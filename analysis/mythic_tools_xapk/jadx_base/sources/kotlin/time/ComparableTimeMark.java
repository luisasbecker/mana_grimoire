...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    public static final class DefaultImpls {
        public static int compareTo(ComparableTimeMark comparableTimeMark, ComparableTimeMark other) {
            ...
            return Duration.m12795compareToLRDsOJo(comparableTimeMark.mo12786minusUwyO8pc(other), Duration.INSTANCE.m12891getZEROUwyO8pc());
        }
        ...
        public static ComparableTimeMark m12789minusLRDsOJo(ComparableTimeMark comparableTimeMark, long j) {
            return comparableTimeMark.mo12787plusLRDsOJo(Duration.m12840unaryMinusUwyO8pc(j));
        }
    }
    ...
    ComparableTimeMark mo12785minusLRDsOJo(long duration);

    /* JADX INFO: renamed from: minus-UwyO8pc */
    long mo12786minusUwyO8pc(ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    ComparableTimeMark mo12787plusLRDsOJo(long duration);
}
