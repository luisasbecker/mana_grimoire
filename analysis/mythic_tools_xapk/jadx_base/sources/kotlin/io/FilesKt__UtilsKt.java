...
public class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit copyRecursively$lambda$1$FilesKt__UtilsKt(Function2 function2, File f, IOException e) throws TerminateException {
    ...
    public static final File createTempDir(String prefix, String str, File file) throws IOException {
        ...
        if (!fileCreateTempFile.mkdir()) {
            throw new IOException("Unable to create temporary directory " + fileCreateTempFile + FilenameUtils.EXTENSION_SEPARATOR);
        }
