...
public final class UnsignedKt {
    public static final int doubleToUInt(double d) {
        ...
        return d <= 2.147483647E9d ? UInt.m11540constructorimpl((int) d) : UInt.m11540constructorimpl(UInt.m11540constructorimpl((int) (d - 2.147483647E9d)) + Integer.MAX_VALUE);
    }
    ...
    public static final long doubleToULong(double d) {
        ...
        return d < 9.223372036854776E18d ? ULong.m11619constructorimpl((long) d) : ULong.m11619constructorimpl(ULong.m11619constructorimpl((long) (d - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
    ...
    public static final int m11796uintDivideJ1ME1BU(int i, int i2) {
        return UInt.m11540constructorimpl((int) ((((long) i) & MuxerUtil.UNSIGNED_INT_MAX_VALUE) / (((long) i2) & MuxerUtil.UNSIGNED_INT_MAX_VALUE)));
    }

    /* JADX INFO: renamed from: uintRemainder-J1ME1BU, reason: not valid java name */
    public static final int m11797uintRemainderJ1ME1BU(int i, int i2) {
        return UInt.m11540constructorimpl((int) ((((long) i) & MuxerUtil.UNSIGNED_INT_MAX_VALUE) % (((long) i2) & MuxerUtil.UNSIGNED_INT_MAX_VALUE)));
    }
    ...
    public static final long m11798ulongDivideeb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compareUnsigned(j, j2) < 0 ? ULong.m11619constructorimpl(0L) : ULong.m11619constructorimpl(1L);
        }
        if (j >= 0) {
            return ULong.m11619constructorimpl(j / j2);
        }
        long j3 = ((j >>> 1) / j2) << 1;
        return ULong.m11619constructorimpl(j3 + ((long) (Long.compareUnsigned(ULong.m11619constructorimpl(j - (j3 * j2)), ULong.m11619constructorimpl(j2)) < 0 ? 0 : 1)));
    }

    /* JADX INFO: renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m11799ulongRemaindereb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compareUnsigned(j, j2) < 0 ? j : ULong.m11619constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m11619constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (Long.compareUnsigned(ULong.m11619constructorimpl(j3), ULong.m11619constructorimpl(j2)) < 0) {
            j2 = 0;
        }
        return ULong.m11619constructorimpl(j3 - j2);
    }
