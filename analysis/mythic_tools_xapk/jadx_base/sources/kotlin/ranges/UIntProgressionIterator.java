...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    private UIntProgressionIterator(int i, int i2, int i3) {
        ...
        this.hasNext = z;
        this.step = UInt.m11540constructorimpl(i3);
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m11534boximpl(m12686nextpVg5ArA());
    }

    /* JADX INFO: renamed from: next-pVg5ArA, reason: not valid java name */
    public int m12686nextpVg5ArA() {
        int i = this.next;
        if (i != this.finalElement) {
            this.next = UInt.m11540constructorimpl(this.step + i);
            return i;
        }
        if (!this.hasNext) {
