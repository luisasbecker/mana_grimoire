...
final class SequenceBuilderIterator<T> extends SequenceScope<T> implements Iterator<T>, Continuation<Unit>, KMappedMarker {
    ...
    private final Throwable exceptionalState() {
        int i = this.state;
        return i != 4 ? i != 5 ? new IllegalStateException("Unexpected state of the iterator: " + this.state) : new IllegalStateException("Iterator has failed.") : new NoSuchElementException();
    }
