...
public final class UStringsKt {
    ...
    public static final String m12780toStringJSWoG40(long j, int i) {
        return UnsignedKt.ulongToString(j, CharsKt.checkRadix(i));
    }

    /* JADX INFO: renamed from: toString-LxnNnR4, reason: not valid java name */
    public static final String m12781toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m12782toStringV7xB4Y4(int i, int i2) {
        return UnsignedKt.ulongToString(((long) i) & MuxerUtil.UNSIGNED_INT_MAX_VALUE, CharsKt.checkRadix(i2));
    }

    /* JADX INFO: renamed from: toString-olVBNx4, reason: not valid java name */
    public static final String m12783toStringolVBNx4(short s, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compareUnsigned(data, UInt.m11540constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m11457boximpl(UByte.m11463constructorimpl((byte) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM11540constructorimpl = UInt.m11540constructorimpl(i);
        ...
        while (i2 < length) {
            ...
            if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                if (iDivideUnsigned == 119304647) {
                    iDivideUnsigned = Integer.divideUnsigned(-1, iM11540constructorimpl);
                    if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            int iM11540constructorimpl2 = UInt.m11540constructorimpl(i3 * iM11540constructorimpl);
            int iM11540constructorimpl3 = UInt.m11540constructorimpl(UInt.m11540constructorimpl(iDigitOf) + iM11540constructorimpl2);
            if (Integer.compareUnsigned(iM11540constructorimpl3, iM11540constructorimpl2) < 0) {
                return null;
            }
            i2++;
            i3 = iM11540constructorimpl3;
        }
        return UInt.m11534boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM11619constructorimpl = ULong.m11619constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                if (jDivideUnsigned == 512409557603043100L) {
                    jDivideUnsigned = Long.divideUnsigned(-1L, jM11619constructorimpl);
                    if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            long jM11619constructorimpl2 = ULong.m11619constructorimpl(j * jM11619constructorimpl);
            long jM11619constructorimpl3 = ULong.m11619constructorimpl(ULong.m11619constructorimpl(((long) UInt.m11540constructorimpl(iDigitOf)) & MuxerUtil.UNSIGNED_INT_MAX_VALUE) + jM11619constructorimpl2);
            if (Long.compareUnsigned(jM11619constructorimpl3, jM11619constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j = jM11619constructorimpl3;
        }
        return ULong.m11613boximpl(j);
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m11540constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m11720boximpl(UShort.m11726constructorimpl((short) data));
    }
}
