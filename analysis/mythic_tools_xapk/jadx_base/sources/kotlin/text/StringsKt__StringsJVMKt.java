...
public class StringsKt__StringsJVMKt extends StringsKt__StringNumberConversionsKt {
    ...
    public static final boolean regionMatches(CharSequence charSequence, int i, CharSequence other, int i2, int i3, boolean z) {
        ...
        Intrinsics.checkNotNullParameter(other, "other");
        return ((charSequence instanceof String) && (other instanceof String)) ? StringsKt.regionMatches((String) charSequence, i, (String) other, i2, i3, z) : StringsKt.regionMatchesImpl(charSequence, i, other, i2, i3, z);
    }
