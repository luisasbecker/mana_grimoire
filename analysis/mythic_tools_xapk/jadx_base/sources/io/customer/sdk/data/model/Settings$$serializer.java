...
public /* synthetic */ class Settings$$serializer implements GeneratedSerializer<Settings> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("io.customer.sdk.data.model.Settings", settings$$serializer, 2);
        pluginGeneratedSerialDescriptor.addElement("writeKey", false);
        pluginGeneratedSerialDescriptor.addElement("apiHost", false);
    ...
    public final Settings deserialize(Decoder decoder) {
        ...
        return new Settings(i, strDecodeStringElement, strDecodeStringElement2, null);
    }
    ...
    public final void serialize(Encoder encoder, Settings value) {
        ...
        Settings.write$Self$core_release(value, compositeEncoderBeginStructure, serialDescriptor);
