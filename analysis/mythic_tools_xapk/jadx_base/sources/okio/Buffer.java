...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public final byte m13210deprecated_getByte(long index) {
    ...
    public InputStream inputStream() {
        return new InputStream() { // from class: okio.Buffer.inputStream.1
            ...
            public int available() {
                return (int) Math.min(Buffer.this.size(), SieveCacheKt.NodeLinkMask);
            }
    ...
    */
        ...
        while (beginIndex < endIndex) {
            ...
            if (cCharAt2 < 128) {
                ...
                if (cCharAt2 < 2048) {
                    ...
                    segmentWritableSegment$okio3.data[segmentWritableSegment$okio3.limit] = (byte) ((cCharAt2 >> '\f') | WebmConstants.MkvEbmlElement.VIDEO);
    ...
    public Buffer writeUtf8CodePoint(int codePoint) {
        ...
        if (codePoint < 65536) {
            ...
            segmentWritableSegment$okio2.data[segmentWritableSegment$okio2.limit] = (byte) ((codePoint >> 12) | WebmConstants.MkvEbmlElement.VIDEO);
