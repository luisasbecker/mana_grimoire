    ...
    */
    ...
    public static final String commonToString(okio.ByteString byteString) {
        ...
        if (iCodePointIndexToCharIndex != -1) {
            ...
            return iCodePointIndexToCharIndex < strUtf8.length() ? "[size=" + byteString2.getData().length + " text=" + strReplace$default + "…]" : "[text=" + strReplace$default + AbstractJsonLexerKt.END_LIST;
        }
