...
public final class HardwareBitmaps {
    ...
    public static final HardwareBitmapService HardwareBitmapService(Logger logger) {
        return IS_DEVICE_BLOCKED ? new ImmutableHardwareBitmapService(false) : (Build.VERSION.SDK_INT == 26 || Build.VERSION.SDK_INT == 27) ? new LimitedFileDescriptorHardwareBitmapService(logger) : new ImmutableHardwareBitmapService(true);
    }
}
