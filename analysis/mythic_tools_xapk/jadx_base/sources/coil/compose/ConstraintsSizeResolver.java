...
public final class ConstraintsSizeResolver implements SizeResolver, LayoutModifier {
    private final MutableStateFlow<Constraints> _constraints = StateFlowKt.MutableStateFlow(Constraints.m9054boximpl(UtilsKt.getZeroConstraints()));

    @Override // androidx.compose.ui.layout.LayoutModifier
    /* JADX INFO: renamed from: measure-3p2s80s */
    public MeasureResult mo2417measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        this._constraints.setValue(Constraints.m9054boximpl(j));
        final Placeable placeableMo7769measureBRTryo0 = measurable.mo7769measureBRTryo0(j);
        return MeasureScope.layout$default(measureScope, placeableMo7769measureBRTryo0.getWidth(), placeableMo7769measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: coil.compose.ConstraintsSizeResolver$measure$1
            {
                super(1);
            }
    ...
    public final void m9912setConstraintsBRTryo0(long constraints) {
        this._constraints.setValue(Constraints.m9054boximpl(constraints));
    }
    ...
    public Object size(Continuation<? super Size> continuation) {
        ...
        return FlowKt.first(new Flow<Size>() { // from class: coil.compose.ConstraintsSizeResolver$size$$inlined$mapNotNull$1
            ...
            public static final class AnonymousClass2<T> implements FlowCollector {
                ...
                @DebugMetadata(c = "coil.compose.ConstraintsSizeResolver$size$$inlined$mapNotNull$1$2", f = "AsyncImage.kt", i = {}, l = {WebmConstants.MkvEbmlElement.AUDIO}, m = "emit", n = {}, s = {})
                ...
                */
                public final Object emit(Object obj, Continuation continuation) {
                    ...
                    if (i == 0) {
                        ...
                        Size sizeM9902toSizeOrNullBRTryo0 = AsyncImageKt.m9902toSizeOrNullBRTryo0(((Constraints) obj).getValue());
                        if (sizeM9902toSizeOrNullBRTryo0 != null) {
                            anonymousClass1.label = 1;
                            if (flowCollector.emit(sizeM9902toSizeOrNullBRTryo0, anonymousClass1) == coroutine_suspended) {
