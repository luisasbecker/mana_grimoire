        ...
        public final CacheControl parse(Headers headers) {
            ...
            while (i4 < size) {
                ...
                if (StringsKt.equals(strName, HttpHeaders.CACHE_CONTROL, z)) {
                        ...
                        if (iIndexOfElement != strValue.length()) {
                            ...
                            if (strValue.charAt(iIndexOfElement) != ',' && strValue.charAt(iIndexOfElement) != ';') {
                                ...
                                if (iIndexOfNonWhitespace >= strValue.length() || strValue.charAt(iIndexOfNonWhitespace) != '\"') {
                                    ...
                                    int iIndexOf$default = StringsKt.indexOf$default((CharSequence) strValue, '\"', i5, false, 4, (Object) null);
                            ...
                            if (!StringsKt.equals("no-cache", string2, z)) {
                                ...
                                } else if (StringsKt.equals(MTApiKt.PRIVACY_TYPE_PRIVATE, string2, z)) {
                                    i = i3;
                                    z5 = z;
                                } else if (StringsKt.equals(MTApiKt.PRIVACY_TYPE_PUBLIC, string2, z)) {
                                    i = i3;
                                    z6 = z;
                    ...
                    headers2 = headers;
                    size = size;
                } else if (!StringsKt.equals(strName, HttpHeaders.PRAGMA, z)) {
                    i4++;
                    headers2 = headers;
                    size = size;
                }
