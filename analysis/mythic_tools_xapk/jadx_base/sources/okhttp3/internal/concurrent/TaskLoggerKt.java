...
public final class TaskLoggerKt {
    public static final String formatDuration(long j) {
        String str = j <= -999500000 ? ((j - 500000000) / C.NANOS_PER_SECOND) + " s " : j <= -999500 ? ((j - 500000) / 1000000) + " ms" : j <= 0 ? ((j - 500) / 1000) + " µs" : j < 999500 ? ((j + 500) / 1000) + " µs" : j < 999500000 ? ((j + 500000) / 1000000) + " ms" : ((j + 500000000) / C.NANOS_PER_SECOND) + " s ";
