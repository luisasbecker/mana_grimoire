...
final class ConcurrentHashMapParametrizedCache<T> implements ParametrizedSerializerCache<T> {
    ...
    public Object mo13031getgIAlus(KClass<Object> key, List<? extends KType> types) {
        ...
        if (obj == null) {
            ...
            Object objPutIfAbsent = concurrentHashMap2.putIfAbsent(arrayList2, resultM11444boximpl);
