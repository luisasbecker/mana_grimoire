...
final class JsonLiteralSerializer implements KSerializer<JsonLiteral> {
    ...
    public JsonLiteral deserialize(Decoder decoder) {
        ...
        String str = "Unexpected JSON element, expected JsonLiteral, had " + Reflection.getOrCreateKotlinClass(jsonElementDecodeJsonElement.getClass());
        String string = jsonDecoderAsJsonDecoder.getJson().getConfiguration().getExceptionsWithDebugInfo() ? JsonExceptionsKt.minify$default(jsonElementDecodeJsonElement.toString(), 0, 1, null).toString() : null;
        throw new JsonDecodingException(JsonExceptionsKt.formatDecodingException(-1, str, null, null, string), str, -1, null, string, null);
    }
