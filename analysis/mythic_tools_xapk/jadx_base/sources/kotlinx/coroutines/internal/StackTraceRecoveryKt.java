...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM11445constructorimpl = Result.m11445constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
        ...
        if (Result.m11448exceptionOrNullimpl(objM11445constructorimpl) == null) {
            obj2 = objM11445constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM11445constructorimpl2 = Result.m11445constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM11445constructorimpl2 = Result.m11445constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m11448exceptionOrNullimpl(objM11445constructorimpl2) == null) {
            obj = objM11445constructorimpl2;
        }
