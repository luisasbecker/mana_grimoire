...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM11445constructorimpl = Result.m11445constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM11445constructorimpl = Result.m11445constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m11451isFailureimpl(objM11445constructorimpl) ? null : objM11445constructorimpl);
