...
public final class ConcurrentWeakMap<K, V> extends AbstractMutableMap<K, V> {
    ...
    private final class Core {
        ...
        private final void removeCleanedAt(int index) {
            ...
            } while (!zzah$$ExternalSyntheticBackportWithForwarding0.m(getValues(), index, obj, null));
        ...
        public final Object putImpl(K key, V value, HashedWeakRef<K> weakKey0) {
            ...
            while (true) {
                ...
                if (hashedWeakRef != null) {
                    ...
                    if (zzah$$ExternalSyntheticBackportWithForwarding0.m(getKeys(), iIndex, null, weakKey0)) {
                        break;
                    }
                } else {
                    return null;
            ...
            } while (!zzah$$ExternalSyntheticBackportWithForwarding0.m(getValues(), iIndex, obj, value));
            return obj;
        }
            ...
            while (true) {
                ...
                while (i < i2) {
                    ...
                    while (true) {
                        ...
                        if (zzah$$ExternalSyntheticBackportWithForwarding0.m(getValues(), i, obj, ConcurrentWeakMapKt.mark(obj))) {
                            break;
                        }
                    }
