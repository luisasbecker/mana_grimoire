...
public class SelectImplementation<R> implements CancelHandler, SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    static final class C13451 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;
        final /* synthetic */ SelectImplementation<R> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C13451(SelectImplementation<R> selectImplementation, Continuation<? super C13451> continuation) {
            super(continuation);
            this.this$0 = selectImplementation;
        }
    ...
    */
    public final Object processResultAndInvokeBlockRecoveringException(SelectImplementation<R>.ClauseData clauseData, Object obj, Continuation<? super R> continuation) throws Throwable {
        C13451 c13451;
        if (continuation instanceof C13451) {
            c13451 = (C13451) continuation;
            if ((c13451.label & Integer.MIN_VALUE) != 0) {
                c13451.label -= Integer.MIN_VALUE;
            } else {
                c13451 = new C13451(this, continuation);
            }
        }
        Object obj2 = c13451.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c13451.label;
        try {
            if (i != 0) {
            ...
            c13451.label = 1;
            Object objInvokeBlock = clauseData.invokeBlock(objProcessResult, c13451);
            return objInvokeBlock == coroutine_suspended ? coroutine_suspended : objInvokeBlock;
        } catch (Throwable th) {
            if (DebugKt.getRECOVER_STACK_TRACES() && (c13451 instanceof CoroutineStackFrame)) {
                throw StackTraceRecoveryKt.recoverFromStackFrame(th, c13451);
            }
            throw th;
        }
    }
