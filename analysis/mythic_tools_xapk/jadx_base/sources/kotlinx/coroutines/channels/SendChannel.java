...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m12979isSuccessimpl(objMo12955trySendJP2dKIU)) {
                return true;
            }
            Throwable thM12973exceptionOrNullimpl = ChannelResult.m12973exceptionOrNullimpl(objMo12955trySendJP2dKIU);
    ...
    Object mo12955trySendJP2dKIU(E element);
}
