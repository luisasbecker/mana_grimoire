...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return ChannelResult.m12969boximpl(Result.m11452isSuccessimpl(objM11445constructorimpl) ? ChannelResult.INSTANCE.m12984successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m12982closedJP2dKIU(Result.m11448exceptionOrNullimpl(objM11445constructorimpl)));
        }
    }
    ...
    public static final /* synthetic */ void sendBlocking(SendChannel sendChannel, Object obj) throws InterruptedException {
        if (ChannelResult.m12979isSuccessimpl(sendChannel.mo12955trySendJP2dKIU(obj))) {
            return;
        }
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo12955trySendJP2dKIU = sendChannel.mo12955trySendJP2dKIU(e);
