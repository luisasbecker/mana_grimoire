    ...
    private final boolean tryPutNodeIntoList(JobNode node, Function2<? super Incomplete, ? super NodeList, Boolean> tryAdd) {
        while (true) {
            ...
            if (state$kotlinx_coroutines_core instanceof Empty) {
                ...
                } else if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$volatile$FU, this, state$kotlinx_coroutines_core, node)) {
                    return true;
                }
            } else {
                if (!(state$kotlinx_coroutines_core instanceof Incomplete)) {
