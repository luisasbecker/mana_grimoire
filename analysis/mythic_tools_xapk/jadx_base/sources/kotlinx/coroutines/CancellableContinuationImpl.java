...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame, Waiter {
    ...
    private final <R> Symbol tryResumeImpl(R proposedUpdate, Object idempotent, Function3<? super Throwable, ? super R, ? super CoroutineContext, Unit> onCancellation) {
        ...
        while (true) {
            ...
            if (!(obj instanceof NotCompleted)) {
                ...
                if ((obj instanceof CompletedContinuation) && obj2 != null) {
                    CompletedContinuation completedContinuation = (CompletedContinuation) obj;
                    if (completedContinuation.idempotentResume == obj2) {
                        if (!DebugKt.getASSERTIONS_ENABLED() || Intrinsics.areEqual(completedContinuation.result, r)) {
            ...
            if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$volatile$FU, cancellableContinuationImpl, obj, cancellableContinuationImpl.resumedState((NotCompleted) obj, r2, this.resumeMode, function3, obj3))) {
    ...
    public final <R> void resumeImpl$kotlinx_coroutines_core(R proposedUpdate, int resumeMode, Function3<? super Throwable, ? super R, ? super CoroutineContext, Unit> onCancellation) {
        ...
        while (true) {
            ...
            if (!(obj instanceof NotCompleted)) {
                ...
                if (obj instanceof CancelledContinuation) {
                    ...
                    if (cancelledContinuation.makeResumed()) {
                        if (function3 != null) {
                            cancellableContinuationImpl.callOnCancellation(function3, cancelledContinuation.cause, r);
                            return;
                        }
                        return;
                    }
                }
                cancellableContinuationImpl.alreadyResumedError(r);
            ...
            if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$volatile$FU, cancellableContinuationImpl2, obj, cancellableContinuationImpl2.resumedState((NotCompleted) obj, r2, i, function32, null))) {
                cancellableContinuationImpl2.detachChildIfNonReusable();
                cancellableContinuationImpl2.dispatchResume(i);
                return;
            } else {
