...
public final class DelayKt {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.DelayKt", f = "Delay.kt", i = {}, l = {WebmConstants.MkvEbmlElement.BLOCK_GROUP}, m = "awaitCancellation", n = {}, s = {})
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.get$context()).mo13018scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m12943delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m12944toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m12944toDelayMillisLRDsOJo(long j) {
        boolean zM12823isPositiveimpl = Duration.m12823isPositiveimpl(j);
        if (zM12823isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m12807getInWholeMillisecondsimpl(Duration.m12825plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (zM12823isPositiveimpl) {
