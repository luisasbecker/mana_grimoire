...
public final class TimeoutKt {
    ...
    */
    public static final TimeoutCancellationException TimeoutCancellationException(long j, Delay delay, Job job) {
        String strM12945timeoutMessageLRDsOJo;
        ...
        if (delayWithTimeoutDiagnostics != null) {
            ...
            strM12945timeoutMessageLRDsOJo = delayWithTimeoutDiagnostics.m12945timeoutMessageLRDsOJo(DurationKt.toDuration(j, DurationUnit.MILLISECONDS));
            if (strM12945timeoutMessageLRDsOJo == null) {
                strM12945timeoutMessageLRDsOJo = "Timed out waiting for " + j + " ms";
            }
        }
        return new TimeoutCancellationException(strM12945timeoutMessageLRDsOJo, job);
    }
    ...
    public static final <T> Object m12953withTimeoutKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m12944toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    */
    ...
    public static final <T> Object m12954withTimeoutOrNullKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m12944toDelayMillisLRDsOJo(j), function2, continuation);
    }
}
