...
final class StartedWhileSubscribed implements SharingStarted {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.StartedWhileSubscribed$command$1", f = "SharingStarted.kt", i = {1, 2, 3}, l = {WebmConstants.MkvEbmlElement.TRACK_ENTRY, WebmConstants.MkvEbmlElement.PIXEL_WIDTH, 178, WebmConstants.MkvEbmlElement.CUE_TIME, WebmConstants.MkvEbmlElement.SAMPLING_FREQUENCY}, m = "invokeSuspend", n = {"$this$transformLatest", "$this$transformLatest", "$this$transformLatest"}, s = {"L$0", "L$0", "L$0"})
