...
public final class CombineKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            static final class C02161<T> implements FlowCollector {
                final /* synthetic */ int $i;
                final /* synthetic */ Channel<IndexedValue<Object>> $resultChannel;

                C02161(Channel<IndexedValue<Object>> channel, int i) {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                try {
                    if (i == 0) {
                        ResultKt.throwOnFailure(obj);
                        this.label = 1;
                        if (this.$flows[this.$i].collect(new C02161(this.$resultChannel, this.$i), this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    } else {
                        if (i != 1) {
        ...
        */
        public final Object invokeSuspend(Object obj) {
            ...
            if (i4 == 0) {
                ...
                this.I$1 = b;
                this.label = 1;
                holder = channel.mo12961receiveCatchingJP2dKIU(this);
            ...
            if (i4 != 1) {
                ...
                if (holder != coroutine_suspended) {
                    ...
                    objArr2 = objArr;
                    bArr2 = bArr3;
                    indexedValue = (IndexedValue) ChannelResult.m12974getOrNullimpl(holder);
                    ...
                    while (true) {
                        ...
                        if (bArr2[index] != i3) {
                            bArr2[index] = (byte) i3;
                            indexedValue = (IndexedValue) ChannelResult.m12974getOrNullimpl(channel.mo12962tryReceivePtdJZtk());
                            if (indexedValue == null) {
                                if (i2 == 0) {
                                }
                            }
