...
public final class SharingStartedKt {
    ...
    public static final SharingStarted m13004WhileSubscribed5qebJ5I(SharingStarted.Companion companion, long j, long j2) {
        return new StartedWhileSubscribed(Duration.m12807getInWholeMillisecondsimpl(j), Duration.m12807getInWholeMillisecondsimpl(j2));
    }

    /* JADX INFO: renamed from: WhileSubscribed-5qebJ5I$default, reason: not valid java name */
    public static /* synthetic */ SharingStarted m13005WhileSubscribed5qebJ5I$default(SharingStarted.Companion companion, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
            j = Duration.INSTANCE.m12891getZEROUwyO8pc();
        }
        if ((i & 2) != 0) {
            j2 = Duration.INSTANCE.m12888getINFINITEUwyO8pc();
        }
        return m13004WhileSubscribed5qebJ5I(companion, j, j2);
    }
}
