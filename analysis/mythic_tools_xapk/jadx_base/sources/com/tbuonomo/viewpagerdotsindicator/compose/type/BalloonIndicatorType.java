...
/* JADX INFO: compiled from: BalloonIndicatorType.kt */
...
public final class BalloonIndicatorType extends IndicatorType {
    ...
    public /* synthetic */ BalloonIndicatorType(DotGraphic dotGraphic, float f, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? new DotGraphic(Dp.m9114constructorimpl(12.0f), 0L, null, null, 0L, 30, null) : dotGraphic, (i & 2) != 0 ? 1.5f : f);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final float computeDotWidth(int currentDotIndex, float globalOffset) {
        return Dp.m9114constructorimpl(this.dotsGraphic.m11294getSizeD9Ej5fM() + Dp.m9114constructorimpl(Dp.m9114constructorimpl(RangesKt.coerceAtLeast(this.balloonSizeFactor - 1.0f, 0.0f) * this.dotsGraphic.m11294getSizeD9Ej5fM()) * (1.0f - RangesKt.coerceAtMost(Math.abs(currentDotIndex - globalOffset), 1.0f)))) / this.dotsGraphic.m11294getSizeD9Ej5fM();
    }

    @Override // com.tbuonomo.viewpagerdotsindicator.compose.type.IndicatorType
    /* JADX INFO: renamed from: IndicatorTypeComposable--jt2gSs, reason: not valid java name */
    public void mo11295IndicatorTypeComposablejt2gSs(final Function0<Float> globalOffsetProvider, final Modifier modifier, final int i, final float f, final Function1<? super Integer, Unit> function1, Composer composer, final int i2) {
        ...
        Composer composerStartRestartGroup = composer.startRestartGroup(122582380);
        if ((i2 & 14) == 0) {
        ...
        if ((374491 & i3) == 74898 && composerStartRestartGroup.getSkipping()) {
            ...
            Modifier modifierM2069height3ABfNKs = SizeKt.m2069height3ABfNKs(SizeKt.fillMaxWidth$default(Modifier.INSTANCE, 0.0f, 1, null), Dp.m9114constructorimpl(this.dotsGraphic.m11294getSizeD9Ej5fM() * this.balloonSizeFactor));
            ...
            composerStartRestartGroup.startReplaceGroup(2022843647);
            boolean z = ((i4 & 14) == 4) | ((i4 & 896) == 256) | ((i4 & 458752) == 131072) | ((i4 & 57344) == 16384);
            Object objRememberedValue = composerStartRestartGroup.rememberedValue();
            if (z || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = (Function1) new Function1<LazyListScope, Unit>() { // from class: com.tbuonomo.viewpagerdotsindicator.compose.type.BalloonIndicatorType$IndicatorTypeComposable$1$1$1
                        ...
                        LazyListScope.items$default(LazyRow, i5, null, null, ComposableLambdaKt.composableLambdaInstance(2058116263, true, new Function4<LazyItemScope, Integer, Composer, Integer, Unit>() { // from class: com.tbuonomo.viewpagerdotsindicator.compose.type.BalloonIndicatorType$IndicatorTypeComposable$1$1$1.1
                            ...
                            public final void invoke(LazyItemScope items, final int i6, Composer composer3, int i7) {
                                ...
                                if (zChanged || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                                    objRememberedValue2 = SnapshotStateKt.derivedStateOf(new Function0<Float>() { // from class: com.tbuonomo.viewpagerdotsindicator.compose.type.BalloonIndicatorType$IndicatorTypeComposable$1$1$1$1$dotSize$2$1
                                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                        {
                                            super(0);
                                        }
                                        ...
                                        public final Float invoke() {
                                            return Float.valueOf(balloonIndicatorType2.computeDotWidth(i6, function02.invoke().floatValue()));
                                        }
                                    });
                                ...
                                composer3.endReplaceGroup();
                                DotKt.Dot(balloonIndicatorType.dotsGraphic, invoke$lambda$3((MutableState) objRememberedValue3), composer3, 0);
                                if (ComposerKt.isTraceInProgress()) {
            ...
            composer2 = composerStartRestartGroup;
            LazyDslKt.LazyRow(modifierM2069height3ABfNKs, null, paddingValuesM2034PaddingValuesa9UjIt4$default, false, horizontalM1908spacedByD5KLDUw, centerVertically, null, false, (Function1) objRememberedValue, composer2, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 202);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.tbuonomo.viewpagerdotsindicator.compose.type.BalloonIndicatorType$IndicatorTypeComposable$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
