...
public final class GpsAraTriggersManager {
    ...
    private final String getEventParameters(AppEvent event) {
        ...
        try {
            ...
            if (jsonObject != null && jsonObject.length() != 0) {
                ...
                this = SequencesKt.joinToString$default(SequencesKt.mapNotNull(SequencesKt.asSequence(itKeys), new Function1<String, String>() { // from class: com.facebook.appevents.gps.ara.GpsAraTriggersManager.getEventParameters.1
    ...
    static final void registerTriggerAsync$lambda$0(String applicationId, AppEvent event) {
        if (CrashShieldHandler.isObjectCrashing(GpsAraTriggersManager.class)) {
            return;
        }
        try {
