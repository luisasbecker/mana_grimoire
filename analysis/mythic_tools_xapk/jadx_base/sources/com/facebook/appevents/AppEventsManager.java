...
public final class AppEventsManager {
    ...
    public static final class AnonymousClass1 implements FetchedAppSettingsManager.FetchedAppSettingsCallback {
        ...
        static final void onSuccess$lambda$0(boolean z) {
            if (z) {
                MetadataIndexer.enable();
            }
        }

        static final void onSuccess$lambda$1(boolean z) {
            if (z) {
                RestrictiveDataManager.enable();
            }
        }

        static final void onSuccess$lambda$10(boolean z) {
            if (z) {
                RedactedEventsManager.enable();
            }
        }

        static final void onSuccess$lambda$11(boolean z) {
            if (z) {
                SensitiveParamsManager.enable();
            }
        }

        static final void onSuccess$lambda$12(boolean z) {
            if (z) {
                AppEventsCAPIManager.enable();
            }
        }

        static final void onSuccess$lambda$13(boolean z) {
            if (z) {
                GpsAraTriggersManager.enable();
            }
        }

        static final void onSuccess$lambda$14(boolean z) {
            if (z) {
                PACustomAudienceClient.enable();
            }
        }

        static final void onSuccess$lambda$15(boolean z) {
            if (z) {
                GpsTopicsManager.enableTopicsObservation();
            }
        }

        static final void onSuccess$lambda$2(boolean z) {
            if (z) {
                ModelManager.enable();
            }
        }

        static final void onSuccess$lambda$3(boolean z) {
            if (z) {
                EventDeactivationManager.enable();
            }
        }

        static final void onSuccess$lambda$4(boolean z) {
            if (z) {
                BannedParamManager.enable();
            }
        }

        static final void onSuccess$lambda$5(boolean z) {
            if (z) {
                InAppPurchaseManager.enableAutoLogging();
            }
        }

        static final void onSuccess$lambda$6(boolean z) {
            if (z) {
                StdParamsEnforcementManager.enable();
            }
        }

        static final void onSuccess$lambda$7(boolean z) {
            if (z) {
                ProtectedModeManager.enable();
            }
        }

        static final void onSuccess$lambda$8(boolean z) {
            if (z) {
                MACARuleMatchingManager.enable();
            }
        }

        static final void onSuccess$lambda$9(boolean z) {
            if (z) {
