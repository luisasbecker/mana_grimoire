...
public final class ActivityLifecycleTracker {
    ...
    static final void onActivityCreated$lambda$1() {
    ...
    static final void onActivityPaused$lambda$7(final long j, final String activityName) {
    ...
    static final void onActivityPaused$lambda$7$lambda$5(long j, String activityName) {
        Intrinsics.checkNotNullParameter(activityName, "$activityName");
        if (currentSession == null) {
            currentSession = new SessionInfo(Long.valueOf(j), null, null, 4, null);
        }
    ...
    static final void onActivityResumed$lambda$3(long j, String activityName, Context appContext) {
        SessionInfo sessionInfo;
        Intrinsics.checkNotNullParameter(activityName, "$activityName");
        SessionInfo sessionInfo2 = currentSession;
    ...
    static final void startTracking$lambda$0(boolean z) {
        if (z) {
