...
public final class AppEventsLoggerImpl {
    ...
    public static final class Companion {
        ...
        static final void initializeLib$lambda$4(Context context, AppEventsLoggerImpl logger) {
        ...
        static final void initializeTimersIfNeeded$lambda$6() {
    ...
    static final void installReferrerCallback$lambda$0(String str) {
        if (CrashShieldHandler.isObjectCrashing(AppEventsLoggerImpl.class)) {
            return;
        }
        try {
