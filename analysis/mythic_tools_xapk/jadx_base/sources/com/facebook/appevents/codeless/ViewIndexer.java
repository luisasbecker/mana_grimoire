...
public final class ViewIndexer {
    ...
    public static final class Companion {
        ...
        static final void buildAppIndexingRequest$lambda$0(GraphResponse it) {
    ...
    static final void schedule$lambda$0(ViewIndexer this$0, TimerTask indexingTask) {
        if (CrashShieldHandler.isObjectCrashing(ViewIndexer.class)) {
            return;
        }
        try {
    ...
    static final void sendToServer$lambda$1(String tree, ViewIndexer this$0) {
        if (CrashShieldHandler.isObjectCrashing(ViewIndexer.class)) {
            return;
        }
        try {
