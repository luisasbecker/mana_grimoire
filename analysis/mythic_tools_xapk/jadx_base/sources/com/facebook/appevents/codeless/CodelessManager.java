...
public final class CodelessManager {
    ...
    static final void checkCodelessSession$lambda$1(String str) {
    ...
    static final void onActivityResumed$lambda$0(FetchedAppSettings fetchedAppSettings, String appId) {
        if (CrashShieldHandler.isObjectCrashing(CodelessManager.class)) {
            return;
        }
        try {
