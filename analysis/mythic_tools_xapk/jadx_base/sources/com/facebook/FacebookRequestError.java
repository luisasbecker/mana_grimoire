                ...
                if (singleResult.has("code")) {
                    ...
                    if (stringPropertyAsJSON == null || !(stringPropertyAsJSON instanceof JSONObject)) {
                        ...
                        if (((JSONObject) stringPropertyAsJSON).has("error")) {
                            ...
                            strOptString = jSONObject != null ? jSONObject.optString(FacebookRequestError.ERROR_MESSAGE_FIELD_KEY, null) : null;
                            int iOptInt = jSONObject != null ? jSONObject.optInt("code", -1) : -1;
                            ...
                            int iOptInt2 = ((JSONObject) stringPropertyAsJSON).optInt("error_code", -1);
                            int iOptInt3 = ((JSONObject) stringPropertyAsJSON).optInt("error_subcode", -1);
                            str2 = strOptString5;
                            str = FacebookRequestError.BODY_KEY;
                            z = false;
                            i = iOptInt3;
                        ...
                        if (z2) {
                            return new FacebookRequestError(i2, iOptInt, i, str2, strOptString, str3, strOptString2, (JSONObject) obj, singleResult, batchResult, connection, null, z, null);
                        }
                    }
                    if (!getHTTP_RANGE_SUCCESS$facebook_core_release().contains(i2)) {
                        return new FacebookRequestError(i2, -1, -1, null, null, null, null, singleResult.has(str) ? (JSONObject) Utility.getStringPropertyAsJSON(singleResult, str, GraphResponse.NON_JSON_RESPONSE_PROPERTY) : null, singleResult, batchResult, connection, null, false, null);
                    }
                }
