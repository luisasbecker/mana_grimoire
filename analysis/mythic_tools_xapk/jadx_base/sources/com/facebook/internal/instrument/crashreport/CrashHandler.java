...
public final class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    public static final class Companion {
        ...
        static final int sendExceptionReports$lambda$2(InstrumentData instrumentData, InstrumentData o2) {
            Intrinsics.checkNotNullExpressionValue(o2, "o2");
            return instrumentData.compareTo(o2);
        }

        static final void sendExceptionReports$lambda$5(List validReports, GraphResponse response) {
