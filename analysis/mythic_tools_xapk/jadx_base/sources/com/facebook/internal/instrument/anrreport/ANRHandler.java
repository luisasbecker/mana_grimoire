...
public final class ANRHandler {
    ...
    static final int sendANRReports$lambda$2(InstrumentData instrumentData, InstrumentData o2) {
        if (CrashShieldHandler.isObjectCrashing(ANRHandler.class)) {
            return 0;
        }
        try {
    ...
    static final void sendANRReports$lambda$5(List validReports, GraphResponse response) {
