...
public final class Utility {
    ...
    public static final String getGraphDomainFromTokenDomain(String tokenGraphDomain) {
        ...
        if (tokenGraphDomain != null) {
            if (Intrinsics.areEqual(tokenGraphDomain, FacebookSdk.GAMING)) {
                return StringsKt.replace$default(facebookDomain, "facebook.com", FacebookSdk.FB_GG, false, 4, (Object) null);
            }
    ...
    static final void getGraphMeRequestWithCacheAsync$lambda$5(GraphMeRequestWithCacheCallback callback, String accessToken, GraphResponse response) {
        Intrinsics.checkNotNullParameter(callback, "$callback");
        Intrinsics.checkNotNullParameter(accessToken, "$accessToken");
