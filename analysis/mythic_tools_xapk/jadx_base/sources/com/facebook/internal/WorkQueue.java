...
public final class WorkQueue {
    ...
    public static final class Companion {
        ...
        public final void m9987assert(boolean condition) {
            if (!condition) {
    ...
    final class WorkNode implements WorkItem {
        ...
        public final WorkNode addToList(WorkNode list, boolean addToFront) {
            WorkQueue.INSTANCE.m9987assert(this.next == null);
            WorkQueue.INSTANCE.m9987assert(this.prev == null);
            if (list == null) {
                this.prev = this;
                this.next = this;
                list = this;
        ...
        public final void verify(boolean shouldBeRunning) {
            ...
            companion.m9987assert(workNode == this);
            Companion companion2 = WorkQueue.INSTANCE;
            WorkNode workNode4 = this.next;
            if (workNode4 == null || (workNode2 = workNode4.prev) == null) {
                workNode2 = this;
            }
            companion2.m9987assert(workNode2 == this);
            WorkQueue.INSTANCE.m9987assert(getIsRunning() == shouldBeRunning);
        }
    }
    ...
    static final void execute$lambda$2(WorkNode node, WorkQueue this$0) {
    ...
    public final void validate() {
        ...
        try {
            ...
            INSTANCE.m9987assert(this.runningCount == i);
            Unit unit = Unit.INSTANCE;
        } finally {
            reentrantLock.unlock();
        }
