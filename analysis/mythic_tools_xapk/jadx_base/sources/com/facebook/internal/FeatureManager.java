...
public final class FeatureManager {
    ...
    public enum Feature {
        ...
        public final Feature getParent() {
            int i = this.code;
            return (i & 255) > 0 ? INSTANCE.fromInt(i & (-256)) : (65280 & i) > 0 ? INSTANCE.fromInt(i & SupportMenu.CATEGORY_MASK) : (16711680 & i) > 0 ? INSTANCE.fromInt(i & (-16777216)) : INSTANCE.fromInt(0);
        }
