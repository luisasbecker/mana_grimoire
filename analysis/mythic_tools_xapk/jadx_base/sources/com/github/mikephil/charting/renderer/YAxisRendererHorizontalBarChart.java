    ...
    public void renderAxisLabels(Canvas canvas) {
        ...
        if (this.mYAxis.isEnabled() && this.mYAxis.isDrawLabelsEnabled()) {
            ...
            if (axisDependency == YAxis.AxisDependency.LEFT) {
                fContentBottom = (labelPosition == YAxis.YAxisLabelPosition.OUTSIDE_CHART ? this.mViewPortHandler.contentTop() : this.mViewPortHandler.contentTop()) - fConvertDpToPixel;
            } else {
                fContentBottom = (labelPosition == YAxis.YAxisLabelPosition.OUTSIDE_CHART ? this.mViewPortHandler.contentBottom() : this.mViewPortHandler.contentBottom()) + fCalcTextHeight + fConvertDpToPixel;
            }
            drawYLabels(canvas, fContentBottom, transformedPositions, this.mYAxis.getYOffset());
        }
    }
            ...
            if (limitLine.isEnabled()) {
                ...
                if (label == null || label.equals("")) {
                    ...
                    if (labelPosition == LimitLine.LimitLabelPosition.RIGHT_TOP) {
                        ...
                        this.mLimitLinePaint.setTextAlign(Paint.Align.LEFT);
                        canvas.drawText(label, fArr[c] + lineWidth, this.mViewPortHandler.contentTop() + fConvertDpToPixel + fCalcTextHeight, this.mLimitLinePaint);
                    } else if (labelPosition == LimitLine.LimitLabelPosition.RIGHT_BOTTOM) {
                        this.mLimitLinePaint.setTextAlign(Paint.Align.LEFT);
                        canvas.drawText(label, fArr[c] + lineWidth, this.mViewPortHandler.contentBottom() - fConvertDpToPixel, this.mLimitLinePaint);
                    } else if (labelPosition == LimitLine.LimitLabelPosition.LEFT_TOP) {
                        this.mLimitLinePaint.setTextAlign(Paint.Align.RIGHT);
                        canvas.drawText(label, fArr[c] - lineWidth, this.mViewPortHandler.contentTop() + fConvertDpToPixel + Utils.calcTextHeight(this.mLimitLinePaint, label), this.mLimitLinePaint);
                    } else {
                        this.mLimitLinePaint.setTextAlign(Paint.Align.RIGHT);
                        canvas.drawText(label, fArr[c] - lineWidth, this.mViewPortHandler.contentBottom() - fConvertDpToPixel, this.mLimitLinePaint);
                    }
