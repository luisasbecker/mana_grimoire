    ...
    protected void drawLabels(Canvas canvas, float f, MPPointF mPPointF) {
        ...
        while (i3 < i) {
            ...
            if (this.mViewPortHandler.isInBoundsY(f3)) {
                ...
                f2 = f;
                mPPointF2 = mPPointF;
                xAxisRendererHorizontalBarChart.drawLabel(canvas2, this.mXAxis.getValueFormatter().getAxisLabel(this.mXAxis.mEntries[i3 / 2], this.mXAxis), f2, f3, mPPointF2, labelRotationAngle);
            } else {
                xAxisRendererHorizontalBarChart = this;
                canvas2 = canvas;
                f2 = f;
