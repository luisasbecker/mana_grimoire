...
public class RadarChart extends PieRadarChartBase<RadarData> {
    ...
    public RadarChart(Context context) {
        ...
        this.mWebColor = Color.rgb(Imgproc.COLOR_YUV2BGRA_YVYU, Imgproc.COLOR_YUV2BGRA_YVYU, Imgproc.COLOR_YUV2BGRA_YVYU);
        this.mWebColorInner = Color.rgb(Imgproc.COLOR_YUV2BGRA_YVYU, Imgproc.COLOR_YUV2BGRA_YVYU, Imgproc.COLOR_YUV2BGRA_YVYU);
        this.mWebAlpha = 150;
        this.mDrawWeb = true;
