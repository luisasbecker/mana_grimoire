...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends ViewGroup implements ChartInterface {
    ...
    protected void init() {
        ...
        paint.setColor(Color.rgb(WebmConstants.MkvEbmlElement.CUE_TRACK, 189, 51));
    ...
    public boolean saveToGallery(String str, String str2, String str3, Bitmap.CompressFormat compressFormat, int i) {
        ...
        String str5 = file.getAbsolutePath() + DomExceptionUtils.SEPARATOR + str;
        try {
            ...
            contentValues.put(Constants.GP_IAP_TITLE, str);
    ...
    public boolean saveToPath(String str, String str2) {
        ...
        try {
            FileOutputStream fileOutputStream = new FileOutputStream(Environment.getExternalStorageDirectory().getPath() + str2 + DomExceptionUtils.SEPARATOR + str + ".png");
