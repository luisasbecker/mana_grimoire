...
public class BarDataSet extends BarLineScatterCandleBubbleDataSet<BarEntry> implements IBarDataSet {
    ...
    public BarDataSet(List<BarEntry> list, String str) {
        super(list, str);
        this.mStackSize = 1;
        this.mBarShadowColor = Color.rgb(WebmConstants.MkvEbmlElement.TRACK_NUMBER, WebmConstants.MkvEbmlElement.TRACK_NUMBER, WebmConstants.MkvEbmlElement.TRACK_NUMBER);
    ...
    private void calcEntryCountIncludingStacks(List<BarEntry> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            int i2 = this.mEntryCountStacks;
            if (yVals == null) {
                this.mEntryCountStacks = i2 + 1;
            } else {
                this.mEntryCountStacks = i2 + yVals.length;
            }
        }
    }
