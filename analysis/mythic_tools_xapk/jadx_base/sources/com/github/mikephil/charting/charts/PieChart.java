...
public class PieChart extends PieRadarChartBase<PieData> {
    ...
    private void calcAngles() {
        ...
        float f3 = this.mMinAngleForSlices;
        boolean z = f3 != 0.0f && ((float) entryCount) * f3 <= this.mMaxAngle;
        ...
        if (z) {
            for (int i6 = 0; i6 < entryCount; i6++) {
                float f8 = fArr[i6];
                float f9 = f8 - (((f8 - this.mMinAngleForSlices) / f5) * f4);
                fArr[i6] = f9;
