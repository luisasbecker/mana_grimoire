...
public abstract class Utils {
    ...
    private static final int[] POW_10 = {1, 10, 100, 1000, 10000, AndroidComposeViewAccessibilityDelegateCompat.ParcelSafeTextLength, 1000000, DefaultEncoderProfilesProvider.DEFAULT_VIDEO_BITRATE_FHD, 100000000, 1000000000};
    ...
    public static String formatNumber(float f, int i, boolean z, char c) {
        ...
        while (true) {
            ...
            if (i7 == length) {
                i4 -= 2;
                cArr2[i6] = AbstractJsonLexerKt.COMMA;
                i3 += 2;
                z4 = true;
