...
public final class SetsDBHelperLocalized extends UpdatableMTGHelper {
    ...
    private static List<Pair<SetsDBHelperLocalized, String>> instances = new ArrayList();

    /* JADX INFO: compiled from: SetsDBHelperLocalized.kt */
    @Metadata(d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010!\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0016\u0010\u000b\u001a\u00020\n2\u0006\u0010\f\u001a\u00020\r2\u0006\u0010\u000e\u001a\u00020\u0005R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0005X\u0082T¢\u0006\u0002\n\u0000R \u0010\u0007\u001a\u0014\u0012\u0010\u0012\u000e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\u00050\t0\bX\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u000f"}, d2 = {"Lcom/studiolaganne/lengendarylens/SetsDBHelperLocalized$Companion;", "", "<init>", "()V", "DATABASE_PREFIX", "", "DATABASE_SUFFIX", "instances", "", "Lkotlin/Pair;", "Lcom/studiolaganne/lengendarylens/SetsDBHelperLocalized;", "getInstance", "context", "Landroid/content/Context;", AndroidContextPlugin.LOCALE_KEY, "app_release"}, k = 1, mv = {2, 2, 0}, xi = 48)
    public static final class Companion {
        ...
        public final synchronized SetsDBHelperLocalized getInstance(Context context, String locale) {
            DefaultConstructorMarker defaultConstructorMarker;
            Object next;
            Object first;
            Intrinsics.checkNotNullParameter(context, "context");
            Intrinsics.checkNotNullParameter(locale, "locale");
            Iterator it = SetsDBHelperLocalized.instances.iterator();
            while (true) {
            ...
            if (pair == null) {
                ...
                pair = new Pair(new SetsDBHelperLocalized(applicationContext, locale, defaultConstructorMarker), locale);
                SetsDBHelperLocalized.instances.add(pair);
            }
            first = pair.getFirst();
            Intrinsics.checkNotNull(first);
            return (SetsDBHelperLocalized) first;
        }
    }

    private SetsDBHelperLocalized(Context context, String str) throws IOException {
        super(context);
    ...
    public /* synthetic */ SetsDBHelperLocalized(Context context, String str, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, str);
    }
    ...
    public final List<CardSet> getSets() {
        ...
        useDatabase(new Function1() { // from class: com.studiolaganne.lengendarylens.SetsDBHelperLocalized$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return SetsDBHelperLocalized.getSets$lambda$0(str, arrayList, (SQLiteDatabase) obj);
            }
        });
        return arrayList;
    }
