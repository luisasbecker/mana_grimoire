...
@Metadata(d1 = {"\u0000)\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0003\n\u0000*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001J$\u0010\u0003\u001a\u00020\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00020\u00062\f\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\u00020\bH\u0016J\u001e\u0010\t\u001a\u00020\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00020\u00062\u0006\u0010\n\u001a\u00020\u000bH\u0016¨\u0006\f"}, d2 = {"com/studiolaganne/lengendarylens/HomeFragment$onDeckTemporary$2$1$1", "Lretrofit2/Callback;", "Lcom/studiolaganne/lengendarylens/MTDecksResponse;", "onResponse", "", NotificationCompat.CATEGORY_CALL, "Lretrofit2/Call;", "response", "Lretrofit2/Response;", "onFailure", "t", "", "app_release"}, k = 1, mv = {2, 2, 0}, xi = 48)
public final class HomeFragment$onDeckTemporary$2$1$1 implements Callback<MTDecksResponse> {
    final /* synthetic */ MTDeck $deck;
    final /* synthetic */ MTUser $it;
    final /* synthetic */ PreferencesManager $prefs;
    final /* synthetic */ HomeFragment this$0;

    HomeFragment$onDeckTemporary$2$1$1(HomeFragment homeFragment, PreferencesManager preferencesManager, MTDeck mTDeck, MTUser mTUser) {
    ...
    public void onResponse(Call<MTDecksResponse> call, Response<MTDecksResponse> response) {
        ...
        if (response.isSuccessful()) {
            ...
            if (decks != null) {
                ...
                homeFragment.updateDecks(mTUser, decks);
            }
            ...
            if (mTResponse != null) {
                ...
                String string = homeFragment2.getString(R.string.server_error);
                ...
                String string2 = homeFragment2.getString(R.string.ok);
                Intrinsics.checkNotNullExpressionValue(string2, "getString(...)");
                CustomDialogFragment.Builder positiveButton = body.setPositiveButton(string2, new Function2() { // from class: com.studiolaganne.lengendarylens.HomeFragment$onDeckTemporary$2$1$1$$ExternalSyntheticLambda0
                    @Override // kotlin.jvm.functions.Function2
                    public final Object invoke(Object obj, Object obj2) {
                        return HomeFragment$onDeckTemporary$2$1$1.onResponse$lambda$1$0$0(((Boolean) obj).booleanValue(), (CustomDialogFragment) obj2);
                    }
                });
