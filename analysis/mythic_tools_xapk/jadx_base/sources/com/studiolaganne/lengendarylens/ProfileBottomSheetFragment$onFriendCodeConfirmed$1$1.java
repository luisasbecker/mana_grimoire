...
@Metadata(d1 = {"\u0000)\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0003\n\u0000*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001J$\u0010\u0003\u001a\u00020\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00020\u00062\f\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\u00020\bH\u0016J\u001e\u0010\t\u001a\u00020\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00020\u00062\u0006\u0010\n\u001a\u00020\u000bH\u0016¨\u0006\f"}, d2 = {"com/studiolaganne/lengendarylens/ProfileBottomSheetFragment$onFriendCodeConfirmed$1$1", "Lretrofit2/Callback;", "Lcom/studiolaganne/lengendarylens/MTFriendResponse;", "onResponse", "", NotificationCompat.CATEGORY_CALL, "Lretrofit2/Call;", "response", "Lretrofit2/Response;", "onFailure", "t", "", "app_release"}, k = 1, mv = {2, 2, 0}, xi = 48)
public final class ProfileBottomSheetFragment$onFriendCodeConfirmed$1$1 implements Callback<MTFriendResponse> {
    final /* synthetic */ PreferencesManager $prefs;
    final /* synthetic */ int $userId;
    final /* synthetic */ ProfileBottomSheetFragment this$0;

    ProfileBottomSheetFragment$onFriendCodeConfirmed$1$1(ProfileBottomSheetFragment profileBottomSheetFragment, int i, PreferencesManager preferencesManager) {
    ...
    public void onFailure(Call<MTFriendResponse> call, Throwable t) {
        ...
        if (this.this$0.getContext() == null || (view = this.this$0.getView()) == null || (constraintLayout = (ConstraintLayout) view.findViewById(R.id.overlay)) == null) {
            return;
        }
        ...
        if (response.isSuccessful()) {
            ...
            if (friends != null) {
                ...
                if (mTFriend != null) {
                    ...
                    String string = profileBottomSheetFragment.getString(R.string.invite_sent);
                    Intrinsics.checkNotNullExpressionValue(string, "getString(...)");
                    CustomDialogFragment.Builder title = builder.setTitle(string);
                    String string2 = profileBottomSheetFragment.getString(R.string.invite_sent_body);
                    ...
                    CustomDialogFragment.Builder positiveButton = body.setPositiveButton(string3, new Function2() { // from class: com.studiolaganne.lengendarylens.ProfileBottomSheetFragment$onFriendCodeConfirmed$1$1$$ExternalSyntheticLambda0
                        @Override // kotlin.jvm.functions.Function2
                        public final Object invoke(Object obj2, Object obj3) {
                            return ProfileBottomSheetFragment$onFriendCodeConfirmed$1$1.onResponse$lambda$0$1$0(((Boolean) obj2).booleanValue(), (CustomDialogFragment) obj3);
                        }
                    });
            ...
            if (mTResponse != null) {
                ...
                String string4 = profileBottomSheetFragment2.getString(R.string.server_error);
                ...
                String string5 = profileBottomSheetFragment2.getString(R.string.ok);
                Intrinsics.checkNotNullExpressionValue(string5, "getString(...)");
                CustomDialogFragment.Builder positiveButton2 = body2.setPositiveButton(string5, new Function2() { // from class: com.studiolaganne.lengendarylens.ProfileBottomSheetFragment$onFriendCodeConfirmed$1$1$$ExternalSyntheticLambda1
                    @Override // kotlin.jvm.functions.Function2
                    public final Object invoke(Object obj2, Object obj3) {
                        return ProfileBottomSheetFragment$onFriendCodeConfirmed$1$1.onResponse$lambda$1$0$0(((Boolean) obj2).booleanValue(), (CustomDialogFragment) obj3);
                    }
                });
                FragmentManager childFragmentManager2 = profileBottomSheetFragment2.getChildFragmentManager();
