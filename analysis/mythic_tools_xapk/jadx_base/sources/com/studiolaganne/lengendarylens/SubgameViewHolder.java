...
public final class SubgameViewHolder extends RecyclerView.ViewHolder {
    ...
    public SubgameViewHolder(View itemView, SubgamesClickListener clickListener) {
        super(itemView);
    ...
    public final SubgamesClickListener getClickListener() {
