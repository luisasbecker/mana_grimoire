...
/* JADX INFO: compiled from: GlossaryDBHelper.kt */
/* JADX INFO: loaded from: classes6.dex */
@Metadata(d1 = {"\u0000N\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\u0010\b\n\u0002\b\t\n\u0002\u0010\u000b\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0007\u0018\u0000 %2\u00020\u0001:\u0001%B\u0011\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\b\u0010\b\u001a\u00020\tH\u0016J\u001c\u0010\n\u001a\u00020\t2\u0012\u0010\u000b\u001a\u000e\u0012\u0004\u0012\u00020\r\u0012\u0004\u0012\u00020\t0\fH\u0002J\u001a\u0010\u000e\u001a\u0014\u0012\u0010\u0012\u000e\u0012\u0004\u0012\u00020\u0011\u0012\u0004\u0012\u00020\u00120\u00100\u000fH\u0002J\u001a\u0010\u0013\u001a\u0014\u0012\u0010\u0012\u000e\u0012\u0004\u0012\u00020\u0011\u0012\u0004\u0012\u00020\u00120\u00100\u000fH\u0002J\u0017\u0010\u0014\u001a\u0004\u0018\u00010\u00122\u0006\u0010\u0015\u001a\u00020\u0011H\u0002¢\u0006\u0002\u0010\u0016J\u0010\u0010\u0017\u001a\u00020\t2\u0006\u0010\u0015\u001a\u00020\u0011H\u0002J\b\u0010\u0018\u001a\u00020\tH\u0002J\b\u0010\u0019\u001a\u00020\u0011H\u0016J\u0006\u0010\u001a\u001a\u00020\u0012J\b\u0010\u001b\u001a\u00020\u001cH\u0016J\u0018\u0010\u001d\u001a\u00020\u001c2\u0006\u0010\u001e\u001a\u00020\r2\u0006\u0010\u001f\u001a\u00020\u0011H\u0002J\u0010\u0010 \u001a\u00020\u001c2\u0006\u0010!\u001a\u00020\u0011H\u0002J\u0006\u0010\"\u001a\u00020\u001cJ\f\u0010#\u001a\b\u0012\u0004\u0012\u00020$0\u000fR\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0007X\u0082.¢\u0006\u0002\n\u0000¨\u0006&"}, d2 = {"Lcom/studiolaganne/lengendarylens/GlossaryDBHelper;", "Lcom/studiolaganne/lengendarylens/UpdatableMTGHelper;", "context", "Landroid/content/Context;", "<init>", "(Landroid/content/Context;)V", "dbFile", "Ljava/io/File;", "initialize", "", "useDatabase", NativeProtocol.WEB_DIALOG_ACTION, "Lkotlin/Function1;", "Landroid/database/sqlite/SQLiteDatabase;", "findDbFilesInContext", "", "Lkotlin/Pair;", "", "", "findDbFilesInAssets", "extractVersionFromFilename", "filename", "(Ljava/lang/String;)Ljava/lang/Integer;", "copyDatabaseFromAssets", "cleanUpOldVersions", "getLang", "getVersion", "isValid", "", "doesTableExist", UserDataStore.DATE_OF_BIRTH, "tableName", "isDatabaseValid", "dbFilePath", "hasDBInAppContext", "getGlossaryEntries", "Lcom/studiolaganne/lengendarylens/GlossaryEntry;", "Companion", "app_release"}, k = 1, mv = {2, 2, 0}, xi = 48)
public final class GlossaryDBHelper extends UpdatableMTGHelper {
    private static final String DATABASE_PREFIX = "glossary_";
    private static final String DATABASE_SUFFIX = ".db";
    private static GlossaryDBHelper instance;
    ...
    /* JADX INFO: compiled from: GlossaryDBHelper.kt */
    @Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u000e\u0010\t\u001a\u00020\b2\u0006\u0010\n\u001a\u00020\u000bR\u000e\u0010\u0004\u001a\u00020\u0005X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0005X\u0082T¢\u0006\u0002\n\u0000R\u0010\u0010\u0007\u001a\u0004\u0018\u00010\bX\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\f"}, d2 = {"Lcom/studiolaganne/lengendarylens/GlossaryDBHelper$Companion;", "", "<init>", "()V", "DATABASE_PREFIX", "", "DATABASE_SUFFIX", "instance", "Lcom/studiolaganne/lengendarylens/GlossaryDBHelper;", "getInstance", "context", "Landroid/content/Context;", "app_release"}, k = 1, mv = {2, 2, 0}, xi = 48)
    public static final class Companion {
        ...
        public final synchronized GlossaryDBHelper getInstance(Context context) {
            GlossaryDBHelper glossaryDBHelper;
            Intrinsics.checkNotNullParameter(context, "context");
            if (GlossaryDBHelper.instance == null) {
                Context applicationContext = context.getApplicationContext();
                Intrinsics.checkNotNullExpressionValue(applicationContext, "getApplicationContext(...)");
                GlossaryDBHelper.instance = new GlossaryDBHelper(applicationContext, null);
            }
            glossaryDBHelper = GlossaryDBHelper.instance;
            Intrinsics.checkNotNull(glossaryDBHelper);
            return glossaryDBHelper;
        }
    }

    private GlossaryDBHelper(Context context) throws IOException {
        super(context);
        this.context = context;
        initialize();
    }

    public /* synthetic */ GlossaryDBHelper(Context context, DefaultConstructorMarker defaultConstructorMarker) {
        this(context);
    }

    private final void cleanUpOldVersions() {
        String str = "glossary_en_" + getCurrentVersion() + DATABASE_SUFFIX;
        ...
        for (String str2 : strArrDatabaseList) {
            ...
            if (StringsKt.startsWith$default(str3, "glossary_en", false, 2, (Object) null) && StringsKt.endsWith$default(str3, DATABASE_SUFFIX, false, 2, (Object) null) && !Intrinsics.areEqual(str3, str)) {
                arrayList.add(str2);
            }
        }
    ...
    private final boolean doesTableExist(SQLiteDatabase db, String tableName) {
        try {
            ...
            Breadcrumbs.INSTANCE.leaveBreadcrumb("glossary_db_corrupt");
            firebaseAnalytics.logEvent("glossary_db_corrupt", null);
            return false;
        }
    }
    ...
    private final List<Pair<String, Integer>> findDbFilesInAssets() {
        try {
            ...
            for (String str : list) {
                ...
                if (StringsKt.startsWith$default(str, "glossary_en", false, 2, (Object) null) && StringsKt.endsWith$default(str, DATABASE_SUFFIX, false, 2, (Object) null)) {
                    arrayList.add(str);
                }
            }
    ...
    private final List<Pair<String, Integer>> findDbFilesInContext() {
        ...
        for (String str : strArrDatabaseList) {
            String str2 = str;
            Intrinsics.checkNotNull(str2);
            if (StringsKt.startsWith$default(str2, "glossary_en", false, 2, (Object) null) && StringsKt.endsWith$default(str2, DATABASE_SUFFIX, false, 2, (Object) null)) {
                arrayList.add(str);
            }
        }
        ArrayList arrayList2 = new ArrayList();
    ...
    static final Unit getGlossaryEntries$lambda$0(String str, List list, SQLiteDatabase db) {
        ...
        try {
            ...
            if (cursorRawQuery.moveToFirst()) {
                do {
                    String string = cursorRawQuery.getString(cursorRawQuery.getColumnIndexOrThrow(SubscriberAttributeKt.JSON_NAME_KEY));
                    String string2 = cursorRawQuery.getString(cursorRawQuery.getColumnIndexOrThrow("value"));
                    GlossaryEntry glossaryEntry = new GlossaryEntry(null, null, null, null, 15, null);
                    Intrinsics.checkNotNull(string);
                    glossaryEntry.setKey(string);
                    Intrinsics.checkNotNull(string2);
                    glossaryEntry.setValue(string2);
    ...
    private final boolean isDatabaseValid(String dbFilePath) {
        ...
        try {
            ...
            try {
                ...
                List listListOf = CollectionsKt.listOf("entries");
    ...
    private final void useDatabase(Function1<? super SQLiteDatabase, Unit> action) {
        ...
        if (file == null) {
            Log.e("GlossaryDBHelper", "Database file not found for locale: en.");
            return;
        }
        if (file == null) {
    ...
    public final List<GlossaryEntry> getGlossaryEntries() {
        final ArrayList arrayList = new ArrayList();
        final String str = "SELECT * FROM entries ORDER BY 'key';";
        useDatabase(new Function1() { // from class: com.studiolaganne.lengendarylens.GlossaryDBHelper$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return GlossaryDBHelper.getGlossaryEntries$lambda$0(str, arrayList, (SQLiteDatabase) obj);
            }
        });
        return arrayList;
    }
