...
public final class RulesDBHelper extends UpdatableMTGHelper {
    ...
    /* JADX INFO: compiled from: RulesDBHelper.kt */
    @Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u000e\u0010\t\u001a\u00020\b2\u0006\u0010\n\u001a\u00020\u000bR\u000e\u0010\u0004\u001a\u00020\u0005X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0005X\u0082T¢\u0006\u0002\n\u0000R\u0010\u0010\u0007\u001a\u0004\u0018\u00010\bX\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\f"}, d2 = {"Lcom/studiolaganne/lengendarylens/RulesDBHelper$Companion;", "", "<init>", "()V", "DATABASE_PREFIX", "", "DATABASE_SUFFIX", "instance", "Lcom/studiolaganne/lengendarylens/RulesDBHelper;", "getInstance", "context", "Landroid/content/Context;", "app_release"}, k = 1, mv = {2, 2, 0}, xi = 48)
    public static final class Companion {
        ...
        public final synchronized RulesDBHelper getInstance(Context context) {
            RulesDBHelper rulesDBHelper;
            Intrinsics.checkNotNullParameter(context, "context");
            if (RulesDBHelper.instance == null) {
                Context applicationContext = context.getApplicationContext();
                Intrinsics.checkNotNullExpressionValue(applicationContext, "getApplicationContext(...)");
                RulesDBHelper.instance = new RulesDBHelper(applicationContext, null);
            }
            rulesDBHelper = RulesDBHelper.instance;
            Intrinsics.checkNotNull(rulesDBHelper);
            return rulesDBHelper;
        }
    }

    private RulesDBHelper(Context context) throws IOException {
        super(context);
        this.context = context;
        initialize();
    }

    public /* synthetic */ RulesDBHelper(Context context, DefaultConstructorMarker defaultConstructorMarker) {
        this(context);
    }

    private final void cleanUpOldVersions() {
        String str = "rules_en_" + getCurrentVersion() + DATABASE_SUFFIX;
        ...
        for (String str2 : strArrDatabaseList) {
            ...
            if (StringsKt.startsWith$default(str3, "rules_en", false, 2, (Object) null) && StringsKt.endsWith$default(str3, DATABASE_SUFFIX, false, 2, (Object) null) && !Intrinsics.areEqual(str3, str)) {
                arrayList.add(str2);
            }
        }
    ...
    private final boolean doesTableExist(SQLiteDatabase db, String tableName) {
        try {
            ...
            Breadcrumbs.INSTANCE.leaveBreadcrumb("rules_en_mtg_db_corrupt");
            firebaseAnalytics.logEvent("rules_en_mtg_db_corrupt", null);
            return false;
        }
    }
    ...
    private final List<Pair<String, Integer>> findDbFilesInAssets() {
        try {
            ...
            for (String str : list) {
                ...
                if (StringsKt.startsWith$default(str, "rules_en", false, 2, (Object) null) && StringsKt.endsWith$default(str, DATABASE_SUFFIX, false, 2, (Object) null)) {
                    arrayList.add(str);
                }
            }
    ...
    private final List<Pair<String, Integer>> findDbFilesInContext() {
        ...
        for (String str : strArrDatabaseList) {
            String str2 = str;
            Intrinsics.checkNotNull(str2);
            if (StringsKt.startsWith$default(str2, "rules_en", false, 2, (Object) null) && StringsKt.endsWith$default(str2, DATABASE_SUFFIX, false, 2, (Object) null)) {
                arrayList.add(str);
            }
        }
        ArrayList arrayList2 = new ArrayList();
    ...
    private final void useDatabase(Function1<? super SQLiteDatabase, Unit> action) {
        ...
        if (file == null) {
            Log.e("RulesDBHelper", "Database file not found for locale: en.");
            return;
        }
        if (file == null) {
    ...
    public final String getEffectiveDate() {
        ...
        useDatabase(new Function1() { // from class: com.studiolaganne.lengendarylens.RulesDBHelper$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return RulesDBHelper.getEffectiveDate$lambda$0(str, objectRef, (SQLiteDatabase) obj);
            }
        });
    ...
    public final List<RuleSection> getRuleSections() {
        ...
        useDatabase(new Function1() { // from class: com.studiolaganne.lengendarylens.RulesDBHelper$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return RulesDBHelper.getRuleSections$lambda$0(str, arrayList, (SQLiteDatabase) obj);
            }
        });
        return arrayList;
    }
    ...
    public final List<RuleParagraph> getRules() {
        ...
        useDatabase(new Function1() { // from class: com.studiolaganne.lengendarylens.RulesDBHelper$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return RulesDBHelper.getRules$lambda$0(str, arrayList, (SQLiteDatabase) obj);
            }
        });
        return arrayList;
    }
