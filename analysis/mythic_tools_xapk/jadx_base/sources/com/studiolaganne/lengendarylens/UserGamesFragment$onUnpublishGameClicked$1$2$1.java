...
@Metadata(d1 = {"\u0000)\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0003\n\u0000*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001J$\u0010\u0003\u001a\u00020\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00020\u00062\f\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\u00020\bH\u0016J\u001e\u0010\t\u001a\u00020\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00020\u00062\u0006\u0010\n\u001a\u00020\u000bH\u0016¨\u0006\f"}, d2 = {"com/studiolaganne/lengendarylens/UserGamesFragment$onUnpublishGameClicked$1$2$1", "Lretrofit2/Callback;", "Lcom/studiolaganne/lengendarylens/MTIdResponse;", "onResponse", "", NotificationCompat.CATEGORY_CALL, "Lretrofit2/Call;", "response", "Lretrofit2/Response;", "onFailure", "t", "", "app_release"}, k = 1, mv = {2, 2, 0}, xi = 48)
public final class UserGamesFragment$onUnpublishGameClicked$1$2$1 implements Callback<MTIdResponse> {
    final /* synthetic */ MTGame $game;
    final /* synthetic */ UserGamesFragment $this_run;
    final /* synthetic */ UserGamesFragment this$0;

    UserGamesFragment$onUnpublishGameClicked$1$2$1(UserGamesFragment userGamesFragment, UserGamesFragment userGamesFragment2, MTGame mTGame) {
        this.$this_run = userGamesFragment;
        this.this$0 = userGamesFragment2;
        this.$game = mTGame;
    }
    ...
    public void onFailure(Call<MTIdResponse> call, Throwable t) {
        ...
        this.$this_run.getBinding().loadingAnimationViewRecyclerView.setVisibility(8);
    }
    ...
    public void onResponse(Call<MTIdResponse> call, Response<MTIdResponse> response) {
        ...
        if (response.isSuccessful()) {
            ...
            this.$this_run.getBinding().gamesRecyclerView.setAdapter(new GamesAdapter(CollectionsKt.toMutableList((Collection) listGroupGamesWithSeparators), false, this.this$0, false, 8, null));
            boolean zIsEmpty = listGroupGamesWithSeparators.isEmpty();
            UserGamesFragment userGamesFragment2 = this.$this_run;
            if (zIsEmpty) {
            ...
            UserGamesFragment userGamesFragment3 = this.$this_run;
            MTResponse mTResponse = (MTResponse) new Gson().fromJson(strString, MTResponse.class);
            if (mTResponse != null) {
                CustomDialogFragment.Builder builder = new CustomDialogFragment.Builder();
                String string = userGamesFragment3.getString(R.string.server_error);
                ...
                String string2 = userGamesFragment3.getString(R.string.ok);
                Intrinsics.checkNotNullExpressionValue(string2, "getString(...)");
                CustomDialogFragment.Builder positiveButton = body.setPositiveButton(string2, new Function2() { // from class: com.studiolaganne.lengendarylens.UserGamesFragment$onUnpublishGameClicked$1$2$1$$ExternalSyntheticLambda0
                    @Override // kotlin.jvm.functions.Function2
                    public final Object invoke(Object obj, Object obj2) {
                        return UserGamesFragment$onUnpublishGameClicked$1$2$1.onResponse$lambda$1$0$0(((Boolean) obj).booleanValue(), (CustomDialogFragment) obj2);
                    }
                });
                FragmentManager childFragmentManager = userGamesFragment3.getChildFragmentManager();
