...
public final class GalleryItemBinding implements ViewBinding {
    ...
    private GalleryItemBinding(CardView cardView, CardView cardView2, TextView textView, TextView textView2, ConstraintLayout constraintLayout) {
        ...
        if (textView != null) {
            ...
            if (textView2 != null) {
                ...
                if (constraintLayout != null) {
                    return new GalleryItemBinding(cardView, cardView, textView, textView2, constraintLayout);
                }
            }
        }
    ...
    public static GalleryItemBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.gallery_item, viewGroup, false);
        if (z) {
