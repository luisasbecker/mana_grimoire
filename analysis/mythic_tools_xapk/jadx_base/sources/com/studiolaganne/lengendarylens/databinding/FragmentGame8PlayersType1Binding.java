...
public final class FragmentGame8PlayersType1Binding implements ViewBinding {
    ...
    public final LifeTotalView lifeTotalView7;
    public final LifeTotalView lifeTotalView8;
    ...
    private FragmentGame8PlayersType1Binding(ConstraintLayout constraintLayout, ImageView imageView, CustomCircleView customCircleView, ConstraintLayout constraintLayout2, TransparentClickImageView transparentClickImageView, View view, ImageView imageView2, LifeTotalView lifeTotalView, LifeTotalView lifeTotalView2, LifeTotalView lifeTotalView3, LifeTotalView lifeTotalView4, LifeTotalView lifeTotalView5, LifeTotalView lifeTotalView6, LifeTotalView lifeTotalView7, LifeTotalView lifeTotalView8, TextView textView, TextView textView2, TextView textView3, View view2, View view3, ImageView imageView3, ConstraintLayout constraintLayout3, TextView textView4, TextView textView5, TextView textView6, TextView textView7) {
        ...
        this.lifeTotalView7 = lifeTotalView7;
        this.lifeTotalView8 = lifeTotalView8;
    ...
    public static FragmentGame8PlayersType1Binding bind(View view) {
                                                                            ...
                                                                            if (textView4 != null) {
                                                                                ...
                                                                                if (textView5 != null) {
                                                                                    ...
                                                                                    if (textView6 != null) {
                                                                                        ...
                                                                                        if (textView7 != null) {
                                                                                            return new FragmentGame8PlayersType1Binding(constraintLayout, imageView, customCircleView, constraintLayout, transparentClickImageView, viewFindChildViewById, imageView2, lifeTotalView, lifeTotalView2, lifeTotalView3, lifeTotalView4, lifeTotalView5, lifeTotalView6, lifeTotalView7, lifeTotalView8, textView, textView2, textView3, viewFindChildViewById2, viewFindChildViewById3, imageView3, constraintLayout2, textView4, textView5, textView6, textView7);
                                                                                        }
                                                                                    }
                                                                                }
                                                                            }
    ...
    public static FragmentGame8PlayersType1Binding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentGame8PlayersType1Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.fragment_game_8_players_type_1, viewGroup, false);
        if (z) {
