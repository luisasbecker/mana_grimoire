...
public final class BottomSheetAcceptPlaygroupBinding implements ViewBinding {
    ...
    private BottomSheetAcceptPlaygroupBinding(ConstraintLayout constraintLayout, ConstraintLayout constraintLayout2, TextView textView, LinearLayoutCompat linearLayoutCompat, ImageView imageView, TextView textView2, ConstraintLayout constraintLayout3, TextView textView3, TextView textView4, LottieAnimationView lottieAnimationView, ImageView imageView2, ConstraintLayout constraintLayout4, TextView textView5, TextView textView6, CachedImageView cachedImageView, ConstraintLayout constraintLayout5, LinearLayoutCompat linearLayoutCompat2) {
        ...
        this.playgroupDescription = textView5;
        this.playgroupName = textView6;
        this.profileIcon = cachedImageView;
        this.profileLayout = constraintLayout5;
        this.textLayout = linearLayoutCompat2;
    }

    public static BottomSheetAcceptPlaygroupBinding bind(View view) {
                                                            ...
                                                            if (cachedImageView != null) {
                                                                ...
                                                                if (constraintLayout4 != null) {
                                                                    ...
                                                                    if (linearLayoutCompat2 != null) {
                                                                        return new BottomSheetAcceptPlaygroupBinding((ConstraintLayout) view, constraintLayout, textView, linearLayoutCompat, imageView, textView2, constraintLayout2, textView3, textView4, lottieAnimationView, imageView2, constraintLayout3, textView5, textView6, cachedImageView, constraintLayout4, linearLayoutCompat2);
                                                                    }
                                                                }
                                                            }
                                                        }
    ...
    public static BottomSheetAcceptPlaygroupBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static BottomSheetAcceptPlaygroupBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.bottom_sheet_accept_playgroup, viewGroup, false);
        if (z) {
