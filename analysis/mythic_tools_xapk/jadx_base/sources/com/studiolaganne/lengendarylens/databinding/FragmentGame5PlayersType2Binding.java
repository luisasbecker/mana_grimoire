...
public final class FragmentGame5PlayersType2Binding implements ViewBinding {
    ...
    public static FragmentGame5PlayersType2Binding bind(View view) {
                                                                ...
                                                                if (textView4 != null) {
                                                                    ...
                                                                    if (textView5 != null) {
                                                                        ...
                                                                        if (textView6 != null) {
                                                                            ...
                                                                            if (textView7 != null) {
                                                                                return new FragmentGame5PlayersType2Binding(constraintLayout, imageView, customCircleView, constraintLayout, transparentClickImageView, viewFindChildViewById, imageView2, lifeTotalView, lifeTotalView2, lifeTotalView3, lifeTotalView4, lifeTotalView5, textView, textView2, textView3, viewFindChildViewById2, viewFindChildViewById3, imageView3, constraintLayout2, textView4, textView5, textView6, textView7);
                                                                            }
                                                                        }
                                                                    }
                                                                }
    ...
    public static FragmentGame5PlayersType2Binding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentGame5PlayersType2Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.fragment_game_5_players_type_2, viewGroup, false);
        if (z) {
