...
public final class FragmentGame1PlayerType1Binding implements ViewBinding {
    ...
    public static FragmentGame1PlayerType1Binding bind(View view) {
                                        ...
                                        if (textView3 != null && (viewFindChildViewById2 = ViewBindings.findChildViewById(view, (i = R.id.overlayView1))) != null) {
                                            ...
                                            if (constraintLayout2 != null) {
                                                ...
                                                if (textView4 != null) {
                                                    ...
                                                    if (textView5 != null) {
                                                        return new FragmentGame1PlayerType1Binding(constraintLayout, imageView, constraintLayout, transparentClickImageView, viewFindChildViewById, imageView2, guideline, guideline2, lifeTotalView, textView, textView2, textView3, viewFindChildViewById2, constraintLayout2, textView4, textView5);
                                                    }
                                                }
                                            }
                                        }
    ...
    public static FragmentGame1PlayerType1Binding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentGame1PlayerType1Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.fragment_game_1_player_type_1, viewGroup, false);
        if (z) {
