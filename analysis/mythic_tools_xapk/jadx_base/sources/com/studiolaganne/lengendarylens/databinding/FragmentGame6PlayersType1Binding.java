...
public final class FragmentGame6PlayersType1Binding implements ViewBinding {
    ...
    public final LifeTotalView lifeTotalView4;
    public final LifeTotalView lifeTotalView5;
    public final LifeTotalView lifeTotalView6;
    public final LifeTotalView lifeTotalViewTeam1;
    public final LifeTotalView lifeTotalViewTeam2;
    ...
    private FragmentGame6PlayersType1Binding(ConstraintLayout constraintLayout, ImageView imageView, CustomCircleView customCircleView, ConstraintLayout constraintLayout2, TransparentClickImageView transparentClickImageView, View view, ImageView imageView2, LifeTotalView lifeTotalView, LifeTotalView lifeTotalView2, LifeTotalView lifeTotalView3, LifeTotalView lifeTotalView4, LifeTotalView lifeTotalView5, LifeTotalView lifeTotalView6, LifeTotalView lifeTotalView7, LifeTotalView lifeTotalView8, TextView textView, TextView textView2, TextView textView3, View view2, View view3, ImageView imageView3, ConstraintLayout constraintLayout3, TextView textView4, TextView textView5, TextView textView6, TextView textView7) {
        ...
        this.lifeTotalView4 = lifeTotalView4;
        this.lifeTotalView5 = lifeTotalView5;
        this.lifeTotalView6 = lifeTotalView6;
        this.lifeTotalViewTeam1 = lifeTotalView7;
        this.lifeTotalViewTeam2 = lifeTotalView8;
    ...
    public static FragmentGame6PlayersType1Binding bind(View view) {
                        ...
                        if (lifeTotalView != null) {
                            ...
                            if (lifeTotalView2 != null) {
                                ...
                                if (lifeTotalView3 != null) {
                                    i = R.id.lifeTotalView4;
                                    LifeTotalView lifeTotalView4 = (LifeTotalView) ViewBindings.findChildViewById(view, i);
                                    if (lifeTotalView4 != null) {
                                        i = R.id.lifeTotalView5;
                                        LifeTotalView lifeTotalView5 = (LifeTotalView) ViewBindings.findChildViewById(view, i);
                                        if (lifeTotalView5 != null) {
                                            i = R.id.lifeTotalView6;
                                            LifeTotalView lifeTotalView6 = (LifeTotalView) ViewBindings.findChildViewById(view, i);
                                            if (lifeTotalView6 != null) {
                                                i = R.id.lifeTotalViewTeam1;
                                                LifeTotalView lifeTotalView7 = (LifeTotalView) ViewBindings.findChildViewById(view, i);
                                                if (lifeTotalView7 != null) {
                                                    i = R.id.lifeTotalViewTeam2;
                                                    LifeTotalView lifeTotalView8 = (LifeTotalView) ViewBindings.findChildViewById(view, i);
                                                                            ...
                                                                            if (textView4 != null) {
                                                                                ...
                                                                                if (textView5 != null) {
                                                                                    ...
                                                                                    if (textView6 != null) {
                                                                                        ...
                                                                                        if (textView7 != null) {
                                                                                            return new FragmentGame6PlayersType1Binding(constraintLayout, imageView, customCircleView, constraintLayout, transparentClickImageView, viewFindChildViewById, imageView2, lifeTotalView, lifeTotalView2, lifeTotalView3, lifeTotalView4, lifeTotalView5, lifeTotalView6, lifeTotalView7, lifeTotalView8, textView, textView2, textView3, viewFindChildViewById2, viewFindChildViewById3, imageView3, constraintLayout2, textView4, textView5, textView6, textView7);
                                                                                        }
                                                                                    }
                                                                                }
                                                                            }
    ...
    public static FragmentGame6PlayersType1Binding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentGame6PlayersType1Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.fragment_game_6_players_type_1, viewGroup, false);
        if (z) {
