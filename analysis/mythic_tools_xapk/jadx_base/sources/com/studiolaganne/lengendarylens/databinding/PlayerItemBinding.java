...
public final class PlayerItemBinding implements ViewBinding {
    ...
    private PlayerItemBinding(MaterialCardView materialCardView, MaterialCardView materialCardView2, TextView textView, ImageView imageView, TextView textView2, ConstraintLayout constraintLayout) {
            ...
            if (imageView != null) {
                ...
                if (textView2 != null) {
                    ...
                    if (constraintLayout != null) {
                        return new PlayerItemBinding(materialCardView, materialCardView, textView, imageView, textView2, constraintLayout);
                    }
                }
            }
        }
    ...
    public static PlayerItemBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.player_item, viewGroup, false);
        if (z) {
