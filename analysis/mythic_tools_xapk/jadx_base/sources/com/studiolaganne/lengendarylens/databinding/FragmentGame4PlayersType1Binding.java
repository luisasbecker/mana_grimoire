...
public final class FragmentGame4PlayersType1Binding implements ViewBinding {
    ...
    private FragmentGame4PlayersType1Binding(ConstraintLayout constraintLayout, ImageView imageView, CustomCircleView customCircleView, ConstraintLayout constraintLayout2, TransparentClickImageView transparentClickImageView, View view, ImageView imageView2, LifeTotalView lifeTotalView, LifeTotalView lifeTotalView2, LifeTotalView lifeTotalView3, LifeTotalView lifeTotalView4, LifeTotalView lifeTotalView5, LifeTotalView lifeTotalView6, TextView textView, TextView textView2, TextView textView3, View view2, View view3, ImageView imageView3, ConstraintLayout constraintLayout3, TextView textView4, TextView textView5, TextView textView6, TextView textView7) {
        ...
        this.lifeTotalViewTeam1 = lifeTotalView5;
        this.lifeTotalViewTeam2 = lifeTotalView6;
    ...
    public static FragmentGame4PlayersType1Binding bind(View view) {
                                                                    ...
                                                                    if (textView4 != null) {
                                                                        ...
                                                                        if (textView5 != null) {
                                                                            ...
                                                                            if (textView6 != null) {
                                                                                ...
                                                                                if (textView7 != null) {
                                                                                    return new FragmentGame4PlayersType1Binding(constraintLayout, imageView, customCircleView, constraintLayout, transparentClickImageView, viewFindChildViewById, imageView2, lifeTotalView, lifeTotalView2, lifeTotalView3, lifeTotalView4, lifeTotalView5, lifeTotalView6, textView, textView2, textView3, viewFindChildViewById2, viewFindChildViewById3, imageView3, constraintLayout2, textView4, textView5, textView6, textView7);
                                                                                }
                                                                            }
                                                                        }
                                                                    }
    ...
    public static FragmentGame4PlayersType1Binding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentGame4PlayersType1Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.fragment_game_4_players_type_1, viewGroup, false);
        if (z) {
