...
public final class FragmentGame2PlayersType1Binding implements ViewBinding {
    ...
    public static FragmentGame2PlayersType1Binding bind(View view) {
    ...
    public static FragmentGame2PlayersType1Binding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentGame2PlayersType1Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.fragment_game_2_players_type_1, viewGroup, false);
        if (z) {
