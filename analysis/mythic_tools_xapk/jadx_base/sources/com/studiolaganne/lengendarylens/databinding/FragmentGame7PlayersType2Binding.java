...
public final class FragmentGame7PlayersType2Binding implements ViewBinding {
    ...
    private FragmentGame7PlayersType2Binding(ConstraintLayout constraintLayout, ImageView imageView, CustomCircleView customCircleView, ConstraintLayout constraintLayout2, TransparentClickImageView transparentClickImageView, View view, ImageView imageView2, LifeTotalView lifeTotalView, LifeTotalView lifeTotalView2, LifeTotalView lifeTotalView3, LifeTotalView lifeTotalView4, LifeTotalView lifeTotalView5, LifeTotalView lifeTotalView6, LifeTotalView lifeTotalView7, TextView textView, TextView textView2, TextView textView3, View view2, View view3, ImageView imageView3, ConstraintLayout constraintLayout3, TextView textView4, TextView textView5, TextView textView6, TextView textView7) {
    ...
    public static FragmentGame7PlayersType2Binding bind(View view) {
    ...
    public static FragmentGame7PlayersType2Binding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentGame7PlayersType2Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.fragment_game_7_players_type_2, viewGroup, false);
        if (z) {
