...
final class zzdc {
    ...
    static {
        ...
        builderNewBuilder.setDebugMessage(ErrorsKt.IN_APP_BILLING_LESS_THAN_3_ERROR_MESSAGE);
        ...
        zzF = builderNewBuilder39.build();
        BillingResult.Builder builderNewBuilder40 = BillingResult.newBuilder();
        builderNewBuilder40.setResponseCode(-2);
        builderNewBuilder40.setDebugMessage("Play Store version installed does not support launching external links.");
        zzG = builderNewBuilder40.build();
        BillingResult.Builder builderNewBuilder41 = BillingResult.newBuilder();
        builderNewBuilder41.setResponseCode(5);
        builderNewBuilder41.setDebugMessage("A DeveloperProvidedBillingListener must be provided when initializing the BillingClient in order to use multiple payment options for this billing program.");
        zzH = builderNewBuilder41.build();
    }
