...
@Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\n\u0002\u0010\u0000\n\u0002\b\u0002\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J!\u0010\u0003\u001a\u00020\u00042\u0012\u0010\u0005\u001a\n\u0012\u0006\b\u0001\u0012\u00020\u00070\u0006\"\u00020\u0007H\u0016¢\u0006\u0002\u0010\b¨\u0006\t"}, d2 = {"Lcom/segment/analytics/kotlin/core/utilities/InMemoryStorageProvider;", "Lcom/segment/analytics/kotlin/core/StorageProvider;", "()V", "createStorage", "Lcom/segment/analytics/kotlin/core/Storage;", NativeProtocol.WEB_DIALOG_PARAMS, "", "", "([Ljava/lang/Object;)Lcom/segment/analytics/kotlin/core/Storage;", "core"}, k = 1, mv = {1, 8, 0}, xi = 48)
    ...
    public Storage createStorage(Object... params) {
        ...
        if (params.length != 0) {
            ...
            if (obj instanceof Analytics) {
                ...
                return new StorageImpl(new InMemoryPrefs(), new InMemoryEventStream(), analytics.getStore(), configuration.getWriteKey(), "segment.events.file.index." + configuration.getWriteKey(), analytics.getFileIODispatcher());
            }
        }
        throw new IllegalArgumentException("Invalid parameters for InMemoryStorageProvider. InMemoryStorageProvider requires at least 1 parameter and the first argument has to be an instance of Analytics");
    }
