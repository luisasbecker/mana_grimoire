...
public final class AliasEvent$$serializer implements GeneratedSerializer<AliasEvent> {
    ...
    static {
        ...
        pluginGeneratedSerialDescriptor.addElement("previousId", false);
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{StringSerializer.INSTANCE, StringSerializer.INSTANCE, EventType.INSTANCE.serializer(), StringSerializer.INSTANCE, StringSerializer.INSTANCE, JsonObjectSerializer.INSTANCE, JsonObjectSerializer.INSTANCE, StringSerializer.INSTANCE, DestinationMetadata$$serializer.INSTANCE};
    }
    ...
    public AliasEvent deserialize(Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            Object objDecodeSerializableElement5 = compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 2, EventType.INSTANCE.serializer(), null);
            ...
            while (z) {
                ...
                switch (iDecodeElementIndex) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        objDecodeSerializableElement8 = compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 5, JsonObjectSerializer.INSTANCE, objDecodeSerializableElement8);
                        i4 |= 32;
                        break;
                    case 6:
                        objDecodeSerializableElement7 = compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, i3, JsonObjectSerializer.INSTANCE, objDecodeSerializableElement7);
                        i4 |= 64;
                        break;
                    case 7:
                        ...
                        break;
                    case 8:
                        objDecodeSerializableElement6 = compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 8, DestinationMetadata$$serializer.INSTANCE, objDecodeSerializableElement6);
                        i4 |= 256;
                        break;
                    default:
        ...
        return new AliasEvent(i, str, strDecodeStringElement, (EventType) objDecodeSerializableElement, str2, str3, (JsonObject) objDecodeSerializableElement4, (JsonObject) objDecodeSerializableElement3, str4, (DestinationMetadata) objDecodeSerializableElement2, null);
    }
    ...
    public void serialize(Encoder encoder, AliasEvent value) {
        ...
        AliasEvent.write$Self(value, compositeEncoderBeginStructure, descriptor2);
