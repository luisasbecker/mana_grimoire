    ...
    */
    private void drawTextWithFont(DocumentData documentData, Font font, Canvas canvas, int i) {
        ...
        if (baseKeyframeAnimation2 == null) {
            ...
            float fDpScale = ((f2 * Utils.dpScale()) * fFloatValue2) / 100.0f;
        ...
        f2 += fFloatValue;
        float fDpScale2 = ((f2 * Utils.dpScale()) * fFloatValue2) / 100.0f;
    ...
    */
    private void drawTextWithGlyphs(DocumentData documentData, Matrix matrix, Font font, Canvas canvas, int i) {
        ...
        if (baseKeyframeAnimation2 == null) {
            ...
            i2 = 0;
            while (i2 < size) {
                List<TextSubLine> listSplitGlyphTextIntoLines = textLayer.splitGlyphTextIntoLines(textLines.get(i2), documentData2.boxSize == null ? 0.0f : documentData2.boxSize.x, font, fFloatValue2, f4, true);
                int i4 = 0;
