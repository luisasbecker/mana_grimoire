...
public class LottieAnimationView extends AppCompatImageView {
    ...
    private LottieTask<LottieComposition> fromAssets(final String str) {
        return isInEditMode() ? new LottieTask<>(new Callable() { // from class: com.airbnb.lottie.LottieAnimationView$$ExternalSyntheticLambda0
            ...
            public final Object call() {
                return this.f$0.m9937lambda$fromAssets$2$comairbnblottieLottieAnimationView(str);
            }
    ...
    private LottieTask<LottieComposition> fromRawRes(final int i) {
        return isInEditMode() ? new LottieTask<>(new Callable() { // from class: com.airbnb.lottie.LottieAnimationView$$ExternalSyntheticLambda2
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.f$0.m9938lambda$fromRawRes$1$comairbnblottieLottieAnimationView(i);
            }
    ...
    /* synthetic */ LottieResult m9937lambda$fromAssets$2$comairbnblottieLottieAnimationView(String str) throws Exception {
    ...
    /* synthetic */ LottieResult m9938lambda$fromRawRes$1$comairbnblottieLottieAnimationView(int i) throws Exception {
