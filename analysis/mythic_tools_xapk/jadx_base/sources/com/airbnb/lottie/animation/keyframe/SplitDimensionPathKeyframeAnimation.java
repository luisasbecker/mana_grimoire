...
public class SplitDimensionPathKeyframeAnimation extends BaseKeyframeAnimation<PointF, PointF> {
    ...
    public PointF getValue(Keyframe<PointF> keyframe, float f) {
        ...
        if (this.xValueCallback == null || (currentKeyframe2 = this.xAnimation.getCurrentKeyframe()) == null) {
            ...
            valueInternal = this.xValueCallback.getValueInternal(currentKeyframe2.startFrame, f2 == null ? currentKeyframe2.startFrame : f2.floatValue(), currentKeyframe2.startValue, currentKeyframe2.endValue, this.xAnimation.getInterpolatedCurrentKeyframeProgress(), this.xAnimation.getLinearCurrentKeyframeProgress(), this.xAnimation.getProgress());
        }
        if (this.yValueCallback != null && (currentKeyframe = this.yAnimation.getCurrentKeyframe()) != null) {
            Float f3 = currentKeyframe.endFrame;
            valueInternal2 = this.yValueCallback.getValueInternal(currentKeyframe.startFrame, f3 == null ? currentKeyframe.startFrame : f3.floatValue(), currentKeyframe.startValue, currentKeyframe.endValue, this.yAnimation.getInterpolatedCurrentKeyframeProgress(), this.yAnimation.getLinearCurrentKeyframeProgress(), this.yAnimation.getProgress());
        }
