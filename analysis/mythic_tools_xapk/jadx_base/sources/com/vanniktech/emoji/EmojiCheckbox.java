...
public class EmojiCheckbox extends AppCompatCheckBox implements EmojiDisplayable {
    ...
    public EmojiCheckbox(Context context, AttributeSet attributeSet) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        int[] EmojiCheckBox = R.styleable.EmojiCheckBox;
        Intrinsics.checkNotNullExpressionValue(EmojiCheckBox, "EmojiCheckBox");
        this.emojiSize = EmojiTextViews.init(this, attributeSet, EmojiCheckBox, R.styleable.EmojiCheckBox_emojiSize);
    }

    public /* synthetic */ EmojiCheckbox(Context context, AttributeSet attributeSet, int i, DefaultConstructorMarker defaultConstructorMarker) {
