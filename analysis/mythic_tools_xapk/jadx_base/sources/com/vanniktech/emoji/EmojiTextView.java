...
public class EmojiTextView extends AppCompatTextView implements EmojiDisplayable {
    ...
    public EmojiTextView(Context context, AttributeSet attributeSet) {
        ...
        this.emojiSize = EmojiTextViews.init(this, attributeSet, EmojiTextView, R.styleable.EmojiTextView_emojiSize);
    }

    public /* synthetic */ EmojiTextView(Context context, AttributeSet attributeSet, int i, DefaultConstructorMarker defaultConstructorMarker) {
