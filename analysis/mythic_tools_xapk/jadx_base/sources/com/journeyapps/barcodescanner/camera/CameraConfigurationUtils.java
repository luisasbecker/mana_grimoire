...
public final class CameraConfigurationUtils {
    ...
    public static void setFocus(Camera.Parameters parameters, CameraSettings.FocusMode focusMode, boolean z) {
        ...
        String strFindSettableValue = (z || focusMode == CameraSettings.FocusMode.AUTO) ? findSettableValue("focus mode", supportedFocusModes, DebugKt.DEBUG_PROPERTY_VALUE_AUTO) : focusMode == CameraSettings.FocusMode.CONTINUOUS ? findSettableValue("focus mode", supportedFocusModes, "continuous-picture", "continuous-video", DebugKt.DEBUG_PROPERTY_VALUE_AUTO) : focusMode == CameraSettings.FocusMode.INFINITY ? findSettableValue("focus mode", supportedFocusModes, "infinity") : focusMode == CameraSettings.FocusMode.MACRO ? findSettableValue("focus mode", supportedFocusModes, "macro") : null;
    ...
    private static String toString(Iterable<Camera.Area> iterable) {
        ...
        for (Camera.Area area : iterable) {
            sb.append(area.rect).append(AbstractJsonLexerKt.COLON).append(area.weight).append(' ');
        }
        return sb.toString();
    }
