...
public final class LruArrayPool implements ArrayPool {
    ...
    public synchronized <T> T get(int i, Class<T> cls) {
        ...
        boolean zMayFillRequest;
        KeyPool keyPool;
        numCeilingKey = getSizesForAdapter(cls).ceilingKey(Integer.valueOf(i));
        zMayFillRequest = mayFillRequest(i, numCeilingKey);
        keyPool = this.keyPool;
        return (T) getForKey(zMayFillRequest ? keyPool.get(numCeilingKey.intValue(), cls) : keyPool.get(i, cls), cls);
    }
