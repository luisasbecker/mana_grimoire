...
public final class QMediaStoreUriLoader<DataT> implements ModelLoader<Uri, DataT> {
    ...
    private static final class QMediaStoreUriFetcher<DataT> implements DataFetcher<DataT> {
        ...
        private ModelLoader.LoadData<DataT> buildDelegateData() throws FileNotFoundException {
            ...
            boolean zIsAccessMediaLocationGranted = isAccessMediaLocationGranted();
            Uri requireOriginal = this.uri;
            if (zIsAccessMediaLocationGranted) {
                requireOriginal = MediaStore.setRequireOriginal(requireOriginal);
            }
            return this.uriDelegate.buildLoadData(requireOriginal, this.width, this.height, this.options);
        }
