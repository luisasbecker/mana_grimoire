...
public class VideoDecoder<T> implements ResourceDecoder<T, Bitmap> {
    ...
    static boolean isHdr180RotationFixRequired() {
        return (Build.MODEL.startsWith("Pixel") && Build.VERSION.SDK_INT == 33) ? isTBuildRequiringRotationFix() : Build.VERSION.SDK_INT >= 30 && Build.VERSION.SDK_INT < 33;
    }
    ...
    public Resource<Bitmap> decode(T t, int i, int i2, Options options) throws Exception {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= 29) {
                AacWriter$$ExternalSyntheticBackport0.m9753m((Object) mediaMetadataRetrieverBuild);
            } else {
