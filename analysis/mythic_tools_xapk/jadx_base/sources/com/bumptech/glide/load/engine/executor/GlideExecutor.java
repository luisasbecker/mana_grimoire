...
public final class GlideExecutor implements ExecutorService {
    ...
    public static final class Builder {
        ...
        public GlideExecutor build() {
            ...
            ThreadPoolExecutor threadPoolExecutor = this.onExecuteDecorator != null ? new ThreadPoolExecutor(this.corePoolSize, this.maximumPoolSize, this.threadTimeoutMillis, TimeUnit.MILLISECONDS, new PriorityBlockingQueue(), defaultThreadFactory) { // from class: com.bumptech.glide.load.engine.executor.GlideExecutor.Builder.1
                @Override // java.util.concurrent.ThreadPoolExecutor, java.util.concurrent.Executor
                public void execute(Runnable runnable) {
                    super.execute((Runnable) Builder.this.onExecuteDecorator.apply(runnable));
                }
            } : new ThreadPoolExecutor(this.corePoolSize, this.maximumPoolSize, this.threadTimeoutMillis, TimeUnit.MILLISECONDS, new PriorityBlockingQueue(), defaultThreadFactory);
