...
public final class AdLoadedData {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual(this.networkName, adLoadedData.networkName) && AdMediatorName.m10306equalsimpl0(this.mediatorName, adLoadedData.mediatorName) && AdFormat.m10289equalsimpl0(this.adFormat, adLoadedData.adFormat) && Intrinsics.areEqual(this.placement, adLoadedData.placement) && Intrinsics.areEqual(this.adUnitId, adLoadedData.adUnitId) && Intrinsics.areEqual(this.impressionId, adLoadedData.impressionId);
    }
    ...
    public String toString() {
        return "AdLoadedData(networkName=" + this.networkName + ", mediatorName=" + ((Object) AdMediatorName.m10308toStringimpl(this.mediatorName)) + ", adFormat=" + ((Object) AdFormat.m10291toStringimpl(this.adFormat)) + ", placement=" + this.placement + ", adUnitId=" + this.adUnitId + ", impressionId=" + this.impressionId + ')';
    }
}
