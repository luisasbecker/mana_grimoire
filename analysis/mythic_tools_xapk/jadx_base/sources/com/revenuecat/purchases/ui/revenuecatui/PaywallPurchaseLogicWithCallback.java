...
public abstract class PaywallPurchaseLogicWithCallback implements PaywallPurchaseLogic {
    ...
    public final Object performPurchase(Activity activity, PaywallPurchaseLogicParams paywallPurchaseLogicParams, Continuation<? super PurchaseLogicResult> continuation) throws Throwable {
        SafeContinuation safeContinuation = new SafeContinuation(IntrinsicsKt.intercepted(continuation));
        final SafeContinuation safeContinuation2 = safeContinuation;
        performPurchaseWithCompletion(activity, paywallPurchaseLogicParams, new Function1<PurchaseLogicResult, Unit>() { // from class: com.revenuecat.purchases.ui.revenuecatui.PaywallPurchaseLogicWithCallback$performPurchase$2$1
    ...
    public abstract void performPurchaseWithCompletion(Activity activity, PaywallPurchaseLogicParams params, Function1<? super PurchaseLogicResult, Unit> completion);
    ...
    public final Object performRestore(CustomerInfo customerInfo, Continuation<? super PurchaseLogicResult> continuation) throws Throwable {
        SafeContinuation safeContinuation = new SafeContinuation(IntrinsicsKt.intercepted(continuation));
        final SafeContinuation safeContinuation2 = safeContinuation;
        performRestoreWithCompletion(customerInfo, new Function1<PurchaseLogicResult, Unit>() { // from class: com.revenuecat.purchases.ui.revenuecatui.PaywallPurchaseLogicWithCallback$performRestore$2$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
