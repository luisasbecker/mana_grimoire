...
public final class ButtonComponent$Action$NavigateTo$$serializer implements GeneratedSerializer<ButtonComponent.Action.NavigateTo> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{ButtonComponent.Action.NavigateTo.$childSerializers[0]};
    }
    ...
    public ButtonComponent.Action.NavigateTo deserialize(Decoder decoder) {
        ...
        KSerializer[] kSerializerArr = ButtonComponent.Action.NavigateTo.$childSerializers;
        int i = 1;
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            destination = (ButtonComponent.Destination) compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 0, kSerializerArr[0], null);
        } else {
            boolean z = true;
            int i2 = 0;
            ...
            while (z) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    destination2 = (ButtonComponent.Destination) compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 0, kSerializerArr[0], destination2);
                    i2 = 1;
                }
            }
    ...
    public void serialize(Encoder encoder, ButtonComponent.Action.NavigateTo value) {
        ...
        compositeEncoderBeginStructure.encodeSerializableElement(descriptor2, 0, ButtonComponent.Action.NavigateTo.$childSerializers[0], value.destination);
