...
public final class ButtonComponent$Destination$Sheet$$serializer implements GeneratedSerializer<ButtonComponent.Destination.Sheet> {
    ...
    public ButtonComponent.Destination.Sheet deserialize(Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            size = (Size) compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 4, Size$$serializer.INSTANCE, null);
            ...
            while (z) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    size2 = (Size) compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 4, Size$$serializer.INSTANCE, size2);
                    i2 |= 16;
                }
            }
        ...
        return new ButtonComponent.Destination.Sheet(i, str, str2, stackComponent, zDecodeBooleanElement, size, null);
    }
    ...
    public void serialize(Encoder encoder, ButtonComponent.Destination.Sheet value) {
        ...
        ButtonComponent.Destination.Sheet.write$Self$purchases_defaultsBc8Release(value, compositeEncoderBeginStructure, descriptor2);
