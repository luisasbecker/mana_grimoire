...
public final class ColorInfo$Gradient$Point$$serializer implements GeneratedSerializer<ColorInfo.Gradient.Point> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{RgbaStringArgbColorIntDeserializer.INSTANCE, FloatSerializer.INSTANCE};
    }
    ...
    public ColorInfo.Gradient.Point deserialize(Decoder decoder) {
        ...
        return new ColorInfo.Gradient.Point(i, iIntValue, fDecodeFloatElement, null);
    }
    ...
    public void serialize(Encoder encoder, ColorInfo.Gradient.Point value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(descriptor2);
        ColorInfo.Gradient.Point.write$Self$purchases_defaultsBc8Release(value, compositeEncoderBeginStructure, descriptor2);
