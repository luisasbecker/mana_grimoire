...
public final class IconComponent$IconBackground$$serializer implements GeneratedSerializer<IconComponent.IconBackground> {
    ...
    public IconComponent.IconBackground deserialize(Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            MaskShape maskShape2 = (MaskShape) compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 1, MaskShapeDeserializer.INSTANCE, null);
            Border border2 = (Border) compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 2, Border$$serializer.INSTANCE, null);
            colorScheme = colorScheme3;
            shadow = (Shadow) compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 3, Shadow$$serializer.INSTANCE, null);
            border = border2;
            ...
            while (z) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    maskShape3 = (MaskShape) compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 1, MaskShapeDeserializer.INSTANCE, maskShape3);
                    i2 |= 2;
                } else if (iDecodeElementIndex == 2) {
                    border3 = (Border) compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 2, Border$$serializer.INSTANCE, border3);
                    i2 |= 4;
                } else {
                    if (iDecodeElementIndex != 3) {
                        throw new UnknownFieldException(iDecodeElementIndex);
                    }
                    shadow2 = (Shadow) compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 3, Shadow$$serializer.INSTANCE, shadow2);
                    i2 |= 8;
                }
            }
            i = i2;
    ...
    public void serialize(Encoder encoder, IconComponent.IconBackground value) {
        ...
        IconComponent.IconBackground.write$Self$purchases_defaultsBc8Release(value, compositeEncoderBeginStructure, descriptor2);
