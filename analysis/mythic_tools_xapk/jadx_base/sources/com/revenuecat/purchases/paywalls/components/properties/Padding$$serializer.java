...
public final class Padding$$serializer implements GeneratedSerializer<Padding> {
    ...
    public Padding deserialize(Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            double dDecodeDoubleElement2 = compositeDecoderBeginStructure.decodeDoubleElement(descriptor2, 0);
            double dDecodeDoubleElement3 = compositeDecoderBeginStructure.decodeDoubleElement(descriptor2, 1);
            double dDecodeDoubleElement4 = compositeDecoderBeginStructure.decodeDoubleElement(descriptor2, 2);
            ...
            double dDecodeDoubleElement5 = AudioStats.AUDIO_AMPLITUDE_NONE;
            boolean z = true;
            int i2 = 0;
            ...
            while (z) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    dDecodeDoubleElement7 = compositeDecoderBeginStructure.decodeDoubleElement(descriptor2, 0);
                    i2 |= 1;
                } else if (iDecodeElementIndex == 1) {
                    dDecodeDoubleElement8 = compositeDecoderBeginStructure.decodeDoubleElement(descriptor2, 1);
                    i2 |= 2;
                    ...
                    dDecodeDoubleElement5 = compositeDecoderBeginStructure.decodeDoubleElement(descriptor2, 3);
                    i2 |= 8;
                }
            }
            i = i2;
        ...
        return new Padding(i, d2, d3, d, dDecodeDoubleElement, (SerializationConstructorMarker) null);
    }
    ...
    public void serialize(Encoder encoder, Padding value) {
        ...
        Padding.write$Self$purchases_defaultsBc8Release(value, compositeEncoderBeginStructure, descriptor2);
