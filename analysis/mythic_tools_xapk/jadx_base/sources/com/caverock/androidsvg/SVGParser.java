...
class SVGParser {
    ...
    private static class FontWeightKeywords {
        ...
        static {
            ...
            map.put("600", 600);
            map.put("700", 700);
            map.put("800", Integer.valueOf(Videoio.CAP_PVAPI));
            map.put("900", 900);
        }
    ...
    */
    ...
    private static SVG.Length parseLengthOrAuto(TextScanner textScanner) {
        return textScanner.consume(DebugKt.DEBUG_PROPERTY_VALUE_AUTO) ? new SVG.Length(0.0f) : textScanner.nextLength();
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:118:0x029f A[SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
