...
final class zzac extends zzab {
    ...
    final boolean zzd(Long l, Long l2, com.google.android.gms.internal.measurement.zziu zziuVar, boolean z) {
        ...
        if (zziuVar.zzf()) {
            if (zzfhVarZzd.zzc()) {
                boolZze = zze(zzg(zziuVar.zzh(), zzfhVarZzd.zzd()), zZzf2);
            } else {
                zzicVar.zzaW().zze().zzb("No number filter for long property. property", zzicVar.zzl().zzc(zziuVar.zzc()));
            }
        } else if (zziuVar.zzk()) {
            if (zzfhVarZzd.zzc()) {
                boolZze = zze(zzh(zziuVar.zzl(), zzfhVarZzd.zzd()), zZzf2);
            } else {
            ...
            boolZze = zze(zzf(zziuVar.zze(), zzfhVarZzd.zzb(), zzicVar.zzaW()), zZzf2);
        ...
        zzicVar.zzaW().zzk().zzb("Property filter result", boolZze == null ? AbstractJsonLexerKt.NULL : boolZze);
        if (boolZze == null) {
            return false;
        }
        this.zzd = true;
