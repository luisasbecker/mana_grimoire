...
interface zzago {
    ...
    void zzM(int i, zzaeu zzaeuVar, Map map) throws IOException;
    ...
    void zzn(int i, zzacr zzacrVar) throws IOException;
    ...
    void zzr(int i, Object obj, zzafp zzafpVar) throws IOException;

    @Deprecated
    void zzs(int i, Object obj, zzafp zzafpVar) throws IOException;
