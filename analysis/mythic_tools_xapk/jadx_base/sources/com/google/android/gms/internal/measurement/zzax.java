...
public final class zzax extends zzav {
    ...
    private static boolean zzc(zzao zzaoVar, zzao zzaoVar2) {
        ...
        return (Double.isNaN(dDoubleValue) || Double.isNaN(dDoubleValue2) || (dDoubleValue == AudioStats.AUDIO_AMPLITUDE_NONE && dDoubleValue2 == AudioStats.AUDIO_AMPLITUDE_NONE) || ((dDoubleValue == AudioStats.AUDIO_AMPLITUDE_NONE && dDoubleValue2 == AudioStats.AUDIO_AMPLITUDE_NONE) || Double.compare(dDoubleValue, dDoubleValue2) >= 0)) ? false : true;
    }
