...
public final class zzaen {
    ...
    static {
        ...
        sparseArray.put(WebmConstants.MkvEbmlElement.DOC_TYPE_READ_VERSION, new Pair<>("ERROR_EXPIRED_ACTION_CODE", "The out of band code has expired."));
        sparseArray.put(WebmConstants.MkvEbmlElement.EBML_VERSION, new Pair<>("ERROR_INVALID_ACTION_CODE", "The out of band code is invalid. This can happen if the code is malformed, expired, or has already been used."));
        sparseArray.put(WebmConstants.MkvEbmlElement.DOC_TYPE_VERSION, new Pair<>("ERROR_INVALID_MESSAGE_PAYLOAD", "The email template corresponding to this action contains invalid characters in its message. Please fix by going to the Auth email templates section in the Firebase Console."));
                                    ...
                                    default:
                                        switch (statusCode) {
                                            case FirebaseError.ERROR_APP_NOT_AUTHORIZED /* 17028 */:
                                                break;
                                            case WebmConstants.MkvEbmlElement.DOC_TYPE_READ_VERSION /* 17029 */:
                                            case WebmConstants.MkvEbmlElement.EBML_VERSION /* 17030 */:
                                                return new FirebaseAuthActionCodeException(zza(statusCode), strZza);
                                            case WebmConstants.MkvEbmlElement.DOC_TYPE_VERSION /* 17031 */:
                                            case 17032:
                                            case 17033:
