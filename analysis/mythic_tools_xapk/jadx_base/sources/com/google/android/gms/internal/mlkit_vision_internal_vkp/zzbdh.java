...
final class zzbdh extends zzbdj {
    ...
    /* synthetic */ zzbdh(InputStream inputStream, int i, zzbdg zzbdgVar) {
        super(null);
    ...
    public final zzbdd zzw() throws IOException {
        ...
        int i2 = this.zzi;
        if (iZzj <= i - i2 && iZzj > 0) {
            zzbdd zzbddVarZzo = zzbdd.zzo(this.zzf, i2, iZzj);
            this.zzi += iZzj;
            return zzbddVarZzo;
        }
        if (iZzj == 0) {
    ...
    public final String zzx() throws IOException {
        ...
        if (iZzj > 0) {
            ...
            int i2 = this.zzi;
            if (iZzj <= i - i2) {
                String str = new String(this.zzf, i2, iZzj, zzbeu.zza);
                this.zzi += iZzj;
                return str;
            }
        }
    ...
    public final String zzy() throws IOException {
        ...
        return zzbhp.zzd(bArrZzM, i, iZzj);
    }
