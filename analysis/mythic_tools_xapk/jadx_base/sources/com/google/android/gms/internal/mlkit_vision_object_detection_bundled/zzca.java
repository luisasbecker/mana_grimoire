...
final class zzca implements ObjectEncoderContext {
    ...
    private final zzce zzi = new zzce(this);
    ...
    static {
        ...
        zzd = new ObjectEncoder() { // from class: com.google.android.gms.internal.mlkit_vision_object_detection_bundled.zzbz
            @Override // com.google.firebase.encoders.Encoder
            public final void encode(Object obj, ObjectEncoderContext objectEncoderContext) throws IOException {
                zzca.zzg((Map.Entry) obj, objectEncoderContext);
            }
        };
    }

    zzca(OutputStream outputStream, Map map, Map map2, ObjectEncoder objectEncoder) {
    ...
    private static int zzh(FieldDescriptor fieldDescriptor) {
        zzby zzbyVar = (zzby) fieldDescriptor.getProperty(zzby.class);
        if (zzbyVar != null) {
            return zzbyVar.zza();
        }
    ...
    private static zzby zzj(FieldDescriptor fieldDescriptor) {
        zzby zzbyVar = (zzby) fieldDescriptor.getProperty(zzby.class);
        if (zzbyVar != null) {
            return zzbyVar;
        }
    ...
    private final zzca zzk(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IOException {
    ...
    private final zzca zzl(ValueEncoder valueEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IOException {
            ...
            if (obj instanceof CharSequence) {
                ...
                if (!(obj instanceof byte[])) {
                    ...
                    if (obj instanceof zzbw) {
                        zzd(fieldDescriptor, ((zzbw) obj).zza(), true);
                        return this;
                    }
    ...
    final zzca zzd(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (!z || i != 0) {
            zzby zzbyVarZzj = zzj(fieldDescriptor);
            int iOrdinal = zzbyVarZzj.zzb().ordinal();
            if (iOrdinal == 0) {
                zzn(zzbyVarZzj.zza() << 3);
                zzn(i);
                return this;
            }
            if (iOrdinal == 1) {
    ...
    final zzca zze(FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (!z || j != 0) {
            zzby zzbyVarZzj = zzj(fieldDescriptor);
            int iOrdinal = zzbyVarZzj.zzb().ordinal();
            if (iOrdinal == 0) {
    ...
    final zzca zzf(Object obj) throws IOException {
        if (obj == null) {
            return this;
        }
        ObjectEncoder objectEncoder = (ObjectEncoder) this.zzf.get(obj.getClass());
