...
public enum zzary implements zznp {
    UNKNOWN_EVENT(0),
    ...
    AGGREGATED_ON_DEVICE_DOCUMENT_DETECT_PROCESS(WebmConstants.MkvEbmlElement.TRACK_NUMBER),
    ...
    ON_DEVICE_DOCUMENT_CROP_CREATE(BuildConfig.VERSION_CODE),
