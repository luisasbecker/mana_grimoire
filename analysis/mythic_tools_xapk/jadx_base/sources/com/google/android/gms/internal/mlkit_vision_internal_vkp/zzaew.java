...
public final class zzaew extends Number {
    private final String zza;

    public zzaew(String str) {
        this.zza = str;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof zzaew) {
            return this.zza.equals(((zzaew) obj).zza);
        }
        return false;
    }
    ...
    public final int intValue() {
        try {
            ...
            return zzaff.zza(this.zza).intValue();
        }
    }
    ...
    public final long longValue() {
        try {
            ...
            return zzaff.zza(this.zza).longValue();
        }
    }
