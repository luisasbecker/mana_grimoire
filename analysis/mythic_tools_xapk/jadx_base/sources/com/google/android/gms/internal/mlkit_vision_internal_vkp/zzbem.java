...
final class zzbem extends zzbcm implements RandomAccess, zzber, zzbga {
    private static final zzbem zza = new zzbem(new int[0], 0, false);
    private int[] zzb;
    private int zzc;
    ...
    private zzbem(int[] iArr, int i, boolean z) {
        super(z);
        this.zzb = iArr;
        this.zzc = i;
    }

    public static zzbem zzf() {
        return zza;
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        byte[] bArr = zzbeu.zzb;
        collection.getClass();
        if (!(collection instanceof zzbem)) {
            return super.addAll(collection);
        }
        zzbem zzbemVar = (zzbem) collection;
        int i = zzbemVar.zzc;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(zzbemVar.zzb, 0, this.zzb, this.zzc, zzbemVar.zzc);
        this.zzc = i3;
        this.modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzbemVar.zzc) {
            return false;
        }
        int[] iArr = zzbemVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzbet zzd(int i) {
        if (i >= this.zzc) {
            return new zzbem(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
