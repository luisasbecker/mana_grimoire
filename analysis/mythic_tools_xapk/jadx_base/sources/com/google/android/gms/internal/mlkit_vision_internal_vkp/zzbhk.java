...
final class zzbhk {
    ...
    private static final zzbhj zzf;
    ...
    static {
        ...
        if (unsafeZzg != null) {
            if (zZzv) {
                zzbhhVar = new zzbhi(unsafeZzg);
            } else if (zZzv2) {
                zzbhhVar = new zzbhh(unsafeZzg);
            }
        }
        zzf = zzbhhVar;
        if (zzbhhVar == null) {
            ...
            try {
                Class<?> cls = zzbhhVar.zza.getClass();
        ...
        if (zzbhjVar2 == null) {
            ...
            try {
                Class<?> cls2 = zzbhjVar2.zza.getClass();
        ...
        zzA(Object[].class);
        Field fieldZzB = zzB();
        if (fieldZzB != null && (zzbhjVar = zzf) != null) {
            zzbhjVar.zza.objectFieldOffset(fieldZzB);
        }
    ...
    public static void zzD(Object obj, long j, byte b) {
        zzbhj zzbhjVar = zzf;
        long j2 = (-4) & j;
        int i = zzbhjVar.zza.getInt(obj, j2);
        int i2 = ((~((int) j)) & 3) << 3;
        zzbhjVar.zza.putInt(obj, j2, ((255 & b) << i2) | (i & (~(255 << i2))));
    }
    ...
    public static void zzE(Object obj, long j, byte b) {
        ...
        long j2 = (-4) & j;
        int i = (((int) j) & 3) << 3;
        zzbhjVar.zza.putInt(obj, j2, ((255 & b) << i) | (zzbhjVar.zza.getInt(obj, j2) & (~(255 << i))));
    }
    ...
    static Unsafe zzg() {
        try {
            return (Unsafe) AccessController.doPrivileged(new zzbhg());
        } catch (Throwable unused) {
            return null;
        }
    }
    ...
    static /* bridge */ /* synthetic */ void zzh(Throwable th) {
        Logger.getLogger(zzbhk.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
    }
