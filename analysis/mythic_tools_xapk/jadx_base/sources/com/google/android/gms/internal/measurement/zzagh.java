...
final class zzagh {
    ...
    static /* synthetic */ void zzb(byte b, byte b2, char[] cArr, int i) throws zzaeh {
        if (b < -62 || zze(b2)) {
    ...
    */
    static /* synthetic */ void zzc(byte b, byte b2, byte b3, char[] cArr, int i) throws zzaeh {
        if (!zze(b2)) {
            if (b != -32) {
                if (b != -19) {
                    if (!zze(b3)) {
    ...
    static /* synthetic */ void zzd(byte b, byte b2, byte b3, byte b4, char[] cArr, int i) throws zzaeh {
