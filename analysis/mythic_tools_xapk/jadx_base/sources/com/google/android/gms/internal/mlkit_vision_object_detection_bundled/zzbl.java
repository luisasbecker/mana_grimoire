...
final class zzbl extends zzat {
    ...
    */
    static zzbl zzh(int i, Object[] objArr, zzas zzasVar) {
        ...
        zzd.zzb(i4, objArrCopyOf.length >> 1, FirebaseAnalytics.Param.INDEX);
        char c3 = 2;
            ...
            if (iHighestOneBit <= 128) {
                    ...
                    while (true) {
                        ...
                        if (i12 == 255) {
                            ...
                            if (objRequireNonNull.equals(objArrCopyOf[i12 == true ? 1 : 0])) {
                                int i13 = ~i12;
                                zzar zzarVar4 = new zzar(objRequireNonNull, objRequireNonNull2, Objects.requireNonNull(objArrCopyOf[i13 == true ? 1 : 0]));
                ...
                if (i8 == i4) {
                    ...
                    if (z3) {
                        ...
                        zzar zzarVar5 = (zzar) objArr2[c];
                        if (zzasVar == null) {
                            throw zzarVar5.zza();
                        }
                        zzasVar.zzc = zzarVar5;
                    ...
                    return new zzbl(r33, objArrCopyOf, i4);
                }
                sArr = new Object[3];
                sArr[z ? 1 : 0] = bArr;
                ...
                if (iHighestOneBit > 32768) {
                        ...
                        while (true) {
                            ...
                            if (i19 == -1) {
                                ...
                                if (objRequireNonNull3.equals(objArrCopyOf[i19])) {
                                    int i20 = i19 ^ 1;
                                    zzar zzarVar6 = new zzar(objRequireNonNull3, objRequireNonNull4, Objects.requireNonNull(objArrCopyOf[i20]));
                    ...
                    return new zzbl(r332, objArrCopyOf, i4);
                }
                    ...
                    while (true) {
                        ...
                        if (c4 == 65535) {
                            ...
                            if (objRequireNonNull5.equals(objArrCopyOf[c4])) {
                                int i26 = c4 ^ 1;
                                zzar zzarVar7 = new zzar(objRequireNonNull5, objRequireNonNull6, Objects.requireNonNull(objArrCopyOf[i26 == true ? 1 : 0]));
                ...
                if (i21 == i4) {
                    ...
                    r32 = new Object[]{sArr, Integer.valueOf(i21), zzarVar3};
                    z4 = z;
                }
            }
        }
        ...
        return new zzbl(r3322, objArrCopyOf, i4);
    }
