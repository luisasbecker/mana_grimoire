...
final class zzapg implements ObjectEncoder {
    static final zzapg zza = new zzapg();
    ...
    static {
        ...
        FieldDescriptor.Builder builder2 = FieldDescriptor.builder(AndroidContextPlugin.DEVICE_KEY);
