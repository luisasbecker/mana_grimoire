...
final class zznt implements ObjectEncoderContext {
    ...
    private final zznx zzi = new zznx(this);
    ...
    static {
        ...
        zzd = new ObjectEncoder() { // from class: com.google.android.gms.internal.mlkit_vision_internal_vkp.zzns
            @Override // com.google.firebase.encoders.Encoder
            public final void encode(Object obj, ObjectEncoderContext objectEncoderContext) throws IOException {
                zznt.zzg((Map.Entry) obj, objectEncoderContext);
            }
        };
    }

    zznt(OutputStream outputStream, Map map, Map map2, ObjectEncoder objectEncoder) {
    ...
    private static int zzh(FieldDescriptor fieldDescriptor) {
        zznr zznrVar = (zznr) fieldDescriptor.getProperty(zznr.class);
        if (zznrVar != null) {
            return zznrVar.zza();
        }
    ...
    private static zznr zzj(FieldDescriptor fieldDescriptor) {
        zznr zznrVar = (zznr) fieldDescriptor.getProperty(zznr.class);
        if (zznrVar != null) {
            return zznrVar;
        }
    ...
    private final zznt zzk(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IOException {
    ...
    private final zznt zzl(ValueEncoder valueEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IOException {
            ...
            if (obj instanceof CharSequence) {
                ...
                if (!(obj instanceof byte[])) {
                    ...
                    if (obj instanceof zznp) {
                        zzd(fieldDescriptor, ((zznp) obj).zza(), true);
                        return this;
                    }
    ...
    final zznt zzd(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (!z || i != 0) {
            zznr zznrVarZzj = zzj(fieldDescriptor);
            int iOrdinal = zznrVarZzj.zzb().ordinal();
            if (iOrdinal == 0) {
                zzn(zznrVarZzj.zza() << 3);
                zzn(i);
                return this;
            }
            if (iOrdinal == 1) {
    ...
    final zznt zze(FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (!z || j != 0) {
            zznr zznrVarZzj = zzj(fieldDescriptor);
            int iOrdinal = zznrVarZzj.zzb().ordinal();
            if (iOrdinal == 0) {
    ...
    final zznt zzf(Object obj) throws IOException {
        if (obj == null) {
            return this;
        }
        ObjectEncoder objectEncoder = (ObjectEncoder) this.zzf.get(obj.getClass());
