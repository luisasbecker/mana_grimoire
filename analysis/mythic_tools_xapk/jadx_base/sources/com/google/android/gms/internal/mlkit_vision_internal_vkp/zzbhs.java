...
interface zzbhs {
    ...
    void zzF(int i, List list, boolean z) throws IOException;

    @Deprecated
    void zzG(int i) throws IOException;

    void zzH(int i, String str) throws IOException;

    void zzI(int i, List list) throws IOException;
    ...
    void zzd(int i, zzbdd zzbddVar) throws IOException;
    ...
    @Deprecated
    void zzq(int i, Object obj, zzbgm zzbgmVar) throws IOException;
    ...
    void zzv(int i, zzbfk zzbfkVar, Map map) throws IOException;

    void zzw(int i, Object obj, zzbgm zzbgmVar) throws IOException;

    void zzx(int i, Object obj) throws IOException;
