...
public final class zzic implements zzjg {
    ...
    zzic(zzjs zzjsVar) {
        ...
        com.google.android.gms.internal.measurement.zzkk zzkkVarZza = com.google.android.gms.internal.measurement.zzjx.zza(context);
        String packageName = context.getPackageName();
        String.valueOf(packageName);
        zzkkVarZza.zza("com.google.android.gms.measurement#".concat(String.valueOf(packageName)), 0, new String[0], null);
    ...
    public final boolean zzI() {
        ...
        if (zznlVarZzt.zzK()) {
            ...
            if (bundle == null) {
                ...
                zzgsVarZzj.zzb(sb2.toString(), Integer.valueOf(this.zzE));
                return z;
            }
            ...
            sb.append("&dma=");
            sb.append(!Objects.equals(zzbaVarZzh.zzj(), false) ? 1 : 0);
    ...
    final /* synthetic */ void zzJ(String str, int i, Throwable th, byte[] bArr, Map map) {
        ...
        if (th == null) {
            ...
            try {
                ...
                double dOptDouble = jSONObject.optDouble(DiagnosticsEntry.TIMESTAMP_KEY, AudioStats.AUDIO_AMPLITUDE_NONE);
                ...
                if (!TextUtils.isEmpty(strOptString)) {
                    ...
                    if (listQueryIntentActivities != null && !listQueryIntentActivities.isEmpty()) {
                        ...
                        this.zzp.zzE(DebugKt.DEBUG_PROPERTY_VALUE_AUTO, Constants.ScionAnalytics.EVENT_FIREBASE_CAMPAIGN, bundle);
                        zzN(zzppVar);
                        if (TextUtils.isEmpty(strOptString)) {
                            return;
                        }
