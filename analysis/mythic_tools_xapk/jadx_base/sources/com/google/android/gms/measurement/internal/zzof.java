...
public final class zzof {
    ...
    public static final Map zzd(ImmutableMap immutableMap, ImmutableMap immutableMap2, ImmutableSet immutableSet, char[] cArr, int i, int i2, int i3, int i4, int i5, String str, String str2, String str3, boolean z, boolean z2, boolean z3) {
        ...
        String str5 = true != zzc(zzabwVar, immutableMap, immutableMap2, immutableSet, cArr, i, i2, i3, i4, i5, str, str2, str3, z, z2, true) ? AppEventsConstants.EVENT_PARAM_VALUE_NO : "1";
        String str6 = true != zzc(zzabwVar2, immutableMap, immutableMap2, immutableSet, cArr, i, i2, i3, i4, i5, str, str2, str3, z, z2, true) ? AppEventsConstants.EVENT_PARAM_VALUE_NO : "1";
        String str7 = true != zzc(zzabwVar3, immutableMap, immutableMap2, immutableSet, cArr, i, i2, i3, i4, i5, str, str2, str3, z, z2, true) ? AppEventsConstants.EVENT_PARAM_VALUE_NO : "1";
        if (true == zzc(zzabwVar4, immutableMap, immutableMap2, immutableSet, cArr, i, i2, i3, i4, i5, str, str2, str3, z, z2, true)) {
            str4 = "1";
        }
        return builderPutAll.putAll(ImmutableMap.of("AuthorizePurpose1", (String) str5, "AuthorizePurpose3", (String) str6, "AuthorizePurpose4", (String) str7, "AuthorizePurpose7", str4, "PurposeDiagnostics", new String(cArr))).buildOrThrow();
    }
