...
final class zzbfg extends zzbcm implements RandomAccess, zzbes, zzbga {
    private static final zzbfg zza = new zzbfg(new long[0], 0, false);
    private long[] zzb;
    private int zzc;
    ...
    private zzbfg(long[] jArr, int i, boolean z) {
        super(z);
        this.zzb = jArr;
        this.zzc = i;
    }
    ...
    public final /* bridge */ /* synthetic */ zzbet zzd(int i) {
        if (i >= this.zzc) {
            return new zzbfg(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
