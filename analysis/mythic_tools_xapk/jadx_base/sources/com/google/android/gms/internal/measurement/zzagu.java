...
public final class zzagu implements zzagt {
    ...
    public final long zzA() {
        return ((Long) zza.zzb(27, "measurement.alarm_manager.minimum_interval", DurationKt.MILLIS_IN_MINUTE).get()).longValue();
    }
    ...
    public final long zzC() {
        return ((Long) zza.zzb(29, "measurement.monitoring.sample_period_millis", 86400000L).get()).longValue();
    }
    ...
    public final long zzX() {
        return ((Long) zza.zzb(53, "measurement.upload.stale_data_deletion_interval", 86400000L).get()).longValue();
    }
    ...
    public final String zzae() {
        return (String) zza.zzd(60, "measurement.rb.attribution.uri_scheme", ProxyConfig.MATCH_HTTPS).get();
    }
    ...
    public final long zzf() {
        return ((Long) zza.zzb(5, "measurement.config.cache_time", 86400000L).get()).longValue();
    }
    ...
    public final String zzh() {
        return (String) zza.zzd(8, "measurement.config.url_scheme", ProxyConfig.MATCH_HTTPS).get();
    }
