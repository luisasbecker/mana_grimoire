...
interface zzafo {
    ...
    void zzG(List list, zzafp zzafpVar, zzadf zzadfVar) throws IOException;

    @Deprecated
    void zzH(List list, zzafp zzafpVar, zzadf zzadfVar) throws IOException;
    ...
    void zzP(Map map, zzaeu zzaeuVar, zzadf zzadfVar) throws IOException;
    ...
    void zzo(Object obj, zzafp zzafpVar, zzadf zzadfVar) throws IOException;

    void zzp(Object obj, zzafp zzafpVar, zzadf zzadfVar) throws IOException;

    zzacr zzq() throws IOException;
