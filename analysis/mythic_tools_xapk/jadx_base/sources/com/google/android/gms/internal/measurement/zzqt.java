...
public final class zzqt {
    ...
    final zzqs zza() {
        ...
        int i = zzlg.zza;
        int iIndexOf = str.indexOf(ColorKt.HEX_PREFIX);
        if (iIndexOf >= 0) {
        ...
        if (iZzg != 0) {
            ...
            if (strZzc.isEmpty()) {
                ...
                if (optionalZze.isPresent()) {
                    ...
                    StringBuilder sb2 = new StringBuilder(String.valueOf(str3).length() + string.length() + String.valueOf(str4).length() + string2.length());
                    sb2.append(str3);
                    sb2.append(string);
                    sb2.append(str4);
                    sb2.append(string2);
                ...
                StringBuilder sb22 = new StringBuilder(String.valueOf(str32).length() + string3.length() + String.valueOf(str42).length() + string22.length());
                sb22.append(str32);
                sb22.append(string3);
                sb22.append(str42);
