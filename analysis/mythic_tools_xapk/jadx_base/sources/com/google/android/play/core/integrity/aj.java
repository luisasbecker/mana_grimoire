...
final class aj {
    ...
    final com.google.android.play.integrity.internal.ae f372a;
    ...
    aj(Context context, com.google.android.play.integrity.internal.s sVar, at atVar, k kVar) {
        ...
        if (com.google.android.play.integrity.internal.ai.b(context)) {
            this.f372a = new com.google.android.play.integrity.internal.ae(context, sVar, "IntegrityService", ak.f373a, new com.google.android.play.integrity.internal.z() { // from class: com.google.android.play.core.integrity.ae
    ...
    final Task b(Activity activity, Bundle bundle) {
        ...
        this.f372a.t(new ag(this, taskCompletionSource, bundle, activity, taskCompletionSource, i), taskCompletionSource);
    ...
    public final Task c(IntegrityTokenRequest integrityTokenRequest) {
        ...
        try {
            ...
            TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
            this.f372a.t(new af(this, taskCompletionSource, bArrDecode, lCloudProjectNumber, null, taskCompletionSource, integrityTokenRequest), taskCompletionSource);
            return taskCompletionSource.getTask();
