...
public class PlayCoreDialogWrapperActivity extends Activity {
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        if (bundle != null) {
            this.zza = (ResultReceiver) bundle.getParcelable(ProxyAmazonBillingActivity.EXTRAS_RESULT_RECEIVER);
            return;
        }
        this.zza = (ResultReceiver) getIntent().getParcelableExtra(ProxyAmazonBillingActivity.EXTRAS_RESULT_RECEIVER);
    ...
    protected final void onSaveInstanceState(Bundle bundle) {
        bundle.putParcelable(ProxyAmazonBillingActivity.EXTRAS_RESULT_RECEIVER, this.zza);
    }
}
