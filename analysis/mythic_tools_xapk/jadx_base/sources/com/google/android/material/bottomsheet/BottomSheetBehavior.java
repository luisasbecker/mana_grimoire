            ...
            public void onViewReleased(View view, float f, float f2) {
                ...
                if (f2 < 0.0f) {
                    ...
                    if (!z) {
                        ...
                        } else if (Math.abs(top2 - bottomSheetBehavior4.halfExpandedOffset) >= Math.abs(top2 - BottomSheetBehavior.this.collapsedOffset) || BottomSheetBehavior.this.shouldSkipHalfExpandedStateWhenDragging()) {
                        }
