...
public class HeroCarouselStrategy extends CarouselStrategy {
    ...
    public KeylineState onFirstChildMeasuredWithMargins(Carousel carousel, View view) {
        ...
        Arrangement arrangementFindLowestCostArrangement = Arrangement.findLowestCostArrangement(f2, fClamp, smallItemSizeMin, fMax, i3 != 0 ? doubleCounts(iArr) : iArr, f3, i3 != 0 ? doubleCounts(MEDIUM_COUNTS) : MEDIUM_COUNTS, fMin, iArr2);
