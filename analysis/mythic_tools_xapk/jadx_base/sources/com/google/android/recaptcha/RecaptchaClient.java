...
public interface RecaptchaClient {
    ...
    Object mo10129execute0E7RQCE(RecaptchaAction recaptchaAction, long j, Continuation<? super Result<String>> continuation);

    /* JADX INFO: renamed from: execute-gIAlu-s, reason: not valid java name */
    Object mo10130executegIAlus(RecaptchaAction recaptchaAction, Continuation<? super Result<String>> continuation);
}
