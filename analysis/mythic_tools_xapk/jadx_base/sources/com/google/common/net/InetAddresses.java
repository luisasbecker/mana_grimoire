...
public final class InetAddresses {
    ...
    private static String convertDottedQuadToHex(String str) {
        ...
        return strSubstring + Integer.toHexString(((bArrTextToNumericFormatV4[0] & 255) << 8) | (bArrTextToNumericFormatV4[1] & 255)) + Constants.SUBS_ID_BASE_PLAN_ID_SEPARATOR + Integer.toHexString((bArrTextToNumericFormatV4[3] & 255) | ((bArrTextToNumericFormatV4[2] & 255) << 8));
    }
