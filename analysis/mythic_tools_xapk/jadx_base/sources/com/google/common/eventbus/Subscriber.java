...
class Subscriber {
    ...
    final void dispatchEvent(final Object obj) {
        this.executor.execute(new Runnable() { // from class: com.google.common.eventbus.Subscriber$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m10135lambda$dispatchEvent$0$comgooglecommoneventbusSubscriber(obj);
            }
        });
    }
    ...
    /* synthetic */ void m10135lambda$dispatchEvent$0$comgooglecommoneventbusSubscriber(Object obj) {
        try {
