...
public final class PairedStatsAccumulator {
    ...
    public final LinearTransformation leastSquaresFit() {
        ...
        if (dSumOfSquaresOfDeltas > AudioStats.AUDIO_AMPLITUDE_NONE) {
            return statsAccumulator.sumOfSquaresOfDeltas() > AudioStats.AUDIO_AMPLITUDE_NONE ? LinearTransformation.mapping(this.xStats.mean(), this.yStats.mean()).withSlope(this.sumOfProductsOfDeltas / dSumOfSquaresOfDeltas) : LinearTransformation.horizontal(this.yStats.mean());
        }
