...
public final class LongMath {
    ...
    static final long[] powersOf10 = {1, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, C.NANOS_PER_SECOND, RealConnection.IDLE_CONNECTION_HEALTHY_NS, 100000000000L, 1000000000000L, 10000000000000L, 100000000000000L, 1000000000000000L, 10000000000000000L, 100000000000000000L, 1000000000000000000L};
    ...
    private enum MillerRabinTester {
        ...
        LARGE { // from class: com.google.common.math.LongMath.MillerRabinTester.2
            ...
            long mulMod(long j, long j2, long j3) {
                long j4 = j >>> 32;
                long j5 = j2 >>> 32;
                long j6 = j & MuxerUtil.UNSIGNED_INT_MAX_VALUE;
                long j7 = j2 & MuxerUtil.UNSIGNED_INT_MAX_VALUE;
            ...
            long squareMod(long j, long j2) {
                long j3 = j >>> 32;
                long j4 = j & MuxerUtil.UNSIGNED_INT_MAX_VALUE;
    ...
    public static double roundToDouble(long j, RoundingMode roundingMode) {
        ...
        double d = j;
        long j2 = (long) d;
        int iCompare = j2 == Long.MAX_VALUE ? -1 : Long.compare(j, j2);
        switch (AnonymousClass1.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
