...
public final class DoubleMath {
    ...
    public static boolean isMathematicalInteger(double d) {
        if (DoubleUtils.isFinite(d)) {
            return d == AudioStats.AUDIO_AMPLITUDE_NONE || 52 - Long.numberOfTrailingZeros(DoubleUtils.getSignificand(d)) <= Math.getExponent(d);
        }
        return false;
    }
    ...
    */
    public static int log2(double d, RoundingMode roundingMode) {
        ...
        Preconditions.checkArgument(d > AudioStats.AUDIO_AMPLITUDE_NONE && DoubleUtils.isFinite(d), "x must be positive and finite");
    ...
    static double roundIntermediate(double d, RoundingMode roundingMode) {
        ...
        switch (AnonymousClass1.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            ...
            case 5:
                ...
                return ((long) d) + ((long) (d > AudioStats.AUDIO_AMPLITUDE_NONE ? 1 : -1));
            case 6:
                return Math.rint(d);
            case 7:
