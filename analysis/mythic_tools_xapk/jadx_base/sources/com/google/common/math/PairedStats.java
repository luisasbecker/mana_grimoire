...
public final class PairedStats implements Serializable {
    ...
    public LinearTransformation leastSquaresFit() {
        ...
        if (dSumOfSquaresOfDeltas > AudioStats.AUDIO_AMPLITUDE_NONE) {
            return stats.sumOfSquaresOfDeltas() > AudioStats.AUDIO_AMPLITUDE_NONE ? LinearTransformation.mapping(this.xStats.mean(), this.yStats.mean()).withSlope(this.sumOfProductsOfDeltas / dSumOfSquaresOfDeltas) : LinearTransformation.horizontal(this.yStats.mean());
        }
