...
public abstract class LinearTransformation {
    ...
    private static final class RegularLinearTransformation extends LinearTransformation {
        ...
        private LinearTransformation createInverse() {
            double d = this.slope;
            return d != AudioStats.AUDIO_AMPLITUDE_NONE ? new RegularLinearTransformation(1.0d / d, (this.yIntercept * (-1.0d)) / d, this) : new VerticalLinearTransformation(this.yIntercept, this);
        }
