...
public abstract class CaseFormat {
    ...
    public static final CaseFormat LOWER_HYPHEN = new CaseFormat("LOWER_HYPHEN", 0, CharMatcher.is(Soundex.SILENT_MARKER), "-") { // from class: com.google.common.base.CaseFormat.1
        @Override // com.google.common.base.CaseFormat
        String convert(CaseFormat caseFormat, String str) {
            return caseFormat == LOWER_UNDERSCORE ? str.replace(Soundex.SILENT_MARKER, '_') : caseFormat == UPPER_UNDERSCORE ? Ascii.toUpperCase(str.replace(Soundex.SILENT_MARKER, '_')) : super.convert(caseFormat, str);
        }
    ...
    static {
        ...
        LOWER_UNDERSCORE = new CaseFormat("LOWER_UNDERSCORE", 1, CharMatcher.is('_'), str) { // from class: com.google.common.base.CaseFormat.2
            ...
            String convert(CaseFormat caseFormat, String str2) {
                return caseFormat == LOWER_HYPHEN ? str2.replace('_', Soundex.SILENT_MARKER) : caseFormat == UPPER_UNDERSCORE ? Ascii.toUpperCase(str2) : super.convert(caseFormat, str2);
            }
        ...
        UPPER_UNDERSCORE = new CaseFormat("UPPER_UNDERSCORE", 4, CharMatcher.is('_'), str) { // from class: com.google.common.base.CaseFormat.5
            ...
            String convert(CaseFormat caseFormat, String str3) {
                return caseFormat == LOWER_HYPHEN ? Ascii.toLowerCase(str3.replace('_', Soundex.SILENT_MARKER)) : caseFormat == LOWER_UNDERSCORE ? Ascii.toLowerCase(str3) : super.convert(caseFormat, str3);
            }
    ...
    String convert(CaseFormat caseFormat, String str) {
        ...
        return length == 0 ? caseFormat.normalizeFirstWord(str) : ((StringBuilder) java.util.Objects.requireNonNull(sb)).append(caseFormat.normalizeWord(str.substring(length))).toString();
    }
