...
abstract class AggregateFuture<InputT, OutputT> extends AggregateFutureState<OutputT> {
    ...
    public void m10157lambda$init$1$comgooglecommonutilconcurrentAggregateFuture(@CheckForNull ImmutableCollection<? extends Future<? extends InputT>> immutableCollection) {
    ...
    public void m10156lambda$init$0$comgooglecommonutilconcurrentAggregateFuture(int i, ListenableFuture<? extends InputT> listenableFuture) {
        try {
            ...
            m10157lambda$init$1$comgooglecommonutilconcurrentAggregateFuture(null);
        }
    }
    ...
    final void init() {
        ...
        if (!this.allMustSucceed) {
            ...
            Runnable runnable = new Runnable() { // from class: com.google.common.util.concurrent.AggregateFuture$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    this.f$0.m10157lambda$init$1$comgooglecommonutilconcurrentAggregateFuture(immutableCollection);
                }
            };
            ...
            while (it.hasNext()) {
                ...
                if (next.isDone()) {
                    m10157lambda$init$1$comgooglecommonutilconcurrentAggregateFuture(immutableCollection);
                } else {
        ...
        while (it2.hasNext()) {
            ...
            int i2 = i + 1;
            if (next2.isDone()) {
                m10156lambda$init$0$comgooglecommonutilconcurrentAggregateFuture(i, next2);
            } else {
                next2.addListener(new Runnable() { // from class: com.google.common.util.concurrent.AggregateFuture$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m10156lambda$init$0$comgooglecommonutilconcurrentAggregateFuture(i, next2);
                    }
