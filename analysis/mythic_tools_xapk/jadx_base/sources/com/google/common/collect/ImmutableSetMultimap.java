...
public class ImmutableSetMultimap<K, V> extends ImmutableMultimap<K, V> implements SetMultimap<K, V> {
    ...
    public static final class Builder<K, V> extends ImmutableMultimap.Builder<K, V> {
        ...
        ImmutableCollection.Builder<V> newValueCollectionBuilderWithExpectedSize(int i) {
            return this.valueComparator == null ? ImmutableSet.builderWithExpectedSize(i) : new ImmutableSortedSet.Builder(this.valueComparator, i);
        }
    ...
    private void readObject(ObjectInputStream objectInputStream) throws ClassNotFoundException, IOException {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            ...
            for (int i5 = 0; i5 < i4; i5++) {
                builderValuesBuilder.add(Objects.requireNonNull(objectInputStream.readObject()));
            }
