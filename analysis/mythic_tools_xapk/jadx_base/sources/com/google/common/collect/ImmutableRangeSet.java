...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
    ...
    private ImmutableList<Range<C>> intersectRanges(final Range<C> range) {
        ...
        final int iBinarySearch2 = (zHasUpperBound ? SortedLists.binarySearch(immutableList, new ImmutableRangeMap$$ExternalSyntheticLambda1(), range.upperBound, SortedLists.KeyPresentBehavior.FIRST_PRESENT, SortedLists.KeyAbsentBehavior.NEXT_HIGHER) : immutableList.size()) - iBinarySearch;
