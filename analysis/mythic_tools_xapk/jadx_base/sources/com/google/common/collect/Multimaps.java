...
public final class Multimaps {
    ...
    private static class CustomListMultimap<K, V> extends AbstractListMultimap<K, V> {
        ...
        private void readObject(ObjectInputStream objectInputStream) throws ClassNotFoundException, IOException {
            ...
            this.factory = (Supplier) Objects.requireNonNull(objectInputStream.readObject());
            setMap((Map) Objects.requireNonNull(objectInputStream.readObject()));
        }
    ...
    private static class CustomSortedSetMultimap<K, V> extends AbstractSortedSetMultimap<K, V> {
        ...
        private void readObject(ObjectInputStream objectInputStream) throws ClassNotFoundException, IOException {
            objectInputStream.defaultReadObject();
            Supplier<? extends SortedSet<V>> supplier = (Supplier) Objects.requireNonNull(objectInputStream.readObject());
                ...
                public Iterator<V> iterator() {
                    return new Iterator<V>() { // from class: com.google.common.collect.Multimaps.MapMultimap.1.1
                        ...
                        public boolean hasNext() {
                            return this.i == 0 && AnonymousClass1.this.this$0.map.containsKey(k);
                        }
                        ...
                        public V next() {
                            ...
                            this.i++;
                            return (V) NullnessCasts.uncheckedCastNullableTToT(AnonymousClass1.this.this$0.map.get(k));
                        }
                        ...
                        public void remove() {
                            ...
                            this.i = -1;
                            AnonymousClass1.this.this$0.map.remove(k);
                        }
                    };
                }
    ...
    private static final class TransformedEntriesListMultimap<K, V1, V2> extends TransformedEntriesMultimap<K, V1, V2> implements ListMultimap<K, V2> {
        ...
        public List<V2> get(@ParametricNullness K k) {
            return m10134x893217c0((Object) k, (Collection) this.fromMultimap.get(k));
        }

        /* JADX WARN: Multi-variable type inference failed */
        @Override // com.google.common.collect.Multimaps.TransformedEntriesMultimap, com.google.common.collect.Multimap, com.google.common.collect.ListMultimap
        public List<V2> removeAll(@CheckForNull Object obj) {
            return m10134x893217c0(obj, (Collection) this.fromMultimap.removeAll(obj));
        }
        ...
        public List<V2> m10134x893217c0(@ParametricNullness K k, Collection<V1> collection) {
    ...
    static class TransformedEntriesMultimap<K, V1, V2> extends AbstractMultimap<K, V2> {
        ...
        Map<K, Collection<V2>> createAsMap() {
            return Maps.transformEntries(this.fromMultimap.asMap(), new Maps.EntryTransformer() { // from class: com.google.common.collect.Multimaps$TransformedEntriesMultimap$$ExternalSyntheticLambda0
                ...
                public final Object transformEntry(Object obj, Object obj2) {
                    return this.f$0.m10134x893217c0(obj, (Collection) obj2);
                }
            });
        }
        ...
        public Collection<V2> get(@ParametricNullness K k) {
            return m10134x893217c0(k, this.fromMultimap.get(k));
        }
        ...
        public Collection<V2> removeAll(@CheckForNull Object obj) {
            return m10134x893217c0(obj, this.fromMultimap.removeAll(obj));
        }
        ...
        public Collection<V2> m10134x893217c0(@ParametricNullness K k, Collection<V1> collection) {
