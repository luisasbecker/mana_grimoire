...
public class TreeMultimap<K, V> extends AbstractSortedKeySortedSetMultimap<K, V> {
    ...
    private void readObject(ObjectInputStream objectInputStream) throws ClassNotFoundException, IOException {
        ...
        this.keyComparator = (Comparator) Objects.requireNonNull((Comparator) objectInputStream.readObject());
        this.valueComparator = (Comparator) Objects.requireNonNull((Comparator) objectInputStream.readObject());
