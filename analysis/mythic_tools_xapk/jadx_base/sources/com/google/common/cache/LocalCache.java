...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    static class LoadingValueReference<K, V> implements ValueReference<K, V> {
        ...
        /* synthetic */ Object m10131x59597480(Object obj) {
            set(obj);
            return obj;
        }
            ...
            try {
                ...
                return listenableFutureReload == null ? Futures.immediateFuture(null) : Futures.transform(listenableFutureReload, new Function() { // from class: com.google.common.cache.LocalCache$LoadingValueReference$$ExternalSyntheticLambda0
                    ...
                    public final Object apply(Object obj) {
                        return this.f$0.m10131x59597480(obj);
                    }
    ...
    static class Segment<K, V> extends ReentrantLock {
        ...
        V get(K k, int i, CacheLoader<? super K, V> cacheLoader) throws Throwable {
            ...
            i2 = i;
            cacheLoader2 = cacheLoader;
            V vLockedGetOrLoad = segment.lockedGetOrLoad(k2, i2, cacheLoader2);
            segment.postReadCleanup();
        ...
        /* synthetic */ void m10132lambda$loadAsync$0$comgooglecommoncacheLocalCache$Segment(Object obj, int i, LoadingValueReference loadingValueReference, ListenableFuture listenableFuture) {
            try {
        ...
        ListenableFuture<V> loadAsync(final K k, final int i, final LoadingValueReference<K, V> loadingValueReference, CacheLoader<? super K, V> cacheLoader) {
            ...
            listenableFutureLoadFuture.addListener(new Runnable() { // from class: com.google.common.cache.LocalCache$Segment$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m10132lambda$loadAsync$0$comgooglecommoncacheLocalCache$Segment(k, i, loadingValueReference, listenableFutureLoadFuture);
                }
            }, MoreExecutors.directExecutor());
