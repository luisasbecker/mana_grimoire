...
class CrashlyticsController {
    ...
    static List<NativeSessionFile> getNativeSessionFiles(NativeSessionFileProvider nativeSessionFileProvider, String str, FileStore fileStore, byte[] bArr) {
        ...
        arrayList.add(new FileBackedNativeSessionFile("app_meta_file", AndroidContextPlugin.APP_KEY, nativeSessionFileProvider.getAppFile()));
        arrayList.add(new FileBackedNativeSessionFile("device_meta_file", AndroidContextPlugin.DEVICE_KEY, nativeSessionFileProvider.getDeviceFile()));
        arrayList.add(new FileBackedNativeSessionFile("os_meta_file", AndroidContextPlugin.OS_KEY, nativeSessionFileProvider.getOsFile()));
    ...
    /* synthetic */ void m10189xe0c67ca9(String str) {
