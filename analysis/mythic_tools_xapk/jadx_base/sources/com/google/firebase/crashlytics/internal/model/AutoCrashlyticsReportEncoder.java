...
public final class AutoCrashlyticsReportEncoder implements Configurator {
    ...
    private static final class CrashlyticsReportApplicationExitInfoEncoder implements ObjectEncoder<CrashlyticsReport.ApplicationExitInfo> {
        ...
        private static final FieldDescriptor TIMESTAMP_DESCRIPTOR = FieldDescriptor.of(DiagnosticsEntry.TIMESTAMP_KEY);
    ...
    private static final class CrashlyticsReportCustomAttributeEncoder implements ObjectEncoder<CrashlyticsReport.CustomAttribute> {
        ...
        private static final FieldDescriptor KEY_DESCRIPTOR = FieldDescriptor.of(SubscriberAttributeKt.JSON_NAME_KEY);
    ...
    private static final class CrashlyticsReportSessionDeviceEncoder implements ObjectEncoder<CrashlyticsReport.Session.Device> {
        ...
        private static final FieldDescriptor ARCH_DESCRIPTOR = FieldDescriptor.of("arch");
        private static final FieldDescriptor MODEL_DESCRIPTOR = FieldDescriptor.of(AndroidContextPlugin.DEVICE_MODEL_KEY);
        ...
        private static final FieldDescriptor MANUFACTURER_DESCRIPTOR = FieldDescriptor.of(AndroidContextPlugin.DEVICE_MANUFACTURER_KEY);
    ...
    private static final class CrashlyticsReportSessionEncoder implements ObjectEncoder<CrashlyticsReport.Session> {
        ...
        private static final FieldDescriptor APP_DESCRIPTOR = FieldDescriptor.of(AndroidContextPlugin.APP_KEY);
        private static final FieldDescriptor USER_DESCRIPTOR = FieldDescriptor.of("user");
        private static final FieldDescriptor OS_DESCRIPTOR = FieldDescriptor.of(AndroidContextPlugin.OS_KEY);
        private static final FieldDescriptor DEVICE_DESCRIPTOR = FieldDescriptor.of(AndroidContextPlugin.DEVICE_KEY);
