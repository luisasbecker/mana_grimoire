...
class GmsRpc {
    ...
    private Task<String> extractResponseWhenComplete(Task<Bundle> task) {
        return task.continueWith(new PixelCopyCompat$Companion$$ExternalSyntheticLambda1(), new Continuation() { // from class: com.google.firebase.messaging.GmsRpc$$ExternalSyntheticLambda0
            @Override // com.google.android.gms.tasks.Continuation
            public final Object then(Task task2) {
                return this.f$0.m10236xb80eb67f(task2);
            }
        });
    }
    ...
    /* synthetic */ String m10236xb80eb67f(Task task) throws Exception {
