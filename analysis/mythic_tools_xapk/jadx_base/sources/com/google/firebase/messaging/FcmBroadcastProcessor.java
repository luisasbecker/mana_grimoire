...
public class FcmBroadcastProcessor {
    ...
    public FcmBroadcastProcessor(Context context) {
        ...
        this.executor = new PixelCopyCompat$Companion$$ExternalSyntheticLambda1();
    }
    ...
    private static Task<Integer> bindToMessagingService(Context context, Intent intent, boolean z) {
        ...
        if (!z) {
            return serviceConnection.sendIntent(intent).continueWith(new PixelCopyCompat$Companion$$ExternalSyntheticLambda1(), new Continuation() { // from class: com.google.firebase.messaging.FcmBroadcastProcessor$$ExternalSyntheticLambda3
    ...
    static /* synthetic */ Task lambda$startMessagingService$2(Context context, Intent intent, boolean z, Task task) throws Exception {
        return (PlatformVersion.isAtLeastO() && ((Integer) task.getResult()).intValue() == 402) ? bindToMessagingService(context, intent, z).continueWith(new PixelCopyCompat$Companion$$ExternalSyntheticLambda1(), new Continuation() { // from class: com.google.firebase.messaging.FcmBroadcastProcessor$$ExternalSyntheticLambda0
            @Override // com.google.android.gms.tasks.Continuation
    ...
    public Task<Integer> startMessagingService(final Context context, final Intent intent) {
        ...
        return (!z || z2) ? Tasks.call(this.executor, new Callable() { // from class: com.google.firebase.messaging.FcmBroadcastProcessor$$ExternalSyntheticLambda1
