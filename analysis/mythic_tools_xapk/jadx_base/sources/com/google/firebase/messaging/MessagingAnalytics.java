...
public class MessagingAnalytics {
    ...
    static String getMessageTypeForScion(Bundle bundle) {
        return (bundle == null || !NotificationParams.isNotification(bundle)) ? Constants.ScionAnalytics.MessageType.DATA_MESSAGE : "display";
    }
    ...
    static long getProjectNumber(Bundle bundle) {
        ...
        if (applicationId.startsWith("1:")) {
            String[] strArrSplit = applicationId.split(com.revenuecat.purchases.common.Constants.SUBS_ID_BASE_PLAN_ID_SEPARATOR);
