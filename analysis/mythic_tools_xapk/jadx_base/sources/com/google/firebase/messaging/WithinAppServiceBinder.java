...
class WithinAppServiceBinder extends Binder {
    ...
    void send(final WithinAppServiceConnection.BindRequest bindRequest) {
        ...
        this.intentHandler.handle(bindRequest.intent).addOnCompleteListener(new PixelCopyCompat$Companion$$ExternalSyntheticLambda1(), new OnCompleteListener() { // from class: com.google.firebase.messaging.WithinAppServiceBinder$$ExternalSyntheticLambda0
