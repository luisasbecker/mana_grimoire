    ...
    public final void zzb() throws MlKitException {
        ...
        try {
            ...
            if (this.zzb.getIsThickClient()) {
                ...
                int loggingLanguageOption = this.zzb.getLoggingLanguageOption();
                Context context = this.zza;
                zzuvVarZzd = loggingLanguageOption == 1 ? zzuyVarZza.zzd(ObjectWrapper.wrap(context)) : zzuyVarZza.zze(ObjectWrapper.wrap(context), zzd(this.zzb, strZza));
            }
            this.zzf = zzuvVarZzd;
