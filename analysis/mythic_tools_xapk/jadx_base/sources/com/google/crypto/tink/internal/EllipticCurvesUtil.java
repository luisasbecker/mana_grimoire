...
public final class EllipticCurvesUtil {
    ...
    static class JacobianEcPoint {
        ...
        ECPoint toECPoint(BigInteger bigInteger) {
            ...
            BigInteger bigIntegerModInverse = this.z.modInverse(bigInteger);
            BigInteger bigIntegerMod = bigIntegerModInverse.multiply(bigIntegerModInverse).mod(bigInteger);
            return new ECPoint(this.x.multiply(bigIntegerMod).mod(bigInteger), this.y.multiply(bigIntegerMod).mod(bigInteger).multiply(bigIntegerModInverse).mod(bigInteger));
        }
    }
    ...
    static JacobianEcPoint addJacobianPoints(JacobianEcPoint jacobianEcPoint, JacobianEcPoint jacobianEcPoint2, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger bigIntegerMod = jacobianEcPoint.z.multiply(jacobianEcPoint.z).mod(bigInteger2);
        BigInteger bigIntegerMod2 = jacobianEcPoint2.z.multiply(jacobianEcPoint2.z).mod(bigInteger2);
        BigInteger bigIntegerMod3 = jacobianEcPoint.x.multiply(bigIntegerMod2).mod(bigInteger2);
        BigInteger bigIntegerMod4 = jacobianEcPoint2.x.multiply(bigIntegerMod).mod(bigInteger2);
        BigInteger bigIntegerMod5 = jacobianEcPoint.y.multiply(jacobianEcPoint2.z).mod(bigInteger2).multiply(bigIntegerMod2).mod(bigInteger2);
        BigInteger bigIntegerMod6 = jacobianEcPoint2.y.multiply(jacobianEcPoint.z).mod(bigInteger2).multiply(bigIntegerMod).mod(bigInteger2);
        if (bigIntegerMod3.equals(bigIntegerMod4)) {
            return !bigIntegerMod5.equals(bigIntegerMod6) ? JacobianEcPoint.INFINITY : doubleJacobianPoint(jacobianEcPoint, bigInteger, bigInteger2);
        }
        BigInteger bigIntegerMod7 = bigIntegerMod4.subtract(bigIntegerMod3).mod(bigInteger2);
        BigInteger bigIntegerMod8 = bigIntegerMod7.multiply(FOUR).multiply(bigIntegerMod7).mod(bigInteger2);
        ...
        BigInteger bigIntegerAdd = jacobianEcPoint.z.add(jacobianEcPoint2.z);
        return new JacobianEcPoint(bigIntegerMod12, bigIntegerMod13, bigIntegerAdd.multiply(bigIntegerAdd).mod(bigInteger2).subtract(bigIntegerMod).subtract(bigIntegerMod2).multiply(bigIntegerMod7).mod(bigInteger2));
    }
    ...
    static JacobianEcPoint doubleJacobianPoint(JacobianEcPoint jacobianEcPoint, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger bigIntegerMod = jacobianEcPoint.x.multiply(jacobianEcPoint.x).mod(bigInteger2);
        BigInteger bigIntegerMod2 = jacobianEcPoint.y.multiply(jacobianEcPoint.y).mod(bigInteger2);
        BigInteger bigIntegerMod3 = bigIntegerMod2.multiply(bigIntegerMod2).mod(bigInteger2);
        BigInteger bigIntegerMod4 = jacobianEcPoint.z.multiply(jacobianEcPoint.z).mod(bigInteger2);
        BigInteger bigIntegerAdd = jacobianEcPoint.x.add(bigIntegerMod2);
        ...
        BigInteger bigIntegerAdd2 = bigIntegerMod.multiply(THREE).add(bigInteger.multiply(bigIntegerMod4).multiply(bigIntegerMod4).mod(bigInteger2));
        ...
        BigInteger bigIntegerMod6 = bigIntegerAdd2.multiply(bigIntegerMultiply.subtract(bigIntegerMod5)).mod(bigInteger2).subtract(bigIntegerMod3.multiply(EIGHT)).mod(bigInteger2);
        BigInteger bigIntegerAdd3 = jacobianEcPoint.y.add(jacobianEcPoint.z);
        return new JacobianEcPoint(bigIntegerMod5, bigIntegerMod6, bigIntegerAdd3.multiply(bigIntegerAdd3).mod(bigInteger2).subtract(bigIntegerMod2).subtract(bigIntegerMod4).mod(bigInteger2));
    }
    ...
    static JacobianEcPoint toJacobianEcPoint(ECPoint eCPoint, BigInteger bigInteger) {
        ...
        BigInteger bigIntegerMod = new BigInteger(1, Random.randBytes((bigInteger.bitLength() + 8) / 8)).mod(bigInteger);
        BigInteger bigIntegerMod2 = bigIntegerMod.multiply(bigIntegerMod).mod(bigInteger);
        return new JacobianEcPoint(eCPoint.getAffineX().multiply(bigIntegerMod2).mod(bigInteger), eCPoint.getAffineY().multiply(bigIntegerMod2.multiply(bigIntegerMod).mod(bigInteger)).mod(bigInteger), bigIntegerMod);
    }
}
