    ...
    public static final class Builder {
        ...
        public FieldInfo build() {
            ...
            if (field != null) {
                ...
                return z ? FieldInfo.forProto2RequiredField(field2, this.fieldNumber, this.type, field, this.presenceMask, this.enforceUtf8, this.enumVerifier) : FieldInfo.forProto2OptionalField(field2, this.fieldNumber, this.type, field, this.presenceMask, this.enforceUtf8, this.enumVerifier);
            }
