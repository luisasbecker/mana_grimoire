...
public abstract class CameraGLRendererBase implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    private void drawTex(int i, boolean z, int i2) {
        ...
        if (z) {
            ...
            GLES20.glUniform1i(GLES20.glGetUniformLocation(this.progOES, GLUtils.VAR_TEXTURE), 0);
        } else {
            GLES20.glBindTexture(3553, i);
            GLES20.glUniform1i(GLES20.glGetUniformLocation(this.prog2D, GLUtils.VAR_TEXTURE), 0);
        }
