...
public final class HmacUtils {
    ...
    public byte[] hmac(Path path) throws IOException {
        BufferedInputStream bufferedInputStream = new BufferedInputStream(Files.newInputStream(path, new OpenOption[0]));
        try {
            byte[] bArrHmac = hmac(bufferedInputStream);
    ...
    public String hmacHex(Path path) throws IOException {
        return Hex.encodeHexString(hmac(path));
    }
