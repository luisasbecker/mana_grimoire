...
public class DoubleMetaphone implements StringEncoder {
    ...
    private boolean conditionCH1(String str, int i) {
        if (!contains(str, 0, 4, "VAN ", "VON ") && !contains(str, 0, 3, "SCH") && !contains(str, i - 2, 6, "ORCHES", "ARCHIT", "ORCHID")) {
            int i2 = i + 2;
            if (!contains(str, i2, 1, ExifInterface.GPS_DIRECTION_TRUE, ExifInterface.LATITUDE_SOUTH) && ((!contains(str, i - 1, 1, ExifInterface.GPS_MEASUREMENT_IN_PROGRESS, "O", "U", ExifInterface.LONGITUDE_EAST) && i != 0) || (!contains(str, i2, 1, L_R_N_M_B_H_F_V_W_SPACE) && i + 1 != str.length() - 1))) {
                return false;
            }
        }
        return true;
    ...
    private int handleGH(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        ...
        if (i > 2 && charAt(str, i - 1) == 'U' && contains(str, i - 3, 1, "C", GameUtils.CONDITION_GOOD, "L", "R", ExifInterface.GPS_DIRECTION_TRUE)) {
    ...
    */
    ...
    private int handleP(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        ...
        return contains(str, i2, 1, GameUtils.CONDITION_POOR, "B") ? i + 2 : i2;
    }
