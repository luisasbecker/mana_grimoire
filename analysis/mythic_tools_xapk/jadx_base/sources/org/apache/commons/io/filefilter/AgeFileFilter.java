...
public class AgeFileFilter extends AbstractFileFilter implements Serializable {
    ...
    public FileVisitResult accept(final Path path, BasicFileAttributes basicFileAttributes) {
        return get(new IOSupplier() { // from class: org.apache.commons.io.filefilter.AgeFileFilter$$ExternalSyntheticLambda0
            ...
            public final Object get() {
                return this.f$0.m13261lambda$accept$0$orgapachecommonsiofilefilterAgeFileFilter(path);
            }
        });
    }
    ...
    /* synthetic */ FileVisitResult m13261lambda$accept$0$orgapachecommonsiofilefilterAgeFileFilter(Path path) throws IOException {
