...
public class IOUtils {
    ...
    private static final ThreadLocal<byte[]> SCRATCH_BYTE_BUFFER_RW = ThreadLocal.withInitial(new Supplier() { // from class: org.apache.commons.io.IOUtils$$ExternalSyntheticLambda8
    ...
    private static final ThreadLocal<char[]> SCRATCH_CHAR_BUFFER_RW = ThreadLocal.withInitial(new Supplier() { // from class: org.apache.commons.io.IOUtils$$ExternalSyntheticLambda9
        @Override // java.util.function.Supplier
        public final Object get() {
    ...
    public static int copy(InputStream inputStream, OutputStream outputStream) throws IOException {
        ...
        if (jCopyLarge > SieveCacheKt.NodeLinkMask) {
            return -1;
        }
    ...
    public static long skip(InputStream inputStream, long j) throws IOException {
        return skip(inputStream, j, new IOUtils$$ExternalSyntheticLambda4());
    }
    ...
    public static void skipFully(InputStream inputStream, long j) throws IOException {
        long jSkip = skip(inputStream, j, new IOUtils$$ExternalSyntheticLambda4());
        if (jSkip != j) {
    ...
    public static byte[] toByteArray(InputStream inputStream) throws IOException {
        ...
        try {
            ThresholdingOutputStream thresholdingOutputStream = new ThresholdingOutputStream(Integer.MAX_VALUE, new IOConsumer() { // from class: org.apache.commons.io.IOUtils$$ExternalSyntheticLambda6
                @Override // org.apache.commons.io.function.IOConsumer
                public final void accept(Object obj) throws IOException {
                    IOUtils.lambda$toByteArray$0((ThresholdingOutputStream) obj);
                }
            }, new IOFunction() { // from class: org.apache.commons.io.IOUtils$$ExternalSyntheticLambda7
    ...
    public static String toString(IOSupplier<InputStream> iOSupplier, Charset charset) throws IOException {
        return toString(iOSupplier, charset, new IOSupplier() { // from class: org.apache.commons.io.IOUtils$$ExternalSyntheticLambda5
            @Override // org.apache.commons.io.function.IOSupplier
            public final Object get() {
    ...
    public static Writer writer(Appendable appendable) {
        ...
        return appendable instanceof Writer ? (Writer) appendable : appendable instanceof StringBuilder ? new StringBuilderWriter((StringBuilder) appendable) : new AppendableWriter(appendable);
    }
}
