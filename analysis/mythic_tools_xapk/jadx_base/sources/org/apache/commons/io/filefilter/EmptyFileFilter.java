...
public class EmptyFileFilter extends AbstractFileFilter implements Serializable {
    ...
    public FileVisitResult accept(final Path path, BasicFileAttributes basicFileAttributes) {
        return path == null ? toFileVisitResult(true) : get(new IOSupplier() { // from class: org.apache.commons.io.filefilter.EmptyFileFilter$$ExternalSyntheticLambda0
            @Override // org.apache.commons.io.function.IOSupplier
            public final Object get() {
                return this.f$0.m13262lambda$accept$0$orgapachecommonsiofilefilterEmptyFileFilter(path);
            }
        });
    }
    ...
    /* synthetic */ FileVisitResult m13262lambda$accept$0$orgapachecommonsiofilefilterEmptyFileFilter(Path path) throws IOException {
