...
public class SizeFileFilter extends AbstractFileFilter implements Serializable {
    ...
    public FileVisitResult accept(final Path path, BasicFileAttributes basicFileAttributes) {
        return get(new IOSupplier() { // from class: org.apache.commons.io.filefilter.SizeFileFilter$$ExternalSyntheticLambda0
            ...
            public final Object get() {
                return this.f$0.m13268lambda$accept$0$orgapachecommonsiofilefilterSizeFileFilter(path);
            }
        });
    }
    ...
    /* synthetic */ FileVisitResult m13268lambda$accept$0$orgapachecommonsiofilefilterSizeFileFilter(Path path) throws IOException {
