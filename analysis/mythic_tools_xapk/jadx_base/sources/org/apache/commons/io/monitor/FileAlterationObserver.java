...
public class FileAlterationObserver implements Serializable {
    ...
    public static final class Builder extends AbstractOriginSupplier<FileAlterationObserver, Builder> {
        ...
        public FileAlterationObserver get() throws IOException {
            return new FileAlterationObserver(this, (AnonymousClass1) null);
        }
    ...
    /* synthetic */ FileAlterationObserver(Builder builder, AnonymousClass1 anonymousClass1) {
        this(builder);
    }
    ...
    private void checkAndFire(FileEntry fileEntry, FileEntry[] fileEntryArr, File[] fileArr) {
        ...
        for (FileEntry fileEntry2 : fileEntryArr) {
            while (i < fileArr.length && this.comparator.compare(fileEntry2.getFile(), fileArr[i]) > 0) {
                FileEntry fileEntryM13308xd1c1b90a = m13308xd1c1b90a(fileEntry, fileArr[i]);
                fileEntryArr2[i] = fileEntryM13308xd1c1b90a;
                fireOnCreate(fileEntryM13308xd1c1b90a);
                i++;
            }
        ...
        while (i < fileArr.length) {
            FileEntry fileEntryM13308xd1c1b90a2 = m13308xd1c1b90a(fileEntry, fileArr[i]);
            fileEntryArr2[i] = fileEntryM13308xd1c1b90a2;
            fireOnCreate(fileEntryM13308xd1c1b90a2);
            i++;
        }
    ...
    public FileEntry m13308xd1c1b90a(FileEntry fileEntry, File file) {
    ...
    private FileEntry[] listFileEntries(File file, final FileEntry fileEntry) {
        return (FileEntry[]) Stream.of((Object[]) listFiles(file)).map(new Function() { // from class: org.apache.commons.io.monitor.FileAlterationObserver$$ExternalSyntheticLambda2
            ...
            public final Object apply(Object obj) {
                return this.f$0.m13308xd1c1b90a(fileEntry, (File) obj);
            }
    ...
    public void checkAndNotify() {
        this.listeners.forEach(new Consumer() { // from class: org.apache.commons.io.monitor.FileAlterationObserver$$ExternalSyntheticLambda6
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                this.f$0.m13306x2d975733((FileAlterationListener) obj);
            }
        });
        ...
        this.listeners.forEach(new Consumer() { // from class: org.apache.commons.io.monitor.FileAlterationObserver$$ExternalSyntheticLambda7
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                this.f$0.m13307x47b2d5d2((FileAlterationListener) obj);
            }
        });
    }
    ...
    /* synthetic */ void m13306x2d975733(FileAlterationListener fileAlterationListener) {
    ...
    /* synthetic */ void m13307x47b2d5d2(FileAlterationListener fileAlterationListener) {
