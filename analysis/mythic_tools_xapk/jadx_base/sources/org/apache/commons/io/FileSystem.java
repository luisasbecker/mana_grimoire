...
public enum FileSystem {
    ...
    /* synthetic */ int m13237lambda$toLegalFileName$0$orgapachecommonsioFileSystem(char c, int i) {
    ...
    public String toLegalFileName(String str, final char c) {
        ...
        int[] array = str.chars().map(new IntUnaryOperator() { // from class: org.apache.commons.io.FileSystem$$ExternalSyntheticLambda0
            ...
            public final int applyAsInt(int i2) {
                return this.f$0.m13237lambda$toLegalFileName$0$orgapachecommonsioFileSystem(c, i2);
            }
        }).toArray();
