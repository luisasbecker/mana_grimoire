    ...
    public JobListenableFuture(Job job, SettableFuture<R> underlying) {
        ...
        job.invokeOnCompletion(new Function1<Throwable, Unit>(this) { // from class: androidx.work.JobListenableFuture.1
            ...
            public final void invoke2(Throwable th) {
                ...
                JobListenableFuture<R> jobListenableFuture = this.this$0;
                if (z) {
                    ((JobListenableFuture) jobListenableFuture).underlying.cancel(true);
                    return;
                }
                SettableFuture settableFuture = ((JobListenableFuture) jobListenableFuture).underlying;
