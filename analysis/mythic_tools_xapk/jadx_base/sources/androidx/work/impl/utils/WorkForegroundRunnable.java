...
public class WorkForegroundRunnable implements Runnable {
    ...
    /* synthetic */ void m9898lambda$run$0$androidxworkimplutilsWorkForegroundRunnable(SettableFuture settableFuture) {
    ...
    public void run() {
        ...
        this.mTaskExecutor.getMainThreadExecutor().execute(new Runnable() { // from class: androidx.work.impl.utils.WorkForegroundRunnable$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m9898lambda$run$0$androidxworkimplutilsWorkForegroundRunnable(settableFutureCreate);
            }
        });
