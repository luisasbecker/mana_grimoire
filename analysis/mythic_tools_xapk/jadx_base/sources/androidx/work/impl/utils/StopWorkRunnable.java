...
public final class StopWorkRunnable implements Runnable {
    ...
    public void run() {
        ...
        Logger.get().debug(Logger.tagWithPrefix("StopWorkRunnable"), "StopWorkRunnable for " + this.token.getId().getWorkSpecId() + "; Processor.stopWork = " + (z ? processor.stopForegroundWork(this.token, this.reason) : processor.stopWork(this.token, this.reason)));
    }
}
