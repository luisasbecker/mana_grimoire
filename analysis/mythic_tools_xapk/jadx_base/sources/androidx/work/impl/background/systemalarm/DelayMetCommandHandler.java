...
public class DelayMetCommandHandler implements OnConstraintsStateChangedListener, WorkTimer.TimeLimitExceededListener {
    ...
    public void onConstraintsStateChanged(WorkSpec workSpec, ConstraintsState constraintsState) {
        ...
        Executor executor = this.mSerialExecutor;
        if (z) {
            executor.execute(new DelayMetCommandHandler$$ExternalSyntheticLambda1(this));
        } else {
            executor.execute(new DelayMetCommandHandler$$ExternalSyntheticLambda0(this));
        }
    }
