...
public final class Room {
    ...
    public static final <T, C> T getGeneratedImplementation(Class<C> klass, String suffix) {
        ...
        String str = StringsKt.replace$default(canonicalName, FilenameUtils.EXTENSION_SEPARATOR, '_', false, 4, (Object) null) + suffix;
        try {
            Class<?> cls = Class.forName(fullPackage.length() == 0 ? str : fullPackage + FilenameUtils.EXTENSION_SEPARATOR + str, true, klass.getClassLoader());
