...
public final class ConstraintLayoutKt$ConstraintLayout$measurePolicy$2$1 implements MeasurePolicy {
    ...
    public ConstraintLayoutKt$ConstraintLayout$measurePolicy$2$1(MutableState<Unit> mutableState, Measurer measurer, ConstraintSet constraintSet, int i) {
    ...
    public final MeasureResult mo1260measure3p2s80s(MeasureScope measureScope, final List<? extends Measurable> list, long j) {
        ...
        return MeasureScope.layout$default(measureScope, iM9285getWidthimpl, iM9284getHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.constraintlayout.compose.ConstraintLayoutKt$ConstraintLayout$measurePolicy$2$1.1
