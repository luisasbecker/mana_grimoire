...
public class Debug {
    public static void dumpLayoutParams(ViewGroup.LayoutParams layoutParams, String str) {
        ...
        String str2 = ".(" + stackTraceElement.getFileName() + Constants.SUBS_ID_BASE_PLAN_ID_SEPARATOR + stackTraceElement.getLineNumber() + ") " + str + "  ";
    ...
    public static void dumpPoc(Object obj) {
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        String str = ".(" + stackTraceElement.getFileName() + Constants.SUBS_ID_BASE_PLAN_ID_SEPARATOR + stackTraceElement.getLineNumber() + ")";
    ...
    public static void logStack(String str, String str2, int i) {
        ...
        for (int i2 = 1; i2 <= iMin; i2++) {
            ...
            str3 = str3 + " ";
            Log.v(str, str2 + str3 + (".(" + stackTrace[i2].getFileName() + Constants.SUBS_ID_BASE_PLAN_ID_SEPARATOR + stackTrace[i2].getLineNumber() + ") " + stackTrace[i2].getMethodName()) + str3);
        }
    }
    ...
    public static void printStack(String str, int i) {
        ...
        for (int i2 = 1; i2 <= iMin; i2++) {
            StackTraceElement stackTraceElement = stackTrace[i2];
            str2 = str2 + " ";
            System.out.println(str + str2 + (".(" + stackTrace[i2].getFileName() + Constants.SUBS_ID_BASE_PLAN_ID_SEPARATOR + stackTrace[i2].getLineNumber() + ") ") + str2);
        }
    }
}
