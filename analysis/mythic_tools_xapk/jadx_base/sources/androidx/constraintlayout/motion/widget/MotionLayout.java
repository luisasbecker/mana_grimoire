...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    private class DevModeDraw {
        ...
        public void draw(Canvas canvas, HashMap<View, MotionController> map, int i, int i2) {
            ...
            if (!MotionLayout.this.isInEditMode() && (i2 & 1) == 2) {
                String str = MotionLayout.this.getContext().getResources().getResourceName(MotionLayout.this.mEndState) + Constants.SUBS_ID_BASE_PLAN_ID_SEPARATOR + MotionLayout.this.getProgress();
            ...
            for (int i2 = 0; i2 < childCount; i2++) {
                ...
                if (motionController2 != null) {
                    if (this.mStart != null) {
                        ...
                        MotionLayout motionLayout = MotionLayout.this;
                        if (widget != null) {
                            motionController2.setStartState(motionLayout.toRect(widget), this.mStart, MotionLayout.this.getWidth(), MotionLayout.this.getHeight());
                        ...
                        if (this.mEnd == null) {
                            ...
                            MotionLayout motionLayout2 = MotionLayout.this;
                            if (widget2 != null) {
                                motionController2.setEndState(motionLayout2.toRect(widget2), this.mEnd, MotionLayout.this.getWidth(), MotionLayout.this.getHeight());
    ...
    */
    ...
    void getAnchorDpDt(int i, float f, float f2, float f3, float[] fArr) {
        ...
        if (motionController == null) {
            Log.w(TAG, "WARNING could not find view id " + (viewById == null ? "" + i : viewById.getContext().getResources().getResourceName(i)));
            return;
        }
