        ...
        while (true) {
            ...
            if (z4) {
                ...
                if (!z) {
                    ...
                    if (i6 != i3) {
                        int horizontalBiasPercent = (int) (finalValue + 0.5f + (i8 * (i == 0 ? constraintWidget6.getHorizontalBiasPercent() : constraintWidget6.getVerticalBiasPercent())));
                        if (i == 0) {
                ...
                margin = margin + constraintWidget3.mListAnchors[i2].getMargin() + (i == 0 ? constraintWidget3.getWidth() : constraintWidget3.getHeight()) + constraintWidget3.mListAnchors[i4].getMargin();
                i7++;
