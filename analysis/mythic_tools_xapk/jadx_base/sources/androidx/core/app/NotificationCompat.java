...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            public static Builder fromAndroidAction(Notification.Action action) {
                Builder builder = action.getIcon() != null ? new Builder(IconCompat.createFromIconOrNullIfZeroResId(action.getIcon()), action.title, action.actionIntent) : new Builder(action.icon, action.title, action.actionIntent);
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m9598clone() {
    ...
    public static class CallStyle extends Style {
        ...
        private Action makeAnswerAction() {
            ...
            return makeAction(z ? i : i2, z ? R.string.call_notification_answer_video_action : R.string.call_notification_answer_action, this.mAnswerButtonColor, R.color.call_notification_answer_color, this.mAnswerIntent);
        }

        private Action makeNegativeAction() {
            int i = R.drawable.ic_call_decline;
            return this.mDeclineIntent == null ? makeAction(i, R.string.call_notification_hang_up_action, this.mDeclineButtonColor, R.color.call_notification_decline_color, this.mHangUpIntent) : makeAction(i, R.string.call_notification_decline_action, this.mDeclineButtonColor, R.color.call_notification_decline_color, this.mDeclineIntent);
        }
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (Build.VERSION.SDK_INT < 31) {
                ...
                if (person2 != null) {
                    ...
                    if (i >= 28) {
                        Api28Impl.addPerson(builder, person3.toAndroidPerson());
                    } else {
                        builder.addPerson(person3.getUri());
                    }
                }
    ...
    public static final class CarExtender implements Extender {
        ...
        private static UnreadConversation getUnreadConversationFromBundle(Bundle bundle) {
            ...
            return new UnreadConversation(strArr, remoteInput != null ? new RemoteInput(remoteInput.getResultKey(), remoteInput.getLabel(), remoteInput.getChoices(), remoteInput.getAllowFreeFormInput(), Build.VERSION.SDK_INT >= 29 ? Api29Impl.getEditChoicesBeforeSending(remoteInput) : 0, remoteInput.getExtras(), null) : null, pendingIntent2, pendingIntent, stringArray, bundle.getLong("timestamp"));
        }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        public static List<CharSequence> getTextsFromContentView(Context context, Notification notification) {
            ...
            RemoteViews remoteViews = notification.bigContentView != null ? notification.bigContentView : notification.contentView != null ? notification.contentView : notification.headsUpContentView;
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            Notification.MessagingStyle messagingStyleCreateMessagingStyle = i >= 28 ? Api28Impl.createMessagingStyle(person.toAndroidPerson()) : Api24Impl.createMessagingStyle(person.getName());
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* JADX INFO: renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m9599clone() {
            WearableExtender wearableExtender = new WearableExtender();
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        int semanticAction = Build.VERSION.SDK_INT >= 28 ? Api28Impl.getSemanticAction(action) : action.getExtras().getInt("android.support.action.semanticAction", 0);
        ...
        if (action.getIcon() != null || action.icon == 0) {
            return new Action(action.getIcon() != null ? IconCompat.createFromIconOrNullIfZeroResId(action.getIcon()) : null, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z, semanticAction, z2, zIsContextual, zIsAuthenticationRequired);
        }
        return new Action(action.icon, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z, semanticAction, z2, zIsContextual, zIsAuthenticationRequired);
    }
