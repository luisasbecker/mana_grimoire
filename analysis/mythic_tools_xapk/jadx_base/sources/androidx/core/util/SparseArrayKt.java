...
public final class SparseArrayKt {
    ...
    public static final class C05211<T> implements Iterator<T>, KMappedMarker {
        final /* synthetic */ SparseArray<T> $this_valueIterator;
        private int index;

        C05211(SparseArray<T> sparseArray) {
