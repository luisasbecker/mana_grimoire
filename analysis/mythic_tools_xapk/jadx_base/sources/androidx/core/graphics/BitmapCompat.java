...
public final class BitmapCompat {
    ...
    public static Bitmap createScaledBitmap(Bitmap bitmap, int i, int i2, Rect rect, boolean z) {
        ...
        if (!z || Build.VERSION.SDK_INT < 27 || Api27Impl.isAlreadyF16AndLinear(bitmap)) {
            ...
            Bitmap bitmapCreateBitmapWithSourceColorspace = Api27Impl.createBitmapWithSourceColorspace(i8 > 0 ? sizeAtStep(iWidth, i, 1, i8) : iWidth, iCeil > 0 ? sizeAtStep(iHeight, i2, 1, iCeil) : iHeight, bitmap, true);
        ...
        while (true) {
            ...
            int i11 = i10;
            int i12 = i9;
            rect3.set(0, 0, sizeAtStep(iWidth, i, i9, i8), sizeAtStep(iHeight, i2, i11, iCeil));
            ...
            int iSizeAtStep = sizeAtStep(iWidth, i, i12 > 0 ? i5 : i12, i8);
            int iSizeAtStep2 = sizeAtStep(iHeight, i2, i11 > 0 ? i5 : i11, iCeil);
            c = 27;
