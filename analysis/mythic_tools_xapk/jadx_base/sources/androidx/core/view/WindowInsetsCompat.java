...
public class WindowInsetsCompat {
    ...
    private static class Impl20 extends Impl {
        ...
        private static List<Rect> getBoundingRects(Rect[][] rectArr, int i) {
            ...
            return rectArr3 == null ? Collections.emptyList() : Arrays.asList(rectArr3);
        }
    ...
    private static class Impl34 extends Impl31 {
        ...
        @Override // androidx.core.view.WindowInsetsCompat.Impl20, androidx.core.view.WindowInsetsCompat.Impl
        DisplayShapeCompat getDisplayShape() {
            return this.mDisplayShapeCompat != null ? this.mDisplayShapeCompat : DisplayShapeCompat.toDisplayShapeCompat(this.mPlatformInsets.getDisplayShape());
        }
