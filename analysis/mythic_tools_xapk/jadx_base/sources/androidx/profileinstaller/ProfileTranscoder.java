...
class ProfileTranscoder {
    ...
    private static String generateDexKey(String str, String str2, byte[] bArr) {
        ...
        return str.length() <= 0 ? enforceSeparator(str2, strDexKeySeparator) : str2.equals("classes.dex") ? str : (str2.contains("!") || str2.contains(Constants.SUBS_ID_BASE_PLAN_ID_SEPARATOR)) ? enforceSeparator(str2, strDexKeySeparator) : str2.endsWith(".apk") ? str2 : str + ProfileVersion.dexKeySeparator(bArr) + str2;
    }
