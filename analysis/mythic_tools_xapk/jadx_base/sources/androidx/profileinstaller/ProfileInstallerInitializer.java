...
public class ProfileInstallerInitializer implements Initializer<Result> {
    ...
    public Result create(Context context) {
        ...
        Choreographer.getInstance().postFrameCallback(new Choreographer.FrameCallback() { // from class: androidx.profileinstaller.ProfileInstallerInitializer$$ExternalSyntheticLambda0
            ...
            public final void doFrame(long j) {
                this.f$0.m9758x451635a(applicationContext, j);
            }
        });
        return new Result();
    }
    ...
    void installAfterDelay(final Context context) {
        (Build.VERSION.SDK_INT >= 28 ? Handler28Impl.createAsync(Looper.getMainLooper()) : new Handler(Looper.getMainLooper())).postDelayed(new Runnable() { // from class: androidx.profileinstaller.ProfileInstallerInitializer$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /* synthetic */ void m9758x451635a(Context context, long j) {
