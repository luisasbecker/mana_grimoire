...
final class MeasurementManagerImplCommon$registerSource$4$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            measurementManagerImplCommon.getMMeasurementManager().registerSource(uri, sourceRegistrationRequest.getInputEvent(), new PixelCopyCompat$Companion$$ExternalSyntheticLambda1(), OutcomeReceiverKt.asOutcomeReceiver(cancellableContinuationImpl));
