...
public final class AdData {
    ...
    public final android.adservices.common.AdData convertToAdServices$ads_adservices_release() {
        return (AdServicesInfo.INSTANCE.adServicesVersion() >= 10 || AdServicesInfo.INSTANCE.extServicesVersionS() >= 10) ? Ext10Impl.INSTANCE.convertAdData(this) : (AdServicesInfo.INSTANCE.adServicesVersion() >= 8 || AdServicesInfo.INSTANCE.extServicesVersionS() >= 9) ? Ext8Impl.INSTANCE.convertAdData(this) : Ext4Impl.INSTANCE.convertAdData(this);
    }
