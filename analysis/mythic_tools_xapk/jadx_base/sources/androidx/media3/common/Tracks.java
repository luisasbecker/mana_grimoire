...
public final class Tracks {
    ...
    public static final class Group {
        ...
        public static Group fromBundle(Bundle bundle) {
            TrackGroup trackGroupFromBundle = TrackGroup.fromBundle((Bundle) Preconditions.checkNotNull(bundle.getBundle(FIELD_TRACK_GROUP)));
    ...
    public static Tracks fromBundle(Bundle bundle) {
        ...
        return new Tracks(parcelableArrayList == null ? ImmutableList.of() : BundleCollectionUtil.fromBundleList(new Function() { // from class: androidx.media3.common.Tracks$$ExternalSyntheticLambda1
