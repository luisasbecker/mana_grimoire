...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    public void animateToMode(boolean z) {
        ...
        if (z) {
            viewPropertyAnimatorCompat = decorToolbar2.setupAnimatorToVisibility(4, FADE_OUT_DURATION_MS);
            viewPropertyAnimatorCompat2 = this.mContextView.setupAnimatorToVisibility(0, FADE_IN_DURATION_MS);
        } else {
            ViewPropertyAnimatorCompat viewPropertyAnimatorCompat3 = decorToolbar2.setupAnimatorToVisibility(0, FADE_IN_DURATION_MS);
