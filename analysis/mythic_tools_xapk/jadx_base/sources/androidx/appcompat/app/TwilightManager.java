...
class TwilightManager {
    ...
    private Location getLastKnownLocation() {
        Location lastKnownLocationForProvider = PermissionChecker.checkSelfPermission(this.mContext, "android.permission.ACCESS_COARSE_LOCATION") == 0 ? getLastKnownLocationForProvider(AndroidContextPlugin.NETWORK_KEY) : null;
    ...
    private void updateState(Location location) {
        ...
        if (j2 == -1 || j3 == -1) {
            ...
            j = j2 + DurationKt.MILLIS_IN_MINUTE;
        }
