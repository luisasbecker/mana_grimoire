...
final class DefaultChipColors implements ChipColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m6326equalsimpl0(this.backgroundColor, defaultChipColors.backgroundColor) && Color.m6326equalsimpl0(this.contentColor, defaultChipColors.contentColor) && Color.m6326equalsimpl0(this.leadingIconContentColor, defaultChipColors.leadingIconContentColor) && Color.m6326equalsimpl0(this.disabledBackgroundColor, defaultChipColors.disabledBackgroundColor) && Color.m6326equalsimpl0(this.disabledContentColor, defaultChipColors.disabledContentColor) && Color.m6326equalsimpl0(this.disabledLeadingIconContentColor, defaultChipColors.disabledLeadingIconContentColor);
    }

    public int hashCode() {
        return (((((((((Color.m6332hashCodeimpl(this.backgroundColor) * 31) + Color.m6332hashCodeimpl(this.contentColor)) * 31) + Color.m6332hashCodeimpl(this.leadingIconContentColor)) * 31) + Color.m6332hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m6332hashCodeimpl(this.disabledContentColor)) * 31) + Color.m6332hashCodeimpl(this.disabledLeadingIconContentColor);
    }
    ...
    public State<Color> leadingIconContentColor(boolean z, Composer composer, int i) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m6315boximpl(z ? this.leadingIconContentColor : this.disabledLeadingIconContentColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
