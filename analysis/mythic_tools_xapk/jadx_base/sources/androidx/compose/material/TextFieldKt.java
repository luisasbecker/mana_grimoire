...
public final class TextFieldKt {
    ...
    static final class AnonymousClass1 implements TextFieldDecorator {
        ...
        static final Unit Decoration$lambda$2(AnonymousClass1 anonymousClass1, Function2 function2, int i, Composer composer, int i2) {
            anonymousClass1.Decoration(function2, composer, RecomposeScopeImplKt.updateChangedFlags(i | 1));
        ...
        public final void Decoration(final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
            ...
            String string;
            Composer composerStartRestartGroup = composer.startRestartGroup(-1516988351);
            ComposerKt.sourceInformation(composerStartRestartGroup, "C(Decoration)N(innerTextField)239@12524L606:TextField.kt#jmzs0o");
            if ((i & 6) == 0) {
            ...
            if (scopeUpdateScopeEndRestartGroup != null) {
                scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.material.TextFieldKt$TextField$1$$ExternalSyntheticLambda0
                    @Override // kotlin.jvm.functions.Function2
                    public final Object invoke(Object obj, Object obj2) {
                        return TextFieldKt.AnonymousClass1.Decoration$lambda$2(this.f$0, function2, i, (Composer) obj, ((Integer) obj2).intValue());
                    }
                });
            }
        }
    ...
    */
    public static final void TextField(final TextFieldState textFieldState, Modifier modifier, boolean z, boolean z2, TextStyle textStyle, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, Function2<? super Composer, ? super Integer, Unit> function24, boolean z3, InputTransformation inputTransformation, OutputTransformation outputTransformation, KeyboardOptions keyboardOptions, KeyboardActionHandler keyboardActionHandler, TextFieldLineLimits textFieldLineLimits, ScrollState scrollState, Shape shape, TextFieldColors textFieldColors, MutableInteractionSource mutableInteractionSource, Composer composer, final int i, final int i2, final int i3) {
        ...
        int i26;
        Composer composerStartRestartGroup = composer.startRestartGroup(-345138714);
                        ...
                        if (i12 != 0) {
                            ...
                            if (i21 != 0) {
                                ...
                                if (i23 != 0) {
                                    ...
                                    mutableInteractionSource2 = mutableInteractionSource;
                                    if ((i2 & 100663296) == 0) {
                                        i22 |= composerStartRestartGroup.changed(mutableInteractionSource2) ? 67108864 : 33554432;
                                    }
                                }
                                if (composerStartRestartGroup.shouldExecute(((i4 & 306783379) == 306783378 && (i22 & 38347923) == 38347922) ? false : true, i4 & 1)) {
                                    composerStartRestartGroup.startDefaults();
                                    ComposerKt.sourceInformation(composerStartRestartGroup, "182@9813L7,193@10376L21,194@10436L14,195@10500L17");
                                    if ((i & 1) == 0 || composerStartRestartGroup.getDefaultsInvalid()) {
                                        Modifier.Companion companion = i27 != 0 ? Modifier.INSTANCE : modifier2;
                                    ...
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventStart(-345138714, i4, i25, "androidx.compose.material.TextField (TextField.kt:197)");
                                    }
                                    if (mutableInteractionSource2 == null) {
                                        composer3.startReplaceGroup(125297845);
                                        ComposerKt.sourceInformation(composer3, "199@10661L39");
                                        ComposerKt.sourceInformationMarkerStart(composer3, -965789459, "CC(remember):TextField.kt#9igjgp");
                                        ...
                                        composer3.startReplaceGroup(-965790110);
                                        composer3.endReplaceGroup();
                                        mutableInteractionSource4 = mutableInteractionSource2;
                                    }
                                    composer3.startReplaceGroup(-965784364);
                                    ...
                                    if (jM8586getColor0d7_KjU == 16) {
                                        jM8586getColor0d7_KjU = textFieldColorsM3216textFieldColorsdx8h9Zs.textColor(z4, composer3, ((i4 >> 6) & 14) | ((i25 >> 18) & 112)).getValue().m6335unboximpl();
                                    }
                                    composer3.endReplaceGroup();
                                    ...
                                    boolean z11 = z9;
                                    int i33 = i25;
                                    Modifier modifierM2067defaultMinSizeVpY3zN4 = SizeKt.m2067defaultMinSizeVpY3zN4(TextFieldImplKt.defaultErrorSemantics(TextFieldDefaults.m3204indicatorLinegv0btCI$default(TextFieldDefaults.INSTANCE, modifier4, z4, z11, mutableInteractionSource4, textFieldColors3, 0.0f, 0.0f, 48, null), z11, Strings_androidKt.m3171getString4foXLRw(Strings.INSTANCE.m3165getDefaultErrorMessageUdPEhr4(), composer3, 6)), TextFieldDefaults.INSTANCE.m3211getMinWidthD9Ej5fM(), TextFieldDefaults.INSTANCE.m3210getMinHeightD9Ej5fM());
                                    SolidColor solidColor = new SolidColor(textFieldColors3.cursorColor(z11, composer3, ((i4 >> 27) & 14) | ((i33 >> 18) & 112)).getValue().m6335unboximpl(), null);
                                    int i34 = i33 << 12;
                                    Composer composer4 = composer3;
                                    BasicTextFieldKt.BasicTextField(textFieldState, modifierM2067defaultMinSizeVpY3zN4, z4, z8, inputTransformation3, textStyleMerge, keyboardOptions3, keyboardActionHandler3, textFieldLineLimits3, (Function2<? super Density, ? super Function0<TextLayoutResult>, Unit>) null, mutableInteractionSource4, solidColor, outputTransformation3, new AnonymousClass1(outputTransformation3, textFieldState, textFieldLineLimits3, z4, mutableInteractionSource4, z11, function25, function26, function212, function213, textFieldShape, textFieldColors3), scrollStateRememberScrollState, composer4, (i4 & 8078) | (57344 & i34) | (3670016 & i34) | (29360128 & i34) | (i34 & 234881024), ((i33 << 3) & 896) | ((i33 >> 3) & 57344), 512);
                                    composer2 = composer4;
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventEnd();
                                    }
                                ...
                                if (scopeUpdateScopeEndRestartGroup != null) {
                                    scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.material.TextFieldKt$$ExternalSyntheticLambda7
                                        @Override // kotlin.jvm.functions.Function2
                                        public final Object invoke(Object obj, Object obj2) {
                                            return TextFieldKt.TextField$lambda$2(textFieldState, modifier3, z6, z5, textStyle3, function28, function29, function210, function211, z7, inputTransformation2, outputTransformation2, keyboardOptions2, keyboardActionHandler2, textFieldLineLimits2, scrollState2, shape2, textFieldColors2, mutableInteractionSource3, i, i2, i3, (Composer) obj, ((Integer) obj2).intValue());
                                        }
                                    });
                                    return;
                                }
    ...
    */
    public static final void TextField(final TextFieldValue textFieldValue, final Function1<? super TextFieldValue, Unit> function1, Modifier modifier, boolean z, boolean z2, TextStyle textStyle, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, Function2<? super Composer, ? super Integer, Unit> function24, boolean z3, VisualTransformation visualTransformation, KeyboardOptions keyboardOptions, KeyboardActions keyboardActions, boolean z4, int i, int i2, MutableInteractionSource mutableInteractionSource, Shape shape, TextFieldColors textFieldColors, Composer composer, final int i3, final int i4, final int i5) {
        ...
        int i33;
        MutableInteractionSource mutableInteractionSource4;
        Composer composerStartRestartGroup = composer.startRestartGroup(-1470183117);
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(TextField)N(value,onValueChange,modifier,enabled,readOnly,textStyle,label,placeholder,leadingIcon,trailingIcon,isError,visualTransformation,keyboardOptions,keyboardActions,singleLine,maxLines,minLines,interactionSource,shape,colors)546@28465L38,555@28849L20,564@29203L792,541@28262L1740:TextField.kt#jmzs0o");
        if ((i3 & 6) == 0) {
                        ...
                        if (i13 != 0) {
                            ...
                            if (i20 != 0) {
                                ...
                                if (i22 != 0) {
                                    ...
                                    i23 = i36 | (composerStartRestartGroup.changed(z4) ? 16384 : 8192);
                                } else {
                                    i23 = i36;
                                }
                                ...
                                if (composerStartRestartGroup.shouldExecute(((i6 & 306783379) == 306783378 && (306783379 & i26) == 306783378) ? false : true, i6 & 1)) {
                                    composerStartRestartGroup.startDefaults();
                                    ComposerKt.sourceInformation(composerStartRestartGroup, "519@27167L7,532@27811L14,533@27875L17");
                                    if ((i3 & 1) == 0 || composerStartRestartGroup.getDefaultsInvalid()) {
                                        Modifier.Companion companion = i34 != 0 ? Modifier.INSTANCE : modifier2;
                                        boolean z13 = i7 != 0 ? true : z;
                                        boolean z14 = i8 != 0 ? false : z5;
                                        if ((i5 & 32) != 0) {
                                            ProvidableCompositionLocal<TextStyle> localTextStyle = TextKt.getLocalTextStyle();
                                            ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 2023513938, "CC(<get-current>):CompositionLocal.kt#9igjgp");
                                            Object objConsume = composerStartRestartGroup.consume(localTextStyle);
                                    ...
                                    composer3.endDefaults();
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventStart(-1470183117, i31, i33, "androidx.compose.material.TextField (TextField.kt:534)");
                                    }
                                    if (mutableInteractionSource3 == null) {
                                        composer3.startReplaceGroup(1852274984);
                                        ComposerKt.sourceInformation(composer3, "536@27979L39");
                                        ComposerKt.sourceInformationMarkerStart(composer3, 198298138, "CC(remember):TextField.kt#9igjgp");
                                        Object objRememberedValue = composer3.rememberedValue();
                                        if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
                                            objRememberedValue = InteractionSourceKt.MutableInteractionSource();
                                            composer3.updateRememberedValue(objRememberedValue);
                                        ...
                                        composer3.startReplaceGroup(198297487);
                                        composer3.endReplaceGroup();
                                        mutableInteractionSource4 = mutableInteractionSource3;
                                    }
                                    composer3.startReplaceGroup(198303233);
                                    ComposerKt.sourceInformation(composer3, "*538@28158L18");
                                    long jM8586getColor0d7_KjU = textStyle5.m8586getColor0d7_KjU();
                                    if (jM8586getColor0d7_KjU == 16) {
                                        jM8586getColor0d7_KjU = textFieldColorsM3216textFieldColorsdx8h9Zs.textColor(z11, composer3, ((i31 >> 9) & 14) | ((i33 >> 24) & 112)).getValue().m6335unboximpl();
                                    }
                                    composer3.endReplaceGroup();
                                    ...
                                    final TextFieldColors textFieldColors3 = textFieldColorsM3216textFieldColorsdx8h9Zs;
                                    final boolean z16 = z11;
                                    Modifier modifier4 = modifier2;
                                    final boolean z17 = z10;
                                    TextStyle textStyle6 = textStyle5;
                                    Modifier modifierM2067defaultMinSizeVpY3zN4 = SizeKt.m2067defaultMinSizeVpY3zN4(TextFieldImplKt.defaultErrorSemantics(TextFieldDefaults.m3204indicatorLinegv0btCI$default(TextFieldDefaults.INSTANCE, modifier4, z16, z17, mutableInteractionSource4, textFieldColors3, 0.0f, 0.0f, 48, null), z17, Strings_androidKt.m3171getString4foXLRw(Strings.INSTANCE.m3165getDefaultErrorMessageUdPEhr4(), composer3, 6)), TextFieldDefaults.INSTANCE.m3211getMinWidthD9Ej5fM(), TextFieldDefaults.INSTANCE.m3210getMinHeightD9Ej5fM());
                                    Color value = textFieldColors3.cursorColor(z17, composer3, (i33 & 14) | ((i33 >> 24) & 112)).getValue();
                                    ...
                                    Composer composer4 = composer3;
                                    int i41 = i30;
                                    BasicTextFieldKt.BasicTextField(textFieldValue, function1, modifierM2067defaultMinSizeVpY3zN4, z16, z5, textStyleMerge, keyboardOptions3, keyboardActions4, z12, i41, i32, visualTransformation3, (Function1<? super TextLayoutResult, Unit>) null, mutableInteractionSource5, new SolidColor(value.m6335unboximpl(), null), ComposableLambdaKt.rememberComposableLambda(1565379926, true, new Function3() { // from class: androidx.compose.material.TextFieldKt$$ExternalSyntheticLambda4
                                        @Override // kotlin.jvm.functions.Function3
                                        public final Object invoke(Object obj, Object obj2, Object obj3) {
                                            return TextFieldKt.TextField$lambda$11(textFieldValue, z16, z18, visualTransformation4, mutableInteractionSource5, z17, function215, function216, function217, function218, shape3, textFieldColors3, (Function2) obj, (Composer) obj2, ((Integer) obj3).intValue());
                                        }
                                    }, composer3, 54), composer4, (i31 & 64638) | (3670016 & i40) | (29360128 & i40) | (234881024 & i40) | (i40 & 1879048192), ((i33 >> 18) & 14) | ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE | (i33 & 112), 4096);
                                    composer2 = composer4;
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventEnd();
                                    }
                                ...
                                scopeUpdateScopeEndRestartGroup = composer2.endRestartGroup();
                                if (scopeUpdateScopeEndRestartGroup != null) {
                                    scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.material.TextFieldKt$$ExternalSyntheticLambda5
                                        @Override // kotlin.jvm.functions.Function2
                                        public final Object invoke(Object obj, Object obj2) {
                                            return TextFieldKt.TextField$lambda$12(textFieldValue, function1, modifier3, z6, z7, textStyle3, function28, function29, function210, function27, z8, visualTransformation2, keyboardOptions2, keyboardActions2, z9, i27, i28, mutableInteractionSource2, shape2, textFieldColors2, i3, i4, i5, (Composer) obj, ((Integer) obj2).intValue());
                                        }
                                    });
                                    return;
                                }
                        ...
                        if (i12 != 0) {
                            ...
                            if (i19 != 0) {
                                ...
                                if (composerStartRestartGroup.shouldExecute(((i5 & 306783379) == 306783378 && (38347923 & i25) == 38347922) ? false : true, i5 & 1)) {
                                    composerStartRestartGroup.startDefaults();
                                    ComposerKt.sourceInformation(composerStartRestartGroup, "596@30372L7,607@30926L39,608@31004L14,609@31068L17");
                                    if ((i2 & 1) == 0 || composerStartRestartGroup.getDefaultsInvalid()) {
                                        ...
                                        if (i24 != 0) {
                                            ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 1479352311, "CC(remember):TextField.kt#9igjgp");
                                        ...
                                        if ((262144 & i4) != 0) {
                                            ...
                                            keyboardActions4 = keyboardActions3;
                                            modifier4 = companion;
                                            textFieldColorsM3216textFieldColorsdx8h9Zs = TextFieldDefaults.INSTANCE.m3216textFieldColorsdx8h9Zs(0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, composer2, 0, 0, 48, 2097151);
                                            i25 = i35 & (-234881025);
                                            z11 = z14;
                                            z6 = z15;
                                            textStyle2 = textStyle4;
                                ...
                                scopeUpdateScopeEndRestartGroup = composer2.endRestartGroup();
                                if (scopeUpdateScopeEndRestartGroup != null) {
                                    scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.material.TextFieldKt$$ExternalSyntheticLambda3
                                        @Override // kotlin.jvm.functions.Function2
                                        public final Object invoke(Object obj, Object obj2) {
                                            return TextFieldKt.TextField$lambda$14(textFieldValue, function1, modifier3, z7, z8, textStyle3, function28, function29, function210, function27, z9, visualTransformation2, keyboardOptions2, keyboardActions2, z10, i26, mutableInteractionSource2, shape2, textFieldColors2, i2, i3, i4, (Composer) obj, ((Integer) obj2).intValue());
                                        }
                                    });
                                    return;
                                }
    ...
    */
    public static final void TextField(final String str, final Function1<? super String, Unit> function1, Modifier modifier, boolean z, boolean z2, TextStyle textStyle, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, Function2<? super Composer, ? super Integer, Unit> function24, boolean z3, VisualTransformation visualTransformation, KeyboardOptions keyboardOptions, KeyboardActions keyboardActions, boolean z4, int i, int i2, MutableInteractionSource mutableInteractionSource, Shape shape, TextFieldColors textFieldColors, Composer composer, final int i3, final int i4, final int i5) {
        ...
        int i33;
        MutableInteractionSource mutableInteractionSource4;
        Composer composerStartRestartGroup = composer.startRestartGroup(179130848);
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(TextField)N(value,onValueChange,modifier,enabled,readOnly,textStyle,label,placeholder,leadingIcon,trailingIcon,isError,visualTransformation,keyboardOptions,keyboardActions,singleLine,maxLines,minLines,interactionSource,shape,colors)356@19163L38,365@19547L20,374@19901L787,351@18960L1735:TextField.kt#jmzs0o");
        if ((i3 & 6) == 0) {
                    ...
                    if (i11 == 0) {
                        ...
                        if (i13 != 0) {
                            ...
                            if (i20 != 0) {
                                ...
                                if (composerStartRestartGroup.shouldExecute(((i6 & 306783379) == 306783378 && (306783379 & i26) == 306783378) ? false : true, i6 & 1)) {
                                    composerStartRestartGroup.startDefaults();
                                    ComposerKt.sourceInformation(composerStartRestartGroup, "329@17865L7,342@18509L14,343@18573L17");
                                    if ((i3 & 1) == 0 || composerStartRestartGroup.getDefaultsInvalid()) {
                                        Modifier.Companion companion = i34 != 0 ? Modifier.INSTANCE : modifier2;
                                        boolean z13 = i7 != 0 ? true : z;
                                        boolean z14 = i8 != 0 ? false : z5;
                                    ...
                                    composer3.endDefaults();
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventStart(179130848, i31, i33, "androidx.compose.material.TextField (TextField.kt:344)");
                                    }
                                    if (mutableInteractionSource3 == null) {
                                        composer3.startReplaceGroup(2138724187);
                                        ComposerKt.sourceInformation(composer3, "346@18677L39");
                                        ComposerKt.sourceInformationMarkerStart(composer3, 346085767, "CC(remember):TextField.kt#9igjgp");
                                        Object objRememberedValue = composer3.rememberedValue();
                                        if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
                                            objRememberedValue = InteractionSourceKt.MutableInteractionSource();
                                            composer3.updateRememberedValue(objRememberedValue);
                                        ...
                                        composer3.startReplaceGroup(346085116);
                                        composer3.endReplaceGroup();
                                        mutableInteractionSource4 = mutableInteractionSource3;
                                    }
                                    composer3.startReplaceGroup(346090862);
                                    ComposerKt.sourceInformation(composer3, "*348@18856L18");
                                    long jM8586getColor0d7_KjU = textStyle5.m8586getColor0d7_KjU();
                                    if (jM8586getColor0d7_KjU == 16) {
                                        jM8586getColor0d7_KjU = textFieldColorsM3216textFieldColorsdx8h9Zs.textColor(z11, composer3, ((i31 >> 9) & 14) | ((i33 >> 24) & 112)).getValue().m6335unboximpl();
                                    }
                                    ...
                                    Composer composer4 = composer3;
                                    int i41 = i30;
                                    BasicTextFieldKt.BasicTextField(str, function1, modifierM2067defaultMinSizeVpY3zN4, z16, z5, textStyleMerge, keyboardOptions3, keyboardActions4, z12, i41, i32, visualTransformation3, (Function1<? super TextLayoutResult, Unit>) null, mutableInteractionSource5, new SolidColor(value.m6335unboximpl(), null), ComposableLambdaKt.rememberComposableLambda(-83351293, true, new Function3() { // from class: androidx.compose.material.TextFieldKt$$ExternalSyntheticLambda1
                                        @Override // kotlin.jvm.functions.Function3
                                        public final Object invoke(Object obj, Object obj2, Object obj3) {
                                            return TextFieldKt.TextField$lambda$5(str, z16, z18, visualTransformation4, mutableInteractionSource5, z17, function215, function216, function217, function218, shape3, textFieldColors3, (Function2) obj, (Composer) obj2, ((Integer) obj3).intValue());
                                        }
                                    }, composer3, 54), composer4, (i31 & 64638) | (3670016 & i40) | (29360128 & i40) | (234881024 & i40) | (i40 & 1879048192), ((i33 >> 18) & 14) | ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE | (i33 & 112), 4096);
                                    composer2 = composer4;
                                    if (ComposerKt.isTraceInProgress()) {
                                ...
                                scopeUpdateScopeEndRestartGroup = composer2.endRestartGroup();
                                if (scopeUpdateScopeEndRestartGroup != null) {
                                    scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.material.TextFieldKt$$ExternalSyntheticLambda2
                                        @Override // kotlin.jvm.functions.Function2
                                        public final Object invoke(Object obj, Object obj2) {
                                            return TextFieldKt.TextField$lambda$6(str, function1, modifier3, z6, z7, textStyle3, function28, function29, function210, function27, z8, visualTransformation2, keyboardOptions2, keyboardActions2, z9, i27, i28, mutableInteractionSource2, shape2, textFieldColors2, i3, i4, i5, (Composer) obj, ((Integer) obj2).intValue());
                                        }
                                    });
                                    return;
                                }
    ...
    */
    public static final /* synthetic */ void TextField(final String str, final Function1 function1, Modifier modifier, boolean z, boolean z2, TextStyle textStyle, Function2 function2, Function2 function22, Function2 function23, Function2 function24, boolean z3, VisualTransformation visualTransformation, KeyboardOptions keyboardOptions, KeyboardActions keyboardActions, boolean z4, int i, MutableInteractionSource mutableInteractionSource, Shape shape, TextFieldColors textFieldColors, Composer composer, final int i2, final int i3, final int i4) {
        ...
        MutableInteractionSource mutableInteractionSource4;
        Shape shape3;
        Composer composerStartRestartGroup = composer.startRestartGroup(378210749);
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(TextField)N(value,onValueChange,modifier,enabled,readOnly,textStyle,label,placeholder,leadingIcon,trailingIcon,isError,visualTransformation,keyboardOptions,keyboardActions,singleLine,maxLines,interactionSource,shape,colors)422@21837L409:TextField.kt#jmzs0o");
        if ((i2 & 6) == 0) {
                    ...
                    if (i10 == 0) {
                        ...
                        if (i12 != 0) {
                            ...
                            if (i19 != 0) {
                                ...
                                if (composerStartRestartGroup.shouldExecute(((i5 & 306783379) == 306783378 && (38347923 & i25) == 38347922) ? false : true, i5 & 1)) {
                                    composerStartRestartGroup.startDefaults();
                                    ComposerKt.sourceInformation(composerStartRestartGroup, "406@21049L7,417@21603L39,419@21685L6,420@21810L17");
                                    if ((i2 & 1) == 0 || composerStartRestartGroup.getDefaultsInvalid()) {
                                        Modifier.Companion companion = i30 != 0 ? Modifier.INSTANCE : modifier2;
                                        boolean z14 = i6 != 0 ? true : z5;
                                        boolean z15 = i7 != 0 ? false : z6;
                                        ...
                                        int i34 = i23 != 0 ? Integer.MAX_VALUE : i;
                                        if (i24 != 0) {
                                            ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, -1611665948, "CC(remember):TextField.kt#9igjgp");
                                            Object objRememberedValue = composerStartRestartGroup.rememberedValue();
                                            if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
                                                objRememberedValue = InteractionSourceKt.MutableInteractionSource();
                                                composerStartRestartGroup.updateRememberedValue(objRememberedValue);
                                    ...
                                    composer2.endDefaults();
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventStart(378210749, i28, i25, "androidx.compose.material.TextField (TextField.kt:421)");
                                    }
                                    int i36 = i28 & 2147483646;
                                    int i37 = (i25 & 14) | 1572864 | (i25 & 112) | (i25 & 896) | (i25 & 7168) | (57344 & i25) | (458752 & i25);
                                    int i38 = i25 << 3;
                                    TextField(str, (Function1<? super String, Unit>) function1, modifier4, z11, z6, textStyle2, (Function2<? super Composer, ? super Integer, Unit>) function211, (Function2<? super Composer, ? super Integer, Unit>) function212, (Function2<? super Composer, ? super Integer, Unit>) function213, (Function2<? super Composer, ? super Integer, Unit>) function214, z12, visualTransformation3, keyboardOptions3, keyboardActions4, z13, i29, 1, mutableInteractionSource4, shape3, textFieldColorsM3216textFieldColorsdx8h9Zs, composer2, i36, i37 | (29360128 & i38) | (234881024 & i38) | (i38 & 1879048192), 0);
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventEnd();
                                    }
                                    modifier3 = modifier4;
                                ...
                                scopeUpdateScopeEndRestartGroup = composer2.endRestartGroup();
                                if (scopeUpdateScopeEndRestartGroup != null) {
                                    scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.material.TextFieldKt$$ExternalSyntheticLambda6
                                        @Override // kotlin.jvm.functions.Function2
                                        public final Object invoke(Object obj, Object obj2) {
                                            return TextFieldKt.TextField$lambda$8(str, function1, modifier3, z7, z8, textStyle3, function28, function29, function210, function27, z9, visualTransformation2, keyboardOptions2, keyboardActions2, z10, i26, mutableInteractionSource2, shape2, textFieldColors2, i2, i3, i4, (Composer) obj, ((Integer) obj2).intValue());
                                        }
                                    });
                                    return;
                                }
    ...
    static final Unit TextField$lambda$11(TextFieldValue textFieldValue, boolean z, boolean z2, VisualTransformation visualTransformation, MutableInteractionSource mutableInteractionSource, boolean z3, Function2 function2, Function2 function22, Function2 function23, Function2 function24, Shape shape, TextFieldColors textFieldColors, Function2 function25, Composer composer, int i) {
        int i2;
        ComposerKt.sourceInformation(composer, "CN(innerTextField)566@29350L631:TextField.kt#jmzs0o");
        if ((i & 6) == 0) {
        ...
        if (composer.shouldExecute((i2 & 19) != 18, i2 & 1)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1565379926, i2, -1, "androidx.compose.material.TextField.<anonymous> (TextField.kt:566)");
            }
            TextFieldDefaults.INSTANCE.TextFieldDecorationBox(textFieldValue.getText(), function25, z, z2, visualTransformation, mutableInteractionSource, z3, function2, function22, function23, function24, shape, textFieldColors, null, composer, (i2 << 3) & 112, 24576, 8192);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    static final Unit TextField$lambda$14(TextFieldValue textFieldValue, Function1 function1, Modifier modifier, boolean z, boolean z2, TextStyle textStyle, Function2 function2, Function2 function22, Function2 function23, Function2 function24, boolean z3, VisualTransformation visualTransformation, KeyboardOptions keyboardOptions, KeyboardActions keyboardActions, boolean z4, int i, MutableInteractionSource mutableInteractionSource, Shape shape, TextFieldColors textFieldColors, int i2, int i3, int i4, Composer composer, int i5) {
    ...
    static final Unit TextField$lambda$5(String str, boolean z, boolean z2, VisualTransformation visualTransformation, MutableInteractionSource mutableInteractionSource, boolean z3, Function2 function2, Function2 function22, Function2 function23, Function2 function24, Shape shape, TextFieldColors textFieldColors, Function2 function25, Composer composer, int i) {
        int i2;
        ComposerKt.sourceInformation(composer, "CN(innerTextField)376@20048L626:TextField.kt#jmzs0o");
        if ((i & 6) == 0) {
            i2 = i | (composer.changedInstance(function25) ? 4 : 2);
        } else {
            i2 = i;
        ...
        if (composer.shouldExecute((i2 & 19) != 18, i2 & 1)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-83351293, i2, -1, "androidx.compose.material.TextField.<anonymous> (TextField.kt:376)");
            }
            TextFieldDefaults.INSTANCE.TextFieldDecorationBox(str, function25, z, z2, visualTransformation, mutableInteractionSource, z3, function2, function22, function23, function24, shape, textFieldColors, null, composer, (i2 << 3) & 112, 24576, 8192);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    static final Unit TextField$lambda$6(String str, Function1 function1, Modifier modifier, boolean z, boolean z2, TextStyle textStyle, Function2 function2, Function2 function22, Function2 function23, Function2 function24, boolean z3, VisualTransformation visualTransformation, KeyboardOptions keyboardOptions, KeyboardActions keyboardActions, boolean z4, int i, int i2, MutableInteractionSource mutableInteractionSource, Shape shape, TextFieldColors textFieldColors, int i3, int i4, int i5, Composer composer, int i6) {
        TextField(str, (Function1<? super String, Unit>) function1, modifier, z, z2, textStyle, (Function2<? super Composer, ? super Integer, Unit>) function2, (Function2<? super Composer, ? super Integer, Unit>) function22, (Function2<? super Composer, ? super Integer, Unit>) function23, (Function2<? super Composer, ? super Integer, Unit>) function24, z3, visualTransformation, keyboardOptions, keyboardActions, z4, i, i2, mutableInteractionSource, shape, textFieldColors, composer, RecomposeScopeImplKt.updateChangedFlags(i3 | 1), RecomposeScopeImplKt.updateChangedFlags(i4), i5);
        return Unit.INSTANCE;
    }

    static final Unit TextField$lambda$8(String str, Function1 function1, Modifier modifier, boolean z, boolean z2, TextStyle textStyle, Function2 function2, Function2 function22, Function2 function23, Function2 function24, boolean z3, VisualTransformation visualTransformation, KeyboardOptions keyboardOptions, KeyboardActions keyboardActions, boolean z4, int i, MutableInteractionSource mutableInteractionSource, Shape shape, TextFieldColors textFieldColors, int i2, int i3, int i4, Composer composer, int i5) {
    ...
    public static final void TextFieldLayout(final Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function3<? super Modifier, ? super Composer, ? super Integer, Unit> function3, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final boolean z, final float f, final PaddingValues paddingValues, Composer composer, final int i) {
        ...
        Composer composerStartRestartGroup = composer.startRestartGroup(-1595074580);
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(TextFieldLayout)N(modifier,textField,label,placeholder,leading,trailing,singleLine,animationProgress,paddingValues)652@32043L147,655@32238L7,656@32250L1959:TextField.kt#jmzs0o");
        if ((i & 6) == 0) {
        ...
        if (composerStartRestartGroup.shouldExecute((38347923 & i2) != 38347922, i2 & 1)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1595074580, i2, -1, "androidx.compose.material.TextFieldLayout (TextField.kt:650)");
            }
            ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 436665599, "CC(remember):TextField.kt#9igjgp");
            ...
            Updater.m5603setimpl(composerM5595constructorimpl, textFieldMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            ...
            ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, -1444583530, "C699@33970L183:TextField.kt#jmzs0o");
            if (function23 != null) {
                composerStartRestartGroup.startReplaceGroup(-1444611617);
                ComposerKt.sourceInformation(composerStartRestartGroup, "660@32358L224");
                ...
                ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, -1684668010, "C664@32555L9:TextField.kt#jmzs0o");
                ...
                i3 = i2;
                composerStartRestartGroup.startReplaceGroup(-1476701825);
            }
            composerStartRestartGroup.endReplaceGroup();
            if (function24 != null) {
                composerStartRestartGroup.startReplaceGroup(-1444322883);
                ComposerKt.sourceInformation(composerStartRestartGroup, "668@32649L226");
                ...
                ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, -1222956578, "C672@32847L10:TextField.kt#jmzs0o");
            ...
            if (function3 != null) {
                composerStartRestartGroup.startReplaceGroup(-1443222972);
                ComposerKt.sourceInformation(composerStartRestartGroup, "694@33763L59");
                function3.invoke(LayoutIdKt.layoutId(Modifier.INSTANCE, "Hint").then(modifierM2041paddingqDBjuR0$default), composerStartRestartGroup, Integer.valueOf((i3 >> 6) & 112));
            } else {
                composerStartRestartGroup.startReplaceGroup(-1476701825);
            }
            composerStartRestartGroup.endReplaceGroup();
            if (function22 != null) {
                composerStartRestartGroup.startReplaceGroup(-1443101018);
                ComposerKt.sourceInformation(composerStartRestartGroup, "697@33886L57");
                Modifier modifierThen = LayoutIdKt.layoutId(Modifier.INSTANCE, "Label").then(modifierM2041paddingqDBjuR0$default);
                ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 733328855, "CC(Box)P(2,1,3)71@3423L130:Box.kt#2w3rfo");
                ...
                ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, -674436289, "C697@33934L7:TextField.kt#jmzs0o");
            ...
            composerStartRestartGroup.endReplaceGroup();
            Modifier modifierThen2 = LayoutIdKt.layoutId(Modifier.INSTANCE, "TextField").then(modifierM2041paddingqDBjuR0$default);
            ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 733328855, "CC(Box)P(2,1,3)71@3423L130:Box.kt#2w3rfo");
            ...
            Modifier modifierMaterializeModifier5 = ComposedModifierKt.materializeModifier(composerStartRestartGroup, modifierThen2);
            ...
            ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 1270525839, "C703@34128L11:TextField.kt#jmzs0o");
            function25 = function2;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.material.TextFieldKt$$ExternalSyntheticLambda8
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return TextFieldKt.TextFieldLayout$lambda$2(modifier, function25, function22, function3, function23, function24, z, f, paddingValues, i, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }

    static final Unit TextFieldLayout$lambda$2(Modifier modifier, Function2 function2, Function2 function22, Function3 function3, Function2 function23, Function2 function24, boolean z, float f, PaddingValues paddingValues, int i, Composer composer, int i2) {
    ...
    public static final int m3226calculateHeightO3s9Psw(int i, boolean z, int i2, int i3, int i4, int i5, long j, float f, PaddingValues paddingValues) {
        ...
        return ConstraintsKt.m9083constrainHeightK40F9xA(j, Math.max(MathKt.roundToInt(z ? i2 + f2 + iMax + bottom : top + iMax + bottom), Math.max(i3, i4)));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: calculateWidth-VsPV1Ek, reason: not valid java name */
    public static final int m3227calculateWidthVsPV1Ek(int i, int i2, int i3, int i4, int i5, long j) {
        return ConstraintsKt.m9084constrainWidthK40F9xA(j, i + Math.max(i3, Math.max(i4, i5)) + i2);
    }
    ...
    public static final Modifier drawIndicatorLine(Modifier modifier, final BorderStroke borderStroke) {
        ...
        return DrawModifierKt.drawWithContent(modifier, new Function1() { // from class: androidx.compose.material.TextFieldKt$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return TextFieldKt.drawIndicatorLine$lambda$0(width, borderStroke, (ContentDrawScope) obj);
            }
        });
    }

    static final Unit drawIndicatorLine$lambda$0(float f, BorderStroke borderStroke, ContentDrawScope contentDrawScope) {
        contentDrawScope.drawContent();
        if (Dp.m9119equalsimpl0(f, Dp.INSTANCE.m9132getHairlineD9Ej5fM())) {
            return Unit.INSTANCE;
        }
        float density = f * contentDrawScope.getDensity();
        float fIntBitsToFloat = Float.intBitsToFloat((int) (contentDrawScope.mo6899getSizeNHjbRc() & MuxerUtil.UNSIGNED_INT_MAX_VALUE)) - (density / 2.0f);
        DrawScope.m6884drawLine1RTmtNc$default(contentDrawScope, borderStroke.getBrush(), Offset.m6072constructorimpl((((long) Float.floatToRawIntBits(0.0f)) << 32) | (((long) Float.floatToRawIntBits(fIntBitsToFloat)) & MuxerUtil.UNSIGNED_INT_MAX_VALUE)), Offset.m6072constructorimpl((MuxerUtil.UNSIGNED_INT_MAX_VALUE & ((long) Float.floatToRawIntBits(fIntBitsToFloat))) | (Float.floatToRawIntBits(Float.intBitsToFloat((int) (contentDrawScope.mo6899getSizeNHjbRc() >> 32))) << 32)), density, 0, null, 0.0f, null, 0, 496, null);
        return Unit.INSTANCE;
    }
    ...
    public static final void placeWithLabel(Placeable.PlacementScope placementScope, int i, int i2, Placeable placeable, Placeable placeable2, Placeable placeable3, Placeable placeable4, Placeable placeable5, boolean z, int i3, int i4, float f, float f2) {
        ...
        if (placeable2 != null) {
            Placeable.PlacementScope.placeRelative$default(placementScope, placeable2, TextFieldImplKt.widthOrZero(placeable4), (z ? Alignment.INSTANCE.getCenterVertically().align(placeable2.getHeight(), i2) : MathKt.roundToInt(TextFieldImplKt.getTextFieldPadding() * f2)) - MathKt.roundToInt((r0 - i3) * f), 0.0f, 4, null);
        }
