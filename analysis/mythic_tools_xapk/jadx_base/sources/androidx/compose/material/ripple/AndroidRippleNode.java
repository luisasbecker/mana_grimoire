...
public final class AndroidRippleNode extends RippleNode implements RippleHostKey {
    ...
    public void mo3254addRipple12SF9DM(PressInteraction.Press interaction, long size, float targetRadius) {
        RippleHostView rippleHostView = getOrCreateRippleContainer().getRippleHostView(this);
        rippleHostView.m3261addRippleKOepWvA(interaction, getBounded(), size, MathKt.roundToInt(targetRadius), m3266getRippleColor0d7_KjU(), getRippleAlpha().invoke().getPressedAlpha(), new Function0() { // from class: androidx.compose.material.ripple.AndroidRippleNode$$ExternalSyntheticLambda0
    ...
    public void drawRipples(DrawScope drawScope) {
        ...
        if (rippleHostView != null) {
            rippleHostView.m3262setRipplePropertiesbiQXAtU(getRippleSize(), MathKt.roundToInt(getTargetRadius()), m3266getRippleColor0d7_KjU(), getRippleAlpha().invoke().getPressedAlpha());
