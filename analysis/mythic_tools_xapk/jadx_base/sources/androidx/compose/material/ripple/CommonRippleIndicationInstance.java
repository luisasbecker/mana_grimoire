...
final class CommonRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    private final void m3256drawRipples4WTKRHQ(DrawScope drawScope, long j) {
        long j2;
        ...
        while (it.hasNext()) {
            ...
            if (pressedAlpha == 0.0f) {
                ...
                j2 = j;
                value.m3258draw4WTKRHQ(drawScope, Color.m6324copywmQWz5c$default(j2, pressedAlpha, 0.0f, 0.0f, 0.0f, 14, null));
            }
            j = j2;
        }
    }
    ...
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        ...
        RippleAnimation rippleAnimation = new RippleAnimation(this.bounded ? Offset.m6069boximpl(interaction.getPressPosition()) : null, this.targetRadius, this.bounded, null);
    ...
    public void drawIndication(ContentDrawScope contentDrawScope) {
        this.targetRadius = Float.isNaN(this.radius) ? RippleAnimationKt.m3259getRippleEndRadiuscSwnlzA(contentDrawScope, this.bounded, contentDrawScope.mo6899getSizeNHjbRc()) : contentDrawScope.mo1624toPx0680j_4(this.radius);
        ...
        m3256drawRipples4WTKRHQ(contentDrawScope2, jM6335unboximpl);
    }
