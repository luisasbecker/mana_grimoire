...
public final class RippleAnimation {
    ...
    @DebugMetadata(c = "androidx.compose.material.ripple.RippleAnimation", f = "RippleAnimation.kt", i = {}, l = {Imgproc.COLOR_LRGB2Luv, Imgproc.COLOR_Lab2LRGB, 80}, m = "animate", n = {}, s = {}, v = 1)
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        ...
        static final class C00612 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00612(RippleAnimation rippleAnimation, Continuation<? super C00612> continuation) {
                super(2, continuation);
                this.this$0 = rippleAnimation;
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ResultKt.throwOnFailure(obj);
                    this.label = 1;
                    if (Animatable.animateTo$default(this.this$0.animatedRadiusPercent, Boxing.boxFloat(1.0f), AnimationSpecKt.tween$default(WebmConstants.MkvEbmlElement.AUDIO, 0, EasingKt.getFastOutSlowInEasing(), 2, null), null, null, this, 12, null) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    if (i != 1) {
        ...
        static final class AnonymousClass3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ResultKt.throwOnFailure(obj);
                    this.label = 1;
                    if (Animatable.animateTo$default(this.this$0.animatedCenterPercent, Boxing.boxFloat(1.0f), AnimationSpecKt.tween$default(WebmConstants.MkvEbmlElement.AUDIO, 0, EasingKt.getLinearEasing(), 2, null), null, null, this, 12, null) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    if (i != 1) {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new C00612(RippleAnimation.this, null), 3, null);
    ...
    static final class C04252 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        private /* synthetic */ Object L$0;
        int label;
        ...
        C04252(Continuation<? super C04252> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04252 c04252 = RippleAnimation.this.new C04252(continuation);
            c04252.L$0 = obj;
            return c04252;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Job> continuation) {
            return ((C04252) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object fadeOut(Continuation<? super Unit> continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C04252(null), continuation);
        return objCoroutineScope == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCoroutineScope : Unit.INSTANCE;
    }
    ...
    */
    ...
    public final void m3258draw4WTKRHQ(DrawScope drawScope, long j) {
        if (this.startRadius == null) {
            this.startRadius = Float.valueOf(RippleAnimationKt.m3260getRippleStartRadiusuvyYCjk(drawScope.mo6899getSizeNHjbRc()));
        }
        if (this.origin == null) {
            this.origin = Offset.m6069boximpl(drawScope.mo6898getCenterF1C5BW0());
        }
        if (this.targetCenter == null) {
            this.targetCenter = Offset.m6069boximpl(OffsetKt.Offset(Size.m6149getWidthimpl(drawScope.mo6899getSizeNHjbRc()) / 2.0f, Size.m6146getHeightimpl(drawScope.mo6899getSizeNHjbRc()) / 2.0f));
        }
        ...
        float fM6080getXimpl = Offset.m6080getXimpl(offset.m6090unboximpl());
        Offset offset2 = this.targetCenter;
        Intrinsics.checkNotNull(offset2);
        float fLerp2 = MathHelpersKt.lerp(fM6080getXimpl, Offset.m6080getXimpl(offset2.m6090unboximpl()), this.animatedCenterPercent.getValue().floatValue());
        Offset offset3 = this.origin;
        Intrinsics.checkNotNull(offset3);
        float fM6081getYimpl = Offset.m6081getYimpl(offset3.m6090unboximpl());
        Offset offset4 = this.targetCenter;
        Intrinsics.checkNotNull(offset4);
        long jOffset = OffsetKt.Offset(fLerp2, MathHelpersKt.lerp(fM6081getYimpl, Offset.m6081getYimpl(offset4.m6090unboximpl()), this.animatedCenterPercent.getValue().floatValue()));
        long jM6324copywmQWz5c$default = Color.m6324copywmQWz5c$default(j, Color.m6327getAlphaimpl(j) * fFloatValue, 0.0f, 0.0f, 0.0f, 14, null);
        if (!this.bounded) {
            DrawScope.m6880drawCircleVaOC9Bg$default(drawScope, jM6324copywmQWz5c$default, fLerp, jOffset, 0.0f, null, null, 0, 120, null);
            return;
        }
