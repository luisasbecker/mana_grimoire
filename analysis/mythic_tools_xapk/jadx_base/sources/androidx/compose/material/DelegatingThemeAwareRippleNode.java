...
final class DelegatingThemeAwareRippleNode extends DelegatingNode implements CompositionLocalConsumerModifierNode, ObserverModifierNode {
    ...
    private final void attachNewRipple() {
        this.rippleNode = delegate(androidx.compose.material.ripple.RippleKt.m3264createRippleModifierNodeTDGSqEk(this.interactionSource, this.bounded, this.radius, new ColorProducer() { // from class: androidx.compose.material.DelegatingThemeAwareRippleNode$attachNewRipple$calculateColor$1
            ...
            public final long mo3015invoke0d7_KjU() {
                ...
                return (rippleConfiguration == null || rippleConfiguration.getColor() == 16) ? RippleDefaults.INSTANCE.m3123rippleColor5vOe2sY(((Color) CompositionLocalConsumerModifierNodeKt.currentValueOf(this.this$0, ContentColorKt.getLocalContentColor())).m6335unboximpl(), ((Colors) CompositionLocalConsumerModifierNodeKt.currentValueOf(this.this$0, ColorsKt.getLocalColors())).isLight()) : rippleConfiguration.getColor();
            }
        }, new Function0() { // from class: androidx.compose.material.DelegatingThemeAwareRippleNode$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return DelegatingThemeAwareRippleNode.attachNewRipple$lambda$0(this.f$0);
            }
        }));
    }

    static final RippleAlpha attachNewRipple$lambda$0(DelegatingThemeAwareRippleNode delegatingThemeAwareRippleNode) {
        ...
        return (rippleConfiguration == null || (rippleAlpha = rippleConfiguration.getRippleAlpha()) == null) ? RippleDefaults.INSTANCE.m3122rippleAlphaDxMtmZc(((Color) CompositionLocalConsumerModifierNodeKt.currentValueOf(delegatingThemeAwareRippleNode2, ContentColorKt.getLocalContentColor())).m6335unboximpl(), ((Colors) CompositionLocalConsumerModifierNodeKt.currentValueOf(delegatingThemeAwareRippleNode2, ColorsKt.getLocalColors())).isLight()) : rippleAlpha;
    }
