...
final class EnterExitTransitionModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    private final void m1325setLookaheadConstraintsBRTryo0(long j) {
    ...
    public MeasureResult mo1288measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (measureScope.isLookingAhead()) {
            ...
            m1325setLookaheadConstraintsBRTryo0(j);
            return MeasureScope.layout$default(measureScope, (int) (jM9280constructorimpl >> 32), (int) (jM9280constructorimpl & MuxerUtil.UNSIGNED_INT_MAX_VALUE), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$1
                {
                    super(1);
                }
        ...
        if (!this.isEnabled.invoke().booleanValue()) {
            ...
            return MeasureScope.layout$default(measureScope, placeableMo7769measureBRTryo02.getWidth(), placeableMo7769measureBRTryo02.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$3$1
                {
                    super(1);
                }
        ...
        final Placeable placeableMo7769measureBRTryo03 = measurable.mo7769measureBRTryo0(j);
        long jM9280constructorimpl2 = IntSize.m9280constructorimpl((((long) placeableMo7769measureBRTryo03.getWidth()) << 32) | (((long) placeableMo7769measureBRTryo03.getHeight()) & MuxerUtil.UNSIGNED_INT_MAX_VALUE));
        final long j2 = AnimationModifierKt.m1292isValidozmzZPI(this.lookaheadSize) ? this.lookaheadSize : jM9280constructorimpl2;
        ...
        State<IntSize> stateAnimate3 = deferredAnimation != null ? deferredAnimation.animate(this.sizeTransitionSpec, new Function1<EnterExitState, IntSize>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$animSize$1
            ...
            public /* bridge */ /* synthetic */ IntSize invoke(EnterExitState enterExitState) {
                return IntSize.m9277boximpl(m1329invokeYEO4UFw(enterExitState));
            }

            /* JADX INFO: renamed from: invoke-YEO4UFw, reason: not valid java name */
            public final long m1329invokeYEO4UFw(EnterExitState enterExitState) {
                return this.this$0.m1326sizeByStateUzc_VyU(enterExitState, j2);
            }
        }) : null;
        if (stateAnimate3 != null) {
            jM9280constructorimpl2 = stateAnimate3.getValue().m9289unboximpl();
        }
        long jM9081constrain4WqzIAM = ConstraintsKt.m9081constrain4WqzIAM(j, jM9280constructorimpl2);
        Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation2 = this.offsetAnimation;
        long jM9253getZeronOccac = (deferredAnimation2 == null || (stateAnimate2 = deferredAnimation2.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<IntOffset>>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$offsetDelta$1
            @Override // kotlin.jvm.functions.Function1
            public final FiniteAnimationSpec<IntOffset> invoke(Transition.Segment<EnterExitState> segment) {
                return EnterExitTransitionKt.DefaultOffsetAnimationSpec;
            }
            ...
            public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                return IntOffset.m9233boximpl(m1330invokeBjo55l4(enterExitState));
            }

            /* JADX INFO: renamed from: invoke-Bjo55l4, reason: not valid java name */
            public final long m1330invokeBjo55l4(EnterExitState enterExitState) {
                return this.this$0.m1328targetOffsetByStateoFUgxo0(enterExitState, j2);
            }
        })) == null) ? IntOffset.INSTANCE.m9253getZeronOccac() : stateAnimate2.getValue().m9251unboximpl();
        Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation3 = this.slideAnimation;
        long jM9253getZeronOccac2 = (deferredAnimation3 == null || (stateAnimate = deferredAnimation3.animate(this.slideSpec, new Function1<EnterExitState, IntOffset>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$slideOffset$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                return IntOffset.m9233boximpl(m1331invokeBjo55l4(enterExitState));
            }

            /* JADX INFO: renamed from: invoke-Bjo55l4, reason: not valid java name */
            public final long m1331invokeBjo55l4(EnterExitState enterExitState) {
                return this.this$0.m1327slideTargetValueByStateoFUgxo0(enterExitState, j2);
            }
        })) == null) ? IntOffset.INSTANCE.m9253getZeronOccac() : stateAnimate.getValue().m9251unboximpl();
        Alignment alignment2 = this.currentAlignment;
        final long jM9246plusqkQi6aY = IntOffset.m9246plusqkQi6aY(alignment2 != null ? alignment2.mo5799alignKFBX0sM(j2, jM9081constrain4WqzIAM, LayoutDirection.Ltr) : IntOffset.INSTANCE.m9253getZeronOccac(), jM9253getZeronOccac2);
        final long j3 = jM9253getZeronOccac;
        return MeasureScope.layout$default(measureScope, (int) (jM9081constrain4WqzIAM >> 32), (int) (jM9081constrain4WqzIAM & MuxerUtil.UNSIGNED_INT_MAX_VALUE), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            ...
            /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Placeable.PlacementScope placementScope) {
                placementScope.placeWithLayer(placeableMo7769measureBRTryo03, IntOffset.m9242getXimpl(j3) + IntOffset.m9242getXimpl(jM9246plusqkQi6aY), IntOffset.m9243getYimpl(j3) + IntOffset.m9243getYimpl(jM9246plusqkQi6aY), 0.0f, function1Init);
            }
        }, 4, null);
    }
    ...
    public final long m1326sizeByStateUzc_VyU(EnterExitState targetState, long fullSize) {
        ...
        if (i != 1) {
            if (i == 2) {
                ...
                if (changeSize != null && (size = changeSize.getSize()) != null) {
                    return size.invoke(IntSize.m9277boximpl(fullSize)).m9289unboximpl();
                }
            } else {
                if (i != 3) {
                ...
                if (changeSize2 != null && (size2 = changeSize2.getSize()) != null) {
                    return size2.invoke(IntSize.m9277boximpl(fullSize)).m9289unboximpl();
                }
            }
        }
        return fullSize;
    ...
    public final long m1327slideTargetValueByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        Function1<IntSize, IntOffset> slideOffset;
        Function1<IntSize, IntOffset> slideOffset2;
        Slide slide = this.enter.getData().getSlide();
        long jM9253getZeronOccac = (slide == null || (slideOffset2 = slide.getSlideOffset()) == null) ? IntOffset.INSTANCE.m9253getZeronOccac() : slideOffset2.invoke(IntSize.m9277boximpl(fullSize)).m9251unboximpl();
        Slide slide2 = this.exit.getData().getSlide();
        long jM9253getZeronOccac2 = (slide2 == null || (slideOffset = slide2.getSlideOffset()) == null) ? IntOffset.INSTANCE.m9253getZeronOccac() : slideOffset.invoke(IntSize.m9277boximpl(fullSize)).m9251unboximpl();
        int i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
        if (i == 1) {
            return IntOffset.INSTANCE.m9253getZeronOccac();
        }
        if (i == 2) {
            return jM9253getZeronOccac;
        }
        if (i == 3) {
            return jM9253getZeronOccac2;
        }
        throw new NoWhenBranchMatchedException();
    }

    /* JADX INFO: renamed from: targetOffsetByState-oFUgxo0, reason: not valid java name */
    public final long m1328targetOffsetByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        int i;
        if (this.currentAlignment != null && getAlignment() != null && !Intrinsics.areEqual(this.currentAlignment, getAlignment()) && (i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()]) != 1 && i != 2) {
            if (i != 3) {
                throw new NoWhenBranchMatchedException();
            }
            ...
            long jM9289unboximpl = changeSize.getSize().invoke(IntSize.m9277boximpl(fullSize)).m9289unboximpl();
            Alignment alignment = getAlignment();
            Intrinsics.checkNotNull(alignment);
            long jMo5799alignKFBX0sM = alignment.mo5799alignKFBX0sM(fullSize, jM9289unboximpl, LayoutDirection.Ltr);
            Alignment alignment2 = this.currentAlignment;
            Intrinsics.checkNotNull(alignment2);
            return IntOffset.m9245minusqkQi6aY(jMo5799alignKFBX0sM, alignment2.mo5799alignKFBX0sM(fullSize, jM9289unboximpl, LayoutDirection.Ltr));
        }
        return IntOffset.INSTANCE.m9253getZeronOccac();
    }
}
