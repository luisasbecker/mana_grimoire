...
public final class EasingFunctionsKt {
    ...
    static final float EaseInBounce$lambda$0(float f) {
        return 1.0f - EaseOutBounce.transform(1.0f - f);
    }

    static final float EaseInElastic$lambda$0(float f) {
        if (f == 0.0f) {
            return 0.0f;
        }
        if (f == 1.0f) {
    ...
    static final float EaseInOutBounce$lambda$0(float f) {
        return (((double) f) < 0.5d ? 1.0f - EaseOutBounce.transform(1.0f - (f * 2.0f)) : 1.0f + EaseOutBounce.transform((f * 2.0f) - 1.0f)) / 2.0f;
    }

    static final float EaseInOutElastic$lambda$0(float f) {
        if (f == 0.0f) {
            return 0.0f;
        }
        if (f == 1.0f) {
    ...
    static final float EaseOutBounce$lambda$0(float f) {
        if (f < 0.36363637f) {
            return 7.5625f * f * f;
        }
        if (f < 0.72727275f) {
    ...
    static final float EaseOutElastic$lambda$0(float f) {
        if (f == 0.0f) {
            return 0.0f;
        }
        if (f == 1.0f) {
