...
public final class FontScaleConverterFactory {
    ...
    private final void put(float scaleKey, FontScaleConverter fontScaleConverter) {
        synchronized (LookupTablesWriteLock) {
            ...
            SparseArrayCompat<FontScaleConverter> sparseArrayCompatM1253clone = sLookupTables.m1253clone();
            fontScaleConverterFactory.putInto(sparseArrayCompatM1253clone, scaleKey, fontScaleConverter);
            sLookupTables = sparseArrayCompatM1253clone;
            Unit unit = Unit.INSTANCE;
        }
    }
