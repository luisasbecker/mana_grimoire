...
public final class CursorAnchorInfoBuilder_androidKt {
    ...
    */
    private static final CursorAnchorInfo.Builder addCharacterBounds(CursorAnchorInfo.Builder builder, int i, int i2, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Rect rect) {
        ...
        textLayoutResult.getMultiParagraph().m8416fillBoundingBoxes8ffj60Q(TextRangeKt.TextRange(iOriginalToTransformed, iOriginalToTransformed2), fArr, 0);
        for (int i3 = i; i3 < i2; i3++) {
            ...
            builder.addCharacterBounds(i3, rect2.getLeft(), rect2.getTop(), rect2.getRight(), rect2.getBottom(), r5 == true ? 1 : 0);
        }
        return builder;
    }
    ...
    public static final CursorAnchorInfo build(CursorAnchorInfo.Builder builder, TextFieldValue textFieldValue, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Matrix matrix, Rect rect, Rect rect2, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        builder.setSelectionRange(iM8554getMinimpl, TextRange.m8553getMaximpl(textFieldValue.getSelection()));
        if (z) {
            setInsertionMarker(builder, iM8554getMinimpl, offsetMapping, textLayoutResult, rect);
        }
        if (z2) {
            ...
            int iM8553getMaximpl = composition2 != null ? TextRange.m8553getMaximpl(composition2.getPackedValue()) : -1;
            if (iM8554getMinimpl2 >= 0 && iM8554getMinimpl2 < iM8553getMaximpl) {
                builder.setComposingText(iM8554getMinimpl2, textFieldValue.getText().subSequence(iM8554getMinimpl2, iM8553getMaximpl));
                addCharacterBounds(builder, iM8554getMinimpl2, iM8553getMaximpl, offsetMapping, textLayoutResult, rect);
            }
        }
