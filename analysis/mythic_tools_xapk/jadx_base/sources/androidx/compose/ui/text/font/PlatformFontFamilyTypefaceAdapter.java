...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        android.graphics.Typeface typefaceMo8696createDefaultFO1MlWM;
        FontFamily fontFamily = typefaceRequest.getFontFamily();
        if (fontFamily == null || (fontFamily instanceof DefaultFontFamily)) {
            typefaceMo8696createDefaultFO1MlWM = this.platformTypefaceResolver.mo8696createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m8714getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            typefaceMo8696createDefaultFO1MlWM = this.platformTypefaceResolver.mo8697createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m8714getFontStyle_LCdwA());
        } else {
            ...
            typefaceMo8696createDefaultFO1MlWM = ((AndroidTypeface) typeface).mo8815getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m8714getFontStyle_LCdwA(), typefaceRequest.m8715getFontSynthesisGVVA2EU());
        }
        return new TypefaceResult.Immutable(typefaceMo8696createDefaultFO1MlWM, false, 2, null);
    }
}
