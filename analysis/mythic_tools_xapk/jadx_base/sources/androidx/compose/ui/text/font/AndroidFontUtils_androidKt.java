...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m8620getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int i) {
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.INSTANCE)) >= 0, FontStyle.m8668equalsimpl0(i, FontStyle.INSTANCE.m8674getItalic_LCdwA()));
    }
}
