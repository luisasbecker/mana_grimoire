...
public final class TextDrawStyleKt {
    public static final TextForegroundStyle lerp(TextForegroundStyle textForegroundStyle, TextForegroundStyle textForegroundStyle2, float f) {
        ...
        if (!z && !(textForegroundStyle2 instanceof BrushStyle)) {
            return TextForegroundStyle.INSTANCE.m9019from8_81llA(ColorKt.m6376lerpjxsXWHM(textForegroundStyle.mo8872getColor0d7_KjU(), textForegroundStyle2.mo8872getColor0d7_KjU(), f));
        }
        if (!z || !(textForegroundStyle2 instanceof BrushStyle)) {
    ...
    public static final long m9018modulateDxMtmZc(long j, float f) {
        return (Float.isNaN(f) || f >= 1.0f) ? j : Color.m6324copywmQWz5c$default(j, Color.m6327getAlphaimpl(j) * f, 0.0f, 0.0f, 0.0f, 14, null);
    }
