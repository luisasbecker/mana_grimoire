...
public final class LayoutHelper {
    ...
    private final float getDownstreamHorizontal(int offset, boolean primary) {
        ...
        return primary ? layout.getPrimaryHorizontal(iCoerceAtMost) : layout.getSecondaryHorizontal(iCoerceAtMost);
    }
    ...
    */
    ...
    public final float getHorizontalPosition(int offset, boolean usePrimaryDirection, boolean upstream) {
        ...
        if (iLineEndToVisibleEnd == lineStart) {
            ...
            return zIsRtlParagraph ? layout2.getPrimaryHorizontal(bidiRunArr[i5 - 1].getStart()) : layout2.getPrimaryHorizontal(bidiRunArr[i5 + 1].getStart());
        }
        ...
        return zIsRtlParagraph ? layout3.getPrimaryHorizontal(bidiRunArr[i5 - 1].getEnd()) : layout3.getPrimaryHorizontal(bidiRunArr[i5 + 1].getEnd());
    }
