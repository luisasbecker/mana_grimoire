...
public final class ViewLayer extends View {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        long jM6140constructorimpl = Size.m6140constructorimpl((((long) Float.floatToRawIntBits(getHeight())) & MuxerUtil.UNSIGNED_INT_MAX_VALUE) | (Float.floatToRawIntBits(width) << 32));
        ...
        drawContext.mo6821setSizeuvyYCjk(jM6140constructorimpl);
