...
public final class EncodeHelper {
    ...
    public final void encode(Shadow shadow) {
        m8260encode8_81llA(shadow.getColor());
    ...
    public final void encode(SpanStyle spanStyle) {
        ...
        if (fontStyle != null) {
            ...
            encode((byte) 4);
            m8262encodenzbMABs(iM8671unboximpl);
        }
        FontSynthesis fontSynthesis = spanStyle.getFontSynthesis();
        if (fontSynthesis != null) {
            int iM8684unboximpl = fontSynthesis.m8684unboximpl();
            encode((byte) 5);
            m8259encode6p3vJLY(iM8684unboximpl);
        }
        ...
        if (!TextUnit.m9305equalsimpl0(spanStyle.getLetterSpacing(), TextUnit.INSTANCE.m9319getUnspecifiedXSAIIZE())) {
            encode((byte) 7);
            m8257encodeR2X_6o(spanStyle.getLetterSpacing());
        }
        BaselineShift baselineShift = spanStyle.getBaselineShift();
        if (baselineShift != null) {
            float fM8860unboximpl = baselineShift.m8860unboximpl();
            encode((byte) 8);
            m8258encode4Dl_Bck(fM8860unboximpl);
        }
        ...
        if (!Color.m6326equalsimpl0(spanStyle.getBackground(), Color.INSTANCE.m6361getUnspecified0d7_KjU())) {
            encode((byte) 10);
            m8260encode8_81llA(spanStyle.getBackground());
        }
    ...
    public final void m8257encodeR2X_6o(long textUnit) {
    ...
    public final void m8258encode4Dl_Bck(float baselineShift) {
        encode(baselineShift);
    }

    /* JADX INFO: renamed from: encode-6p3vJLY, reason: not valid java name */
    public final void m8259encode6p3vJLY(int fontSynthesis) {
        byte b = 0;
    ...
    public final void m8260encode8_81llA(long color) {
        m8261encodeVKZWuLQ(ULong.m11619constructorimpl(AndroidColor_androidKt.m6188toColorLong8_81llA(color)));
    }

    /* JADX INFO: renamed from: encode-VKZWuLQ, reason: not valid java name */
    public final void m8261encodeVKZWuLQ(long uLong) {
        this.parcel.writeLong(uLong);
    }

    /* JADX INFO: renamed from: encode-nzbMABs, reason: not valid java name */
    public final void m8262encodenzbMABs(int fontStyle) {
        byte b = 0;
