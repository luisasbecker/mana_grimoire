...
public final class WindowInfoKt {
    public static final void WindowFocusObserver(final Function1<? super Boolean, Unit> function1, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(WindowFocusObserver)68@2941L7,69@2968L42,70@3042L90,70@3015L117:WindowInfo.kt#itgzvw");
        if ((i & 6) == 0) {
        ...
        if (composerStartRestartGroup.shouldExecute((i2 & 3) != 2, i2 & 1)) {
            ...
            ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, -1709607551, "CC(remember):WindowInfo.kt#9igjgp");
