...
public final class SubcomposeLayoutKt {
    ...
    public static final void SubcomposeLayout(final Modifier modifier, Function2<? super SubcomposeMeasureScope, ? super Constraints, ? extends MeasureResult> function2, Composer composer, final int i, final int i2) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(SubcomposeLayout)P(1)97@4796L36,96@4762L145:SubcomposeLayout.kt#80mrfh");
        int i4 = i2 & 1;
        if (i4 != 0) {
            i3 = i | 6;
        } else if ((i & 6) == 0) {
    ...
    public static final void SubcomposeLayout(final SubcomposeLayoutState subcomposeLayoutState, Modifier modifier, final Function2<? super SubcomposeMeasureScope, ? super Constraints, ? extends MeasureResult> function2, Composer composer, final int i, final int i2) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(SubcomposeLayout)P(2,1)129@6259L27,130@6327L28,133@6483L492:SubcomposeLayout.kt#80mrfh");
        if ((i & 6) == 0) {
        ...
        if (composerStartRestartGroup.shouldExecute((i3 & 147) != 146, i3 & 1)) {
            ...
            Updater.m5603setimpl(composerM5595constructorimpl, subcomposeLayoutState, subcomposeLayoutState.getSetRoot$ui());
            Updater.m5603setimpl(composerM5595constructorimpl, compositionContextRememberCompositionContext, subcomposeLayoutState.getSetCompositionContext$ui());
            Updater.m5603setimpl(composerM5595constructorimpl, function2, subcomposeLayoutState.getSetMeasurePolicy$ui());
            ...
            if (composerStartRestartGroup.getSkipping()) {
                composerStartRestartGroup.startReplaceGroup(-1266202711);
            } else {
                composerStartRestartGroup.startReplaceGroup(-1259244916);
                ComposerKt.sourceInformation(composerStartRestartGroup, "146@7032L34,146@7021L45");
                ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 1899042491, "CC(remember):SubcomposeLayout.kt#9igjgp");
