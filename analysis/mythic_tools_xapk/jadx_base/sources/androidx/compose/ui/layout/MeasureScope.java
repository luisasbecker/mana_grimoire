...
public interface MeasureScope extends IntrinsicMeasureScope {
    ...
    public static final class DefaultImpls {
        ...
        public static int m7813roundToPxR2X_6o(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo1617roundToPxR2X_6o(j);
        }

        @Deprecated
        /* JADX INFO: renamed from: roundToPx-0680j_4, reason: not valid java name */
        public static int m7814roundToPx0680j_4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo1618roundToPx0680j_4(f);
        }

        @Deprecated
        /* JADX INFO: renamed from: toDp-GaN1DYA, reason: not valid java name */
        public static float m7815toDpGaN1DYA(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo1619toDpGaN1DYA(j);
        }

        @Deprecated
        /* JADX INFO: renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m7816toDpu2uoSUM(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo1620toDpu2uoSUM(f);
        }

        @Deprecated
        /* JADX INFO: renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m7817toDpu2uoSUM(MeasureScope measureScope, int i) {
            return MeasureScope.super.mo1621toDpu2uoSUM(i);
        }

        @Deprecated
        /* JADX INFO: renamed from: toDpSize-k-rfVVM, reason: not valid java name */
        public static long m7818toDpSizekrfVVM(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo1622toDpSizekrfVVM(j);
        }

        @Deprecated
        /* JADX INFO: renamed from: toPx--R2X_6o, reason: not valid java name */
        public static float m7819toPxR2X_6o(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo1623toPxR2X_6o(j);
        }

        @Deprecated
        /* JADX INFO: renamed from: toPx-0680j_4, reason: not valid java name */
        public static float m7820toPx0680j_4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo1624toPx0680j_4(f);
        }
        ...
        public static long m7821toSizeXkaWNTQ(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo1625toSizeXkaWNTQ(j);
        }

        @Deprecated
        /* JADX INFO: renamed from: toSp-0xMU5do, reason: not valid java name */
        public static long m7822toSp0xMU5do(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo1626toSp0xMU5do(f);
        }

        @Deprecated
        /* JADX INFO: renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m7823toSpkPz2Gy4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo1627toSpkPz2Gy4(f);
        }

        @Deprecated
        /* JADX INFO: renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m7824toSpkPz2Gy4(MeasureScope measureScope, int i) {
            return MeasureScope.super.mo1628toSpkPz2Gy4(i);
        }
    }
