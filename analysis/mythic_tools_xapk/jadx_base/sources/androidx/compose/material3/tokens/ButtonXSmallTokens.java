...
public final class ButtonXSmallTokens {
    ...
    private static final float IconLabelSpace = Dp.m9114constructorimpl(8.0f);
    ...
    public final float m4765getIconLabelSpaceD9Ej5fM() {
    ...
    public final float m4767getLeadingSpaceD9Ej5fM() {
        return LeadingSpace;
    }

    /* JADX INFO: renamed from: getOutlinedOutlineWidth-D9Ej5fM, reason: not valid java name */
    public final float m4768getOutlinedOutlineWidthD9Ej5fM() {
    ...
    public final float m4769getTrailingSpaceD9Ej5fM() {
