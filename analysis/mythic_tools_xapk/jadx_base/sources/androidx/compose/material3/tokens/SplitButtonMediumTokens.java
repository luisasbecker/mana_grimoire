...
public final class SplitButtonMediumTokens {
    ...
    private static final float LeadingButtonLeadingSpace = Dp.m9114constructorimpl(24.0f);
    private static final float LeadingButtonTrailingSpace = Dp.m9114constructorimpl(24.0f);
    private static final float TrailingIconSize = Dp.m9114constructorimpl(26.0f);
    private static final float TrailingInnerSelectedCornerCornerSizePercent = 50.0f;
    private static final float TrailingButtonLeadingSpace = Dp.m9114constructorimpl(15.0f);
    private static final float TrailingButtonTrailingSpace = Dp.m9114constructorimpl(15.0f);

    private SplitButtonMediumTokens() {
    }

    /* JADX INFO: renamed from: getBetweenSpace-D9Ej5fM, reason: not valid java name */
    public final float m5341getBetweenSpaceD9Ej5fM() {
        return BetweenSpace;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m5342getContainerHeightD9Ej5fM() {
    ...
    public final float m5346getTrailingButtonTrailingSpaceD9Ej5fM() {
        return TrailingButtonTrailingSpace;
    }

    /* JADX INFO: renamed from: getTrailingIconSize-D9Ej5fM, reason: not valid java name */
    public final float m5347getTrailingIconSizeD9Ej5fM() {
