...
public final class LargeIconButtonTokens {
    ...
    private static final float ContainerHeight = Dp.m9114constructorimpl(96.0f);
    ...
    private static final float IconSize = Dp.m9114constructorimpl(32.0f);
    private static final float NarrowLeadingSpace = Dp.m9114constructorimpl(16.0f);
    private static final float NarrowTrailingSpace = Dp.m9114constructorimpl(16.0f);
    private static final float OutlinedOutlineWidth = Dp.m9114constructorimpl(2.0f);
    ...
    private static final float UniformLeadingSpace = Dp.m9114constructorimpl(32.0f);
    private static final float UniformTrailingSpace = Dp.m9114constructorimpl(32.0f);
    private static final float WideLeadingSpace = Dp.m9114constructorimpl(48.0f);
    private static final float WideTrailingSpace = Dp.m9114constructorimpl(48.0f);

    private LargeIconButtonTokens() {
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m5072getContainerHeightD9Ej5fM() {
