...
public final class SplitButtonSmallTokens {
    ...
    private static final float LeadingButtonLeadingSpace = Dp.m9114constructorimpl(16.0f);
    private static final float LeadingButtonTrailingSpace = Dp.m9114constructorimpl(12.0f);
    private static final float TrailingIconSize = Dp.m9114constructorimpl(22.0f);
    private static final float TrailingInnerSelectedCornerCornerSizePercent = 50.0f;
    private static final float TrailingButtonLeadingSpace = Dp.m9114constructorimpl(13.0f);
    private static final float TrailingButtonTrailingSpace = Dp.m9114constructorimpl(13.0f);

    private SplitButtonSmallTokens() {
    }

    /* JADX INFO: renamed from: getBetweenSpace-D9Ej5fM, reason: not valid java name */
    public final float m5348getBetweenSpaceD9Ej5fM() {
        return BetweenSpace;
    }
    ...
    public final float m5353getTrailingButtonTrailingSpaceD9Ej5fM() {
        return TrailingButtonTrailingSpace;
    }

    /* JADX INFO: renamed from: getTrailingIconSize-D9Ej5fM, reason: not valid java name */
    public final float m5354getTrailingIconSizeD9Ej5fM() {
