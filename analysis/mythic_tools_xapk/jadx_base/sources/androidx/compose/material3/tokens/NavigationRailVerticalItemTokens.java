...
public final class NavigationRailVerticalItemTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m9114constructorimpl(32.0f);
    private static final float ActiveIndicatorWidth = Dp.m9114constructorimpl(56.0f);
    private static final float IconLabelSpace = Dp.m9114constructorimpl(4.0f);
    private static final float LeadingSpace = Dp.m9114constructorimpl(16.0f);
    private static final float TrailingSpace = Dp.m9114constructorimpl(16.0f);
    ...
    public final float m5165getLeadingSpaceD9Ej5fM() {
        return LeadingSpace;
    }

    /* JADX INFO: renamed from: getTrailingSpace-D9Ej5fM, reason: not valid java name */
    public final float m5166getTrailingSpaceD9Ej5fM() {
