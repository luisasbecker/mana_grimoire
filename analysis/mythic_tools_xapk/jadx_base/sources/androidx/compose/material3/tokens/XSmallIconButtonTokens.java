...
public final class XSmallIconButtonTokens {
    ...
    private static final float DefaultLeadingSpace = Dp.m9114constructorimpl(6.0f);
    private static final float DefaultTrailingSpace = Dp.m9114constructorimpl(6.0f);
    private static final float IconSize = Dp.m9114constructorimpl(20.0f);
    private static final float NarrowLeadingSpace = Dp.m9114constructorimpl(4.0f);
    private static final float NarrowTrailingSpace = Dp.m9114constructorimpl(4.0f);
    private static final float OutlinedOutlineWidth = Dp.m9114constructorimpl(1.0f);
    ...
    private static final float WideLeadingSpace = Dp.m9114constructorimpl(10.0f);
    private static final float WideTrailingSpace = Dp.m9114constructorimpl(10.0f);
    ...
    public final float m5524getWideLeadingSpaceD9Ej5fM() {
        return WideLeadingSpace;
    }

    /* JADX INFO: renamed from: getWideTrailingSpace-D9Ej5fM, reason: not valid java name */
    public final float m5525getWideTrailingSpaceD9Ej5fM() {
