...
public final class SplitButtonLargeTokens {
    ...
    private static final float LeadingButtonLeadingSpace = Dp.m9114constructorimpl(48.0f);
    private static final float LeadingButtonTrailingSpace = Dp.m9114constructorimpl(48.0f);
    private static final float TrailingIconSize = Dp.m9114constructorimpl(38.0f);
    private static final float TrailingInnerSelectedCornerCornerSizePercent = 50.0f;
    private static final float TrailingButtonLeadingSpace = Dp.m9114constructorimpl(29.0f);
    private static final float TrailingButtonTrailingSpace = Dp.m9114constructorimpl(29.0f);

    private SplitButtonLargeTokens() {
    }

    /* JADX INFO: renamed from: getBetweenSpace-D9Ej5fM, reason: not valid java name */
    public final float m5334getBetweenSpaceD9Ej5fM() {
        return BetweenSpace;
    }
    ...
    public final float m5339getTrailingButtonTrailingSpaceD9Ej5fM() {
        return TrailingButtonTrailingSpace;
    }

    /* JADX INFO: renamed from: getTrailingIconSize-D9Ej5fM, reason: not valid java name */
    public final float m5340getTrailingIconSizeD9Ej5fM() {
