...
public final class XLargeIconButtonTokens {
    ...
    private static final float DefaultLeadingSpace = Dp.m9114constructorimpl(48.0f);
    private static final float DefaultTrailingSpace = Dp.m9114constructorimpl(48.0f);
    private static final float IconSize = Dp.m9114constructorimpl(40.0f);
    private static final float NarrowLeadingSpace = Dp.m9114constructorimpl(32.0f);
    private static final float NarrowTrailingSpace = Dp.m9114constructorimpl(32.0f);
    private static final float OutlinedOutlineWidth = Dp.m9114constructorimpl(3.0f);
    ...
    private static final float WideLeadingSpace = Dp.m9114constructorimpl(72.0f);
    private static final float WideTrailingSpace = Dp.m9114constructorimpl(72.0f);

    private XLargeIconButtonTokens() {
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m5508getContainerHeightD9Ej5fM() {
    ...
    public final float m5515getWideLeadingSpaceD9Ej5fM() {
        return WideLeadingSpace;
    }

    /* JADX INFO: renamed from: getWideTrailingSpace-D9Ej5fM, reason: not valid java name */
    public final float m5516getWideTrailingSpaceD9Ej5fM() {
