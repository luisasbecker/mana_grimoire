...
public final class ElevationKt {
    ...
    public static final Object m4591animateElevationrAjV9yQ(Animatable<Dp, ?> animatable, float f, Interaction interaction, Interaction interaction2, Continuation<? super Unit> continuation) {
    ...
    public static /* synthetic */ Object m4592animateElevationrAjV9yQ$default(Animatable animatable, float f, Interaction interaction, Interaction interaction2, Continuation continuation, int i, Object obj) {
        if ((i & 2) != 0) {
            interaction = null;
        }
        if ((i & 4) != 0) {
        ...
        return m4591animateElevationrAjV9yQ(animatable, f, interaction, interaction2, continuation);
    }
}
