...
final class DraggableAnchorsNode<T> extends Modifier.Node implements LayoutModifierNode {
    ...
    static final Unit measure_3p2s80s$lambda$1(MeasureScope measureScope, DraggableAnchorsNode draggableAnchorsNode, final Placeable placeable, Placeable.PlacementScope placementScope) {
        final float fPositionOf = measureScope.isLookingAhead() ? draggableAnchorsNode.state.getAnchors().positionOf(draggableAnchorsNode.state.getTargetValue()) : draggableAnchorsNode.state.requireOffset();
        final float f = draggableAnchorsNode.orientation == Orientation.Horizontal ? fPositionOf : 0.0f;
        ...
        placementScope.withMotionFrameOfReferencePlacement(new Function1() { // from class: androidx.compose.material3.internal.DraggableAnchorsNode$$ExternalSyntheticLambda1
            ...
            public final Object invoke(Object obj) {
                return DraggableAnchorsNode.measure_3p2s80s$lambda$1$lambda$0(placeable, f, fPositionOf, (Placeable.PlacementScope) obj);
            }
        });
    ...
    public MeasureResult mo1288measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, placeableMo7769measureBRTryo0.getWidth(), placeableMo7769measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.material3.internal.DraggableAnchorsNode$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return DraggableAnchorsNode.measure_3p2s80s$lambda$1(measureScope, this, placeableMo7769measureBRTryo0, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
