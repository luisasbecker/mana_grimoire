...
public final class AnchoredDraggableKt {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function3<CoroutineScope, Float, Continuation<? super Unit>, Object> {
        ...
        static final class C00771 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            C00771(AnchoredDraggableState<T> anchoredDraggableState, float f, Continuation<? super C00771> continuation) {
    ...
    static final class C04561<I> extends ContinuationImpl {
        int label;
    ...
    static final class C04572 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        static final class AnonymousClass1<T> implements FlowCollector {
            ...
            static final class C00782 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                C00782(Function2<? super I, ? super Continuation<? super Unit>, ? extends Object> function2, I i, CoroutineScope coroutineScope, Continuation<? super C00782> continuation) {
                    super(2, continuation);
                ...
                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    return new C00782(this.$block, this.$latestInputs, this.$$this$coroutineScope, continuation);
                }
            ...
            */
            public final Object emit(I i, Continuation<? super Unit> continuation) {
                ...
                this.$previousDrag.element = (T) BuildersKt__Builders_commonKt.launch$default(this.$$this$coroutineScope, null, CoroutineStart.UNDISPATCHED, new C00782(this.$block, obj, this.$$this$coroutineScope, null), 1, null);
                return Unit.INSTANCE;
            }
        }
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C04572(Function0<? extends I> function0, Function2<? super I, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super C04572> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04572 c04572 = new C04572(this.$inputs, this.$block, continuation);
            c04572.L$0 = obj;
            return c04572;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C04572) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    static final class C04582<T> extends SuspendLambda implements Function4<AnchoredDragScope, DraggableAnchors<T>, T, Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        /* synthetic */ Object L$1;
        /* synthetic */ Object L$2;
        int label;

        C04582(Continuation<? super C04582> continuation) {
            super(4, continuation);
        }

        @Override // kotlin.jvm.functions.Function4
        public final Object invoke(AnchoredDragScope anchoredDragScope, DraggableAnchors<T> draggableAnchors, T t, Continuation<? super Unit> continuation) {
            C04582 c04582 = new C04582(continuation);
            c04582.L$0 = anchoredDragScope;
            c04582.L$1 = draggableAnchors;
            c04582.L$2 = t;
            return c04582.invokeSuspend(Unit.INSTANCE);
        }
    ...
    */
    public static final <I> Object restartable(Function0<? extends I> function0, Function2<? super I, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        ...
        Object obj = c04561.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c04561.label;
        try {
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                C04572 c04572 = new C04572(function0, function2, null);
                c04561.label = 1;
                if (CoroutineScopeKt.coroutineScope(c04572, c04561) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
    ...
    public static final <T> Object snapTo(AnchoredDraggableState<T> anchoredDraggableState, T t, Continuation<? super Unit> continuation) {
        Object objAnchoredDrag$default = AnchoredDraggableState.anchoredDrag$default(anchoredDraggableState, t, null, new C04582(null), continuation, 2, null);
        return objAnchoredDrag$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objAnchoredDrag$default : Unit.INSTANCE;
    }
}
