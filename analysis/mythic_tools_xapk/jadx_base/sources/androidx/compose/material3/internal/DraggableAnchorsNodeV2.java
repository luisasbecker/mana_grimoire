...
final class DraggableAnchorsNodeV2<T> extends Modifier.Node implements LayoutModifierNode {
    ...
    static final Unit measure_3p2s80s$lambda$1(MeasureScope measureScope, DraggableAnchorsNodeV2 draggableAnchorsNodeV2, final Placeable placeable, Placeable.PlacementScope placementScope) {
        ...
        final float f = draggableAnchorsNodeV2.orientation == Orientation.Horizontal ? (draggableAnchorsNodeV2.isReverseDirection() ? -1.0f : 1.0f) * fPositionOf : 0.0f;
        ...
        placementScope.withMotionFrameOfReferencePlacement(new Function1() { // from class: androidx.compose.material3.internal.DraggableAnchorsNodeV2$$ExternalSyntheticLambda1
            ...
            public final Object invoke(Object obj) {
                return DraggableAnchorsNodeV2.measure_3p2s80s$lambda$1$lambda$0(placeable, f, fPositionOf, (Placeable.PlacementScope) obj);
            }
        });
    ...
    public MeasureResult mo1288measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (!measureScope.isLookingAhead() || !this.didLookahead) {
            Pair<? extends androidx.compose.foundation.gestures.DraggableAnchors<T>, ? extends T> pairInvoke = this.anchors.invoke(IntSize.m9277boximpl(IntSize.m9280constructorimpl((((long) placeableMo7769measureBRTryo0.getHeight()) & MuxerUtil.UNSIGNED_INT_MAX_VALUE) | (((long) placeableMo7769measureBRTryo0.getWidth()) << 32))), Constraints.m9054boximpl(j));
        ...
        return MeasureScope.layout$default(measureScope, placeableMo7769measureBRTryo0.getWidth(), placeableMo7769measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.material3.internal.DraggableAnchorsNodeV2$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return DraggableAnchorsNodeV2.measure_3p2s80s$lambda$1(measureScope, this, placeableMo7769measureBRTryo0, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
