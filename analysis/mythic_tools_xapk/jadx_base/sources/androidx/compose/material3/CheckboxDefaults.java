...
public final class CheckboxDefaults {
    ...
    public final CheckboxColors m3380colors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        ...
        CheckboxColors checkboxColorsM3367copy2qZNXz8 = getDefaultCheckboxColors$material3(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m3367copy2qZNXz8(jM6361getUnspecified0d7_KjU3, Color.INSTANCE.m6360getTransparent0d7_KjU(), jM6361getUnspecified0d7_KjU, Color.INSTANCE.m6360getTransparent0d7_KjU(), jM6361getUnspecified0d7_KjU4, Color.INSTANCE.m6360getTransparent0d7_KjU(), jM6361getUnspecified0d7_KjU6, jM6361getUnspecified0d7_KjU, jM6361getUnspecified0d7_KjU2, jM6361getUnspecified0d7_KjU4, jM6361getUnspecified0d7_KjU5, jM6361getUnspecified0d7_KjU6);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return checkboxColorsM3367copy2qZNXz8;
    }
    ...
    public final float m3381getStrokeWidthD9Ej5fM() {
        return StrokeWidth;
    }
}
