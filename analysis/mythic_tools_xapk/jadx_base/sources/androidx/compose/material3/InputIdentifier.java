...
public final class InputIdentifier {
    ...
    private static final int SingleDateInput = m3760constructorimpl(0);
    private static final int StartDateInput = m3760constructorimpl(1);
    private static final int EndDateInput = m3760constructorimpl(2);
    ...
    public static final /* synthetic */ InputIdentifier m3759boximpl(int i) {
        return new InputIdentifier(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m3760constructorimpl(int i) {
        return i;
    }
    ...
    public static String m3764toStringimpl(int i) {
        return m3762equalsimpl0(i, SingleDateInput) ? "SingleDateInput" : m3762equalsimpl0(i, StartDateInput) ? "StartDateInput" : m3762equalsimpl0(i, EndDateInput) ? "EndDateInput" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }

    public boolean equals(Object other) {
        return m3761equalsimpl(this.value, other);
    }
