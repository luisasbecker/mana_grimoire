...
public final class MagnifierNode extends Modifier.Node implements GlobalPositionAwareModifierNode, DrawModifierNode, SemanticsModifierNode, ObserverModifierNode {
    ...
    private MagnifierNode(Function1<? super Density, Offset> function1, Function1<? super Density, Offset> function12, Function1<? super DpSize, Unit> function13, float f, boolean z, long j, float f2, float f3, boolean z2, PlatformMagnifierFactory platformMagnifierFactory) {
        ...
        this.sourceCenterInRoot = Offset.INSTANCE.m6095getUnspecifiedF1C5BW0();
    }
    ...
    public /* synthetic */ MagnifierNode(Function1 function1, Function1 function12, Function1 function13, float f, boolean z, long j, float f2, float f3, boolean z2, PlatformMagnifierFactory platformMagnifierFactory, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(function1, (i & 2) != 0 ? null : function12, (i & 4) != 0 ? null : function13, (i & 8) != 0 ? Float.NaN : f, (i & 16) != 0 ? false : z, (i & 32) != 0 ? DpSize.INSTANCE.m9221getUnspecifiedMYxV2XQ() : j, (i & 64) != 0 ? Dp.INSTANCE.m9134getUnspecifiedD9Ej5fM() : f2, (i & 128) != 0 ? Dp.INSTANCE.m9134getUnspecifiedD9Ej5fM() : f3, (i & 256) != 0 ? true : z2, (i & 512) != 0 ? PlatformMagnifierFactory.INSTANCE.getForCurrentPlatform() : platformMagnifierFactory, null);
    }
    ...
    private final long m1541getAnchorPositionInRootF1C5BW0() {
        ...
        return state != null ? state.getValue().m6090unboximpl() : Offset.INSTANCE.m6095getUnspecifiedF1C5BW0();
    }

    static final Offset getAnchorPositionInRoot_F1C5BW0$lambda$0(MagnifierNode magnifierNode) {
        LayoutCoordinates layoutCoordinates = magnifierNode.getLayoutCoordinates();
        return Offset.m6069boximpl(layoutCoordinates != null ? LayoutCoordinatesKt.positionInRoot(layoutCoordinates) : Offset.INSTANCE.m6095getUnspecifiedF1C5BW0());
    }
    ...
    static final Unit onObservedReadsChanged$lambda$0(MagnifierNode magnifierNode) {
    ...
    private final void recreateMagnifier() {
        ...
        this.magnifier = this.platformMagnifierFactory.mo1573createnHHXs2Y(view, this.useTextDefault, this.size, this.cornerRadius, this.elevation, this.clippingEnabled, density, this.zoom);
    ...
    */
    private final void updateMagnifier() {
        long jM6095getUnspecifiedF1C5BW0;
        Density densityRequireDensity = this.density;
        if (densityRequireDensity == null) {
            densityRequireDensity = DelegatableNodeKt.requireDensity(this);
            this.density = densityRequireDensity;
        }
        long jM6090unboximpl = this.sourceCenter.invoke(densityRequireDensity).m6090unboximpl();
        if ((jM6090unboximpl & 9223372034707292159L) == InlineClassHelperKt.UnspecifiedPackedFloats || (m1541getAnchorPositionInRootF1C5BW0() & 9223372034707292159L) == InlineClassHelperKt.UnspecifiedPackedFloats) {
            this.sourceCenterInRoot = Offset.INSTANCE.m6095getUnspecifiedF1C5BW0();
            PlatformMagnifier platformMagnifier = this.magnifier;
            if (platformMagnifier != null) {
                platformMagnifier.dismiss();
        ...
        this.sourceCenterInRoot = Offset.m6085plusMKHz9U(m1541getAnchorPositionInRootF1C5BW0(), jM6090unboximpl);
        Function1<? super Density, Offset> function1 = this.magnifierCenter;
        if (function1 != null) {
            Offset offsetM6069boximpl = Offset.m6069boximpl(function1.invoke(densityRequireDensity).m6090unboximpl());
            if ((offsetM6069boximpl.m6090unboximpl() & 9223372034707292159L) == InlineClassHelperKt.UnspecifiedPackedFloats) {
                offsetM6069boximpl = null;
            }
            if (offsetM6069boximpl != null) {
                jM6095getUnspecifiedF1C5BW0 = Offset.m6085plusMKHz9U(m1541getAnchorPositionInRootF1C5BW0(), offsetM6069boximpl.m6090unboximpl());
            } else {
                jM6095getUnspecifiedF1C5BW0 = Offset.INSTANCE.m6095getUnspecifiedF1C5BW0();
            }
        }
        long j = jM6095getUnspecifiedF1C5BW0;
        if (this.magnifier == null) {
            recreateMagnifier();
        }
        PlatformMagnifier platformMagnifier2 = this.magnifier;
        if (platformMagnifier2 != null) {
            platformMagnifier2.mo1572updateWko1d7g(this.sourceCenterInRoot, j, this.zoom);
        }
        updateSizeIfNecessary();
    }
    ...
    private final void updateSizeIfNecessary() {
        Density density;
        PlatformMagnifier platformMagnifier = this.magnifier;
        if (platformMagnifier == null || (density = this.density) == null || IntSize.m9282equalsimpl(platformMagnifier.mo1571getSizeYbymL2g(), this.previousSize)) {
            return;
        }
        Function1<? super DpSize, Unit> function1 = this.onSizeChanged;
        if (function1 != null) {
            function1.invoke(DpSize.m9200boximpl(density.mo1622toDpSizekrfVVM(IntSizeKt.m9297toSizeozmzZPI(platformMagnifier.mo1571getSizeYbymL2g()))));
        }
        this.previousSize = IntSize.m9277boximpl(platformMagnifier.mo1571getSizeYbymL2g());
    }
    ...
    public void applySemantics(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        semanticsPropertyReceiver.set(Magnifier_androidKt.getMagnifierPositionInRoot(), new Function0() { // from class: androidx.compose.foundation.MagnifierNode$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return Offset.m6069boximpl(this.f$0.sourceCenterInRoot);
            }
        });
    }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (channel != null) {
            ChannelResult.m12969boximpl(channel.mo12955trySendJP2dKIU(Unit.INSTANCE));
        }
    }
    ...
    public final void m1545setCornerRadius0680j_4(float f) {
        this.cornerRadius = f;
    }

    /* JADX INFO: renamed from: setElevation-0680j_4, reason: not valid java name */
    public final void m1546setElevation0680j_4(float f) {
        this.elevation = f;
    }
    ...
    public final void m1547setSizeEaSLcWc(long j) {
        this.size = j;
    }
    ...
    public final void m1548update5F03MCQ(Function1<? super Density, Offset> sourceCenter, Function1<? super Density, Offset> magnifierCenter, float zoom, boolean useTextDefault, long size, float cornerRadius, float elevation, boolean clippingEnabled, Function1<? super DpSize, Unit> onSizeChanged, PlatformMagnifierFactory platformMagnifierFactory) {
        ...
        if (this.magnifier != null && ((!Magnifier_androidKt.equalsIncludingNaN(zoom, f) && !platformMagnifierFactory.getCanUpdateZoom()) || !DpSize.m9209equalsimpl0(size, j) || !Dp.m9119equalsimpl0(cornerRadius, f2) || !Dp.m9119equalsimpl0(elevation, f3) || useTextDefault != z || clippingEnabled != z2 || !Intrinsics.areEqual(platformMagnifierFactory, platformMagnifierFactory2) || !Intrinsics.areEqual(viewRequireView, view) || !Intrinsics.areEqual(densityRequireDensity, density))) {
            recreateMagnifier();
        }
        updateMagnifier();
    }
