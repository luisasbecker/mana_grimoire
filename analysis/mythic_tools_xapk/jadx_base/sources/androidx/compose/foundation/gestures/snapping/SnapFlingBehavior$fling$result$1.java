...
final class SnapFlingBehavior$fling$result$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super AnimationResult<Float, AnimationVector1D>>, Object> {
    ...
    static final Unit invokeSuspend$lambda$1(Ref.FloatRef floatRef, Function1 function1, float f) {
        floatRef.element -= f;
        function1.invoke(Float.valueOf(floatRef.element));
        return Unit.INSTANCE;
    }

    static final Unit invokeSuspend$lambda$4(Ref.FloatRef floatRef, Function1 function1, float f) {
        floatRef.element -= f;
        function1.invoke(Float.valueOf(floatRef.element));
        return Unit.INSTANCE;
    }
