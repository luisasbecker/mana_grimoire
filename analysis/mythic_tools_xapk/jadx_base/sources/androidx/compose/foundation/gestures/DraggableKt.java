...
public final class DraggableKt {
    ...
    public static final float m1705toFloat3MmeM6k(long j, Orientation orientation) {
        return Float.intBitsToFloat((int) (orientation == Orientation.Vertical ? j & MuxerUtil.UNSIGNED_INT_MAX_VALUE : j >> 32));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: toFloat-sF-c-tU, reason: not valid java name */
    public static final float m1706toFloatsFctU(long j, Orientation orientation) {
        return orientation == Orientation.Vertical ? Velocity.m9353getYimpl(j) : Velocity.m9352getXimpl(j);
    }

    /* JADX INFO: renamed from: toValidVelocity-TH1AsA0, reason: not valid java name */
    public static final long m1707toValidVelocityTH1AsA0(long j) {
        return VelocityKt.Velocity(Float.isNaN(Velocity.m9352getXimpl(j)) ? 0.0f : Velocity.m9352getXimpl(j), Float.isNaN(Velocity.m9353getYimpl(j)) ? 0.0f : Velocity.m9353getYimpl(j));
    }
}
