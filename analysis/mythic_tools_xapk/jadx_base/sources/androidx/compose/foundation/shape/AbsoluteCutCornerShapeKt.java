...
public final class AbsoluteCutCornerShapeKt {
    ...
    public static final AbsoluteCutCornerShape m2329AbsoluteCutCornerShape0680j_4(float f) {
        return AbsoluteCutCornerShape(CornerSizeKt.m2337CornerSize0680j_4(f));
    }

    /* JADX INFO: renamed from: AbsoluteCutCornerShape-a9UjIt4, reason: not valid java name */
    public static final AbsoluteCutCornerShape m2330AbsoluteCutCornerShapea9UjIt4(float f, float f2, float f3, float f4) {
        return new AbsoluteCutCornerShape(CornerSizeKt.m2337CornerSize0680j_4(f), CornerSizeKt.m2337CornerSize0680j_4(f2), CornerSizeKt.m2337CornerSize0680j_4(f3), CornerSizeKt.m2337CornerSize0680j_4(f4));
    }

    /* JADX INFO: renamed from: AbsoluteCutCornerShape-a9UjIt4$default, reason: not valid java name */
    public static /* synthetic */ AbsoluteCutCornerShape m2331AbsoluteCutCornerShapea9UjIt4$default(float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m2330AbsoluteCutCornerShapea9UjIt4(f, f2, f3, f4);
    }
