...
final class HorizontalScrollableClipShape implements Shape {
    ...
    public Outline mo1539createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        ...
        return new Outline.Rectangle(new Rect(0.0f, -fMo1618roundToPx0680j_4, Float.intBitsToFloat((int) (size >> 32)), Float.intBitsToFloat((int) (size & MuxerUtil.UNSIGNED_INT_MAX_VALUE)) + fMo1618roundToPx0680j_4));
    }
}
