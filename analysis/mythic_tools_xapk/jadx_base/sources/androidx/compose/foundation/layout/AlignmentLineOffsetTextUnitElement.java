...
final class AlignmentLineOffsetTextUnitElement extends ModifierNodeElement<AlignmentLineOffsetTextUnitNode> {
    ...
    public boolean equals(Object other) {
        ...
        return alignmentLineOffsetTextUnitElement != null && Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetTextUnitElement.alignmentLine) && TextUnit.m9305equalsimpl0(this.before, alignmentLineOffsetTextUnitElement.before) && TextUnit.m9305equalsimpl0(this.after, alignmentLineOffsetTextUnitElement.after);
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + TextUnit.m9309hashCodeimpl(this.before)) * 31) + TextUnit.m9309hashCodeimpl(this.after);
    }
    ...
    public void update(AlignmentLineOffsetTextUnitNode node) {
        ...
        node.m1896setBeforeR2X_6o(this.before);
        node.m1895setAfterR2X_6o(this.after);
    }
}
