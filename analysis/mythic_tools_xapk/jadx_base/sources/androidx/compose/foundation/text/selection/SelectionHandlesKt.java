...
public final class SelectionHandlesKt {
    private static final float HandleWidth = Dp.m9114constructorimpl(25.0f);
    private static final float HandleHeight = Dp.m9114constructorimpl(25.0f);
    ...
    public static final long m2827getAdjustedCoordinatesk4lQ0M(long j) {
        float fIntBitsToFloat = Float.intBitsToFloat((int) (j >> 32));
        return Offset.m6072constructorimpl((((long) Float.floatToRawIntBits(Float.intBitsToFloat((int) (j & MuxerUtil.UNSIGNED_INT_MAX_VALUE)) - 1.0f)) & MuxerUtil.UNSIGNED_INT_MAX_VALUE) | (Float.floatToRawIntBits(fIntBitsToFloat) << 32));
    }
