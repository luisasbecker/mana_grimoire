...
final /* data */ class VerticalScrollLayoutModifier implements LayoutModifier {
    ...
    static final Unit measure_3p2s80s$lambda$0(VerticalScrollLayoutModifier verticalScrollLayoutModifier, Placeable placeable, int i, Placeable.PlacementScope placementScope) {
    ...
    public MeasureResult mo2417measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, placeableMo7769measureBRTryo0.getWidth(), iMin, null, new Function1() { // from class: androidx.compose.foundation.text.VerticalScrollLayoutModifier$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return VerticalScrollLayoutModifier.measure_3p2s80s$lambda$0(this.f$0, placeableMo7769measureBRTryo0, iMin, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
