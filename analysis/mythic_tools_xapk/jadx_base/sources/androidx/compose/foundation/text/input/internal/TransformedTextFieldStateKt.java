...
public final class TransformedTextFieldStateKt {
    public static final <R> R getIndexTransformationType(TransformedTextFieldState transformedTextFieldState, int i, Function3<? super IndexTransformationType, ? super TextRange, ? super TextRange, ? extends R> function3) {
        ...
        return function3.invoke((TextRange.m8550getCollapsedimpl(jM2680mapFromTransformedjx7JFs) && TextRange.m8550getCollapsedimpl(jM2683mapToTransformedGEjPoXI)) ? IndexTransformationType.Untransformed : (TextRange.m8550getCollapsedimpl(jM2680mapFromTransformedjx7JFs) || TextRange.m8550getCollapsedimpl(jM2683mapToTransformedGEjPoXI)) ? (!TextRange.m8550getCollapsedimpl(jM2680mapFromTransformedjx7JFs) || TextRange.m8550getCollapsedimpl(jM2683mapToTransformedGEjPoXI)) ? IndexTransformationType.Deletion : IndexTransformationType.Insertion : IndexTransformationType.Replacement, TextRange.m8544boximpl(jM2680mapFromTransformedjx7JFs), TextRange.m8544boximpl(jM2683mapToTransformedGEjPoXI));
    }
}
