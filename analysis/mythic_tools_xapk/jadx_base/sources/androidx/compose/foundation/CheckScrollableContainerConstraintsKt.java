...
public final class CheckScrollableContainerConstraintsKt {
    ...
    public static final void m1510checkScrollableContainerConstraintsK40F9xA(long j, Orientation orientation) {
        if (orientation == Orientation.Vertical) {
            if (Constraints.m9066getMaxHeightimpl(j) != Integer.MAX_VALUE) {
                return;
            }
            ...
            if (Constraints.m9067getMaxWidthimpl(j) != Integer.MAX_VALUE) {
                return;
            }
