...
final class MutableSpanStyle {
    ...
    public final void m1868setBackground8_81llA(long j) {
        this.background = j;
    }

    /* JADX INFO: renamed from: setBaselineShift-_isdbwI, reason: not valid java name */
    public final void m1869setBaselineShift_isdbwI(BaselineShift baselineShift) {
        this.baselineShift = baselineShift;
    }

    /* JADX INFO: renamed from: setColor-8_81llA, reason: not valid java name */
    public final void m1870setColor8_81llA(long j) {
        this.color = j;
    }
    ...
    public final void m1871setFontSizeR2X_6o(long j) {
        this.fontSize = j;
    }

    /* JADX INFO: renamed from: setFontStyle-mLjRB2g, reason: not valid java name */
    public final void m1872setFontStylemLjRB2g(FontStyle fontStyle) {
        this.fontStyle = fontStyle;
    }

    /* JADX INFO: renamed from: setFontSynthesis-tDdu0R4, reason: not valid java name */
    public final void m1873setFontSynthesistDdu0R4(FontSynthesis fontSynthesis) {
        this.fontSynthesis = fontSynthesis;
    }
    ...
    public final void m1874setLetterSpacingR2X_6o(long j) {
