...
public abstract class CustomTabsService extends Service {
    ...
    class AnonymousClass1 extends ICustomTabsService.Stub {
        ...
        private boolean newSessionInternal(ICustomTabsCallback iCustomTabsCallback, PendingIntent pendingIntent) {
            ...
            try {
                IBinder.DeathRecipient deathRecipient = new IBinder.DeathRecipient() { // from class: androidx.browser.customtabs.CustomTabsService$1$$ExternalSyntheticLambda2
                    @Override // android.os.IBinder.DeathRecipient
                    public final void binderDied() {
                        this.f$0.m19x67c68af6(customTabsSessionToken);
                    }
                };
        ...
        /* JADX INFO: renamed from: lambda$newAuthTabSession$1$androidx-browser-customtabs-CustomTabsService$1, reason: not valid java name */
        /* synthetic */ void m18x3d26a773(AuthTabSessionToken authTabSessionToken) {
        ...
        /* synthetic */ void m19x67c68af6(CustomTabsSessionToken customTabsSessionToken) {
        ...
        public boolean newAuthTabSession(IAuthTabCallback iAuthTabCallback, Bundle bundle) {
            final AuthTabSessionToken authTabSessionToken = new AuthTabSessionToken(iAuthTabCallback, getSessionIdFromBundle(bundle));
            try {
                IBinder.DeathRecipient deathRecipient = new IBinder.DeathRecipient() { // from class: androidx.browser.customtabs.CustomTabsService$1$$ExternalSyntheticLambda3
                    @Override // android.os.IBinder.DeathRecipient
                    public final void binderDied() {
                        this.f$0.m18x3d26a773(authTabSessionToken);
                    }
                };
                synchronized (CustomTabsService.this.mDeathRecipientMap) {
                    iAuthTabCallback.asBinder().linkToDeath(deathRecipient, 0);
                    CustomTabsService.this.mDeathRecipientMap.put(iAuthTabCallback.asBinder(), deathRecipient);
                }
        ...
        public void prefetch(ICustomTabsCallback iCustomTabsCallback, Uri uri, Bundle bundle) {
            CustomTabsService.this.prefetch(new CustomTabsSessionToken(iCustomTabsCallback, getSessionIdFromBundle(bundle)), AacWriter$$ExternalSyntheticBackport0.m(new Object[]{uri}), PrefetchOptions.fromBundle(bundle));
        }

        @Override // android.support.customtabs.ICustomTabsService
        public void prefetchWithMultipleUrls(ICustomTabsCallback iCustomTabsCallback, List<Uri> list, Bundle bundle) {
            CustomTabsService.this.prefetch(new CustomTabsSessionToken(iCustomTabsCallback, getSessionIdFromBundle(bundle)), list, PrefetchOptions.fromBundle(bundle));
        }
    ...
    protected boolean cleanUpSession(AuthTabSessionToken authTabSessionToken) {
        try {
    ...
    protected void prefetch(CustomTabsSessionToken customTabsSessionToken, Uri uri, PrefetchOptions prefetchOptions) {
    }

    protected void prefetch(CustomTabsSessionToken customTabsSessionToken, List<Uri> list, PrefetchOptions prefetchOptions) {
    }

    protected abstract boolean receiveFile(CustomTabsSessionToken customTabsSessionToken, Uri uri, int i, Bundle bundle);

    protected boolean registerAuthTabSession(AuthTabSessionToken authTabSessionToken) {
        return false;
    }
