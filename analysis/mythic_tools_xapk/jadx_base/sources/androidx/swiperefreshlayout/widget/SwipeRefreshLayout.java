...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent3, NestedScrollingParent2, NestedScrollingChild3, NestedScrollingChild2, NestedScrollingParent, NestedScrollingChild {
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mAnimateToCorrectPosition = new Animation() { // from class: androidx.swiperefreshlayout.widget.SwipeRefreshLayout.6
            ...
            public void applyTransformation(float f, Transformation transformation) {
                ...
                SwipeRefreshLayout swipeRefreshLayout = SwipeRefreshLayout.this;
                SwipeRefreshLayout.this.setTargetOffsetTopAndBottom((SwipeRefreshLayout.this.mFrom + ((int) (((!z ? swipeRefreshLayout.mSpinnerOffsetEnd - Math.abs(SwipeRefreshLayout.this.mOriginalOffsetTop) : swipeRefreshLayout.mSpinnerOffsetEnd) - SwipeRefreshLayout.this.mFrom) * f))) - SwipeRefreshLayout.this.mCircleView.getTop());
    ...
    private void moveSpinner(float f) {
        ...
        int i3 = this.mOriginalOffsetTop + ((int) ((f2 * fMin) + (f2 * fPow * 2.0f)));
