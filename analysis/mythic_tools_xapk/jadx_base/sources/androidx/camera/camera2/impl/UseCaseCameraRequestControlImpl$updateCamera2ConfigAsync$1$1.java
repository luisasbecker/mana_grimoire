...
@DebugMetadata(c = "androidx.camera.camera2.impl.UseCaseCameraRequestControlImpl$updateCamera2ConfigAsync$1$1", f = "UseCaseCameraRequestControl.kt", i = {}, l = {Videoio.CAP_PROP_XI_AEAG_ROI_WIDTH}, m = "invokeSuspend", n = {}, s = {}, v = 1)
final class UseCaseCameraRequestControlImpl$updateCamera2ConfigAsync$1$1 extends SuspendLambda implements Function1<Continuation<? super Deferred<? extends Unit>>, Object> {
    ...
    UseCaseCameraRequestControlImpl$updateCamera2ConfigAsync$1$1(UseCaseCameraRequestControlImpl useCaseCameraRequestControlImpl, Config config, Map<String, ? extends Object> map, Continuation<? super UseCaseCameraRequestControlImpl$updateCamera2ConfigAsync$1$1> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (Logger.isDebugEnabled(Log.TAG)) {
            android.util.Log.d(Camera2Logger.TRUNCATED_TAG, "UseCaseCameraRequestControlImpl#updateCamera2ConfigAsync");
        }
