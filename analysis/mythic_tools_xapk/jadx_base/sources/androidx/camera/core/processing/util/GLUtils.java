...
public final class GLUtils {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (shaderProvider != null) {
                ...
                if (dynamicRange.is10BitHdr()) {
                    ...
                    samplerShaderProgram = shaderProvider2 != null ? new SamplerShaderProgram(dynamicRange, shaderProvider2) : new SamplerShaderProgram(dynamicRange, InputFormat.DEFAULT);
                }
            }
    ...
    public static int loadShader(int i, String str) {
        ...
        throw new IllegalStateException("Could not compile shader type " + i + Constants.SUBS_ID_BASE_PLAN_ID_SEPARATOR + strGlGetShaderInfoLog);
    }
