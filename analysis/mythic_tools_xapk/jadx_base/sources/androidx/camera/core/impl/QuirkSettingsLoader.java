...
public class QuirkSettingsLoader implements Function<Context, QuirkSettings> {
    ...
    public QuirkSettings apply(Context context) {
        try {
            Bundle bundle = context.getPackageManager().getServiceInfo(new ComponentName(context, (Class<?>) MetadataHolderService.class), Imgcodecs.IMWRITE_JPEGXL_QUALITY).metaData;
            if (bundle != null) {
