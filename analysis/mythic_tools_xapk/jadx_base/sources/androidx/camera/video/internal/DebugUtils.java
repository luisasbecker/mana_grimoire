...
public final class DebugUtils {
    ...
    public static String getCsdHex(MediaFormat mediaFormat) {
        ...
        sb.append(byteBufferToHex(mediaFormat.getByteBuffer(MediaFormatExt.KEY_CSD_0)));
        if (mediaFormat.containsKey(MediaFormatExt.KEY_CSD_1)) {
            sb.append(", csd-1 = ").append(byteBufferToHex(mediaFormat.getByteBuffer(MediaFormatExt.KEY_CSD_1)));
        }
        if (mediaFormat.containsKey(MediaFormatExt.KEY_CSD_2)) {
            sb.append(", csd-2 = ").append(byteBufferToHex(mediaFormat.getByteBuffer(MediaFormatExt.KEY_CSD_2)));
        }
        sb.append("}");
        return sb.toString();
    }
