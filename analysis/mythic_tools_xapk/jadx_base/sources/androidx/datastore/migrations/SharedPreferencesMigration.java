...
public final class SharedPreferencesMigration<T> implements DataMigration<T> {
    ...
    static final class C05431 extends ContinuationImpl {
        Object L$0;
        int label;
        ...
        C05431(SharedPreferencesMigration<T> sharedPreferencesMigration, Continuation<? super C05431> continuation) {
            super(continuation);
    ...
    */
    public Object shouldMigrate(T t, Continuation<? super Boolean> continuation) {
        C05431 c05431;
        if (continuation instanceof C05431) {
            c05431 = (C05431) continuation;
            if ((c05431.label & Integer.MIN_VALUE) != 0) {
                c05431.label -= Integer.MIN_VALUE;
            } else {
                c05431 = new C05431(this, continuation);
            }
        }
        Object objInvoke = c05431.result;
        ...
        if (i == 0) {
            ...
            c05431.L$0 = this;
            c05431.label = 1;
            objInvoke = function2.invoke(t, c05431);
            ...
            this = (SharedPreferencesMigration) c05431.L$0;
            ResultKt.throwOnFailure(objInvoke);
        }
