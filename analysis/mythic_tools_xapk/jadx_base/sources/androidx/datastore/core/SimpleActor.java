...
public final class SimpleActor<T> {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Removed duplicated region for block: B:15:0x0054 A[PHI: r1 r6
          ...
          0x0054: PHI (r6v6 java.lang.Object) = (r6v13 java.lang.Object), (r6v0 java.lang.Object) binds: [B:13:0x0051, B:9:0x001a] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        if (job != null) {
            job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: androidx.datastore.core.SimpleActor.1
                ...
                public final void invoke2(Throwable th) {
                    ...
                    do {
                        Object objM12974getOrNullimpl = ChannelResult.m12974getOrNullimpl(((SimpleActor) this).messageQueue.mo12962tryReceivePtdJZtk());
                        if (objM12974getOrNullimpl != null) {
                            onUndeliveredElement.invoke((T) objM12974getOrNullimpl, th);
                            unit = Unit.INSTANCE;
                        } else {
                            unit = null;
                        }
    ...
    public final void offer(T msg) {
        Object obj = this.messageQueue.mo12955trySendJP2dKIU(msg);
        if (obj instanceof ChannelResult.Closed) {
            Throwable thM12973exceptionOrNullimpl = ChannelResult.m12973exceptionOrNullimpl(obj);
