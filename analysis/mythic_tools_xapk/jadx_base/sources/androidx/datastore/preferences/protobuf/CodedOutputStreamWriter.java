...
final class CodedOutputStreamWriter implements Writer {
    ...
    private void writeBoolListInternal(int i, BooleanArrayList booleanArrayList, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
    ...
    private void writeBoolListInternal(int i, List<Boolean> list, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
            while (i2 < list.size()) {
    ...
    private void writeDoubleListInternal(int i, DoubleArrayList doubleArrayList, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
    ...
    private void writeDoubleListInternal(int i, List<Double> list, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
            while (i2 < list.size()) {
    ...
    private void writeEnumListInternal(int i, IntArrayList intArrayList, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
    ...
    private void writeEnumListInternal(int i, List<Integer> list, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
            while (i2 < list.size()) {
    ...
    private void writeFixed32ListInternal(int i, IntArrayList intArrayList, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
            while (i2 < intArrayList.size()) {
    ...
    private void writeFixed32ListInternal(int i, List<Integer> list, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
            while (i2 < list.size()) {
    ...
    private void writeFixed64ListInternal(int i, LongArrayList longArrayList, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
    ...
    private void writeFixed64ListInternal(int i, List<Long> list, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
            while (i2 < list.size()) {
    ...
    private void writeFloatListInternal(int i, FloatArrayList floatArrayList, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
    ...
    private void writeFloatListInternal(int i, List<Float> list, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
            while (i2 < list.size()) {
    ...
    private void writeInt32ListInternal(int i, IntArrayList intArrayList, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
            while (i2 < intArrayList.size()) {
    ...
    private void writeInt32ListInternal(int i, List<Integer> list, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
            while (i2 < list.size()) {
    ...
    private void writeInt64ListInternal(int i, LongArrayList longArrayList, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
            while (i2 < longArrayList.size()) {
    ...
    private void writeInt64ListInternal(int i, List<Long> list, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
            while (i2 < list.size()) {
    ...
    private void writeSFixed32ListInternal(int i, IntArrayList intArrayList, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
            while (i2 < intArrayList.size()) {
    ...
    private void writeSFixed32ListInternal(int i, List<Integer> list, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
            while (i2 < list.size()) {
    ...
    private void writeSFixed64ListInternal(int i, LongArrayList longArrayList, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
            while (i2 < longArrayList.size()) {
    ...
    private void writeSFixed64ListInternal(int i, List<Long> list, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
            while (i2 < list.size()) {
    ...
    private void writeSInt32ListInternal(int i, IntArrayList intArrayList, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
            while (i2 < intArrayList.size()) {
    ...
    private void writeSInt64ListInternal(int i, LongArrayList longArrayList, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
            while (i2 < longArrayList.size()) {
    ...
    private void writeSInt64ListInternal(int i, List<Long> list, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
            while (i2 < list.size()) {
    ...
    private void writeUInt32ListInternal(int i, IntArrayList intArrayList, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
            while (i2 < intArrayList.size()) {
    ...
    private void writeUInt64ListInternal(int i, LongArrayList longArrayList, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
            while (i2 < longArrayList.size()) {
    ...
    private void writeUInt64ListInternal(int i, List<Long> list, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
            while (i2 < list.size()) {
    ...
    public void writeSInt32ListInternal(int i, List<Integer> list, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
            while (i2 < list.size()) {
    ...
    public void writeUInt32ListInternal(int i, List<Integer> list, boolean z) throws IOException {
        int i2 = 0;
        if (!z) {
            while (i2 < list.size()) {
