        ...
        public final void writeUInt64NoTag(long j) throws IOException {
            ...
            while (true) {
                ...
                if (j3 == 0) {
                    ...
                    int i4 = this.position;
                    this.position = i4 + 1;
                    UnsafeUtil.putByte(bArr2, i4, (byte) ((((int) j) | 128) & 255));
                    j >>>= 7;
                }
            }
        }
            ...
            if (this.position <= this.oneVarintLimit) {
                ...
                while (true) {
                    ...
                    if ((i & (-128)) == 0) {
                        ...
                        this.position = j2 + 1;
                        UnsafeUtil.putByte(j2, (byte) ((i | 128) & 255));
                        i >>>= 7;
                    }
                }
            }
            ...
            if (this.position <= this.oneVarintLimit) {
                while (true) {
                    ...
                    if (j2 == 0) {
                        ...
                        this.position = j3 + 1;
                        UnsafeUtil.putByte(j3, (byte) ((((int) j) | 128) & 255));
                        j >>>= 7;
                    }
                }
            } else {
                while (true) {
                    ...
                    if ((j & (-128)) == 0) {
                        ...
                        this.position = j4 + 1;
                        UnsafeUtil.putByte(j4, (byte) ((((int) j) | 128) & 255));
                        j >>>= 7;
                    }
                }
            }
