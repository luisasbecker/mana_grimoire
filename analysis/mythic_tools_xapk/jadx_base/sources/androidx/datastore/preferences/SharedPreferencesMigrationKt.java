...
public final class SharedPreferencesMigrationKt {
    ...
    static final class C05441 extends SuspendLambda implements Function2<Preferences, Continuation<? super Boolean>, Object> {
        final /* synthetic */ Set<String> $keysToMigrate;
        /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C05441(Set<String> set, Continuation<? super C05441> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C05441 c05441 = new C05441(this.$keysToMigrate, continuation);
            c05441.L$0 = obj;
            return c05441;
        }
        ...
        public final Object invoke(Preferences preferences, Continuation<? super Boolean> continuation) {
            return ((C05441) create(preferences, continuation)).invokeSuspend(Unit.INSTANCE);
        }
