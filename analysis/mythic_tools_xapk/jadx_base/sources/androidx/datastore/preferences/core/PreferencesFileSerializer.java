...
public final class PreferencesFileSerializer implements Serializer<Preferences> {
    ...
    private final PreferencesProto.Value getValueProto(Object value) {
        ...
        if (!(value instanceof Set)) {
            ...
            PreferencesProto.Value valueBuild7 = PreferencesProto.Value.newBuilder().setBytes(ByteString.copyFrom((byte[]) value)).build();
            Intrinsics.checkNotNullExpressionValue(valueBuild7, "newBuilder().setBytes(By….copyFrom(value)).build()");
            return valueBuild7;
        }
        ...
        PreferencesProto.Value valueBuild8 = builderNewBuilder.setStringSet(builderNewBuilder2.addAllStrings((Set) value)).build();
        Intrinsics.checkNotNullExpressionValue(valueBuild8, "newBuilder()\n           …                 .build()");
        return valueBuild8;
    }
