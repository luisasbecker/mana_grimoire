...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public final class Recycler {
        ...
        /* JADX WARN: Removed duplicated region for block: B:117:0x0274 A[ADDED_TO_REGION] */
    ...
    public static abstract class ViewHolder {
        ...
        public final void setIsRecyclable(boolean z) {
            ...
            if (RecyclerView.sVerboseLoggingEnabled) {
                Log.d(RecyclerView.TAG, "setIsRecyclable val:" + z + Constants.SUBS_ID_BASE_PLAN_ID_SEPARATOR + this);
            }
        }
            ...
            while (childCount >= 0) {
                ...
                if (childViewHolderInt.shouldIgnore()) {
                    ...
                    if (fromOldChangeHolders == null || fromOldChangeHolders.shouldIgnore()) {
                        recyclerView2 = this;
                        recyclerView2.mViewInfoStore.addToPostLayout(childViewHolderInt, itemHolderInfoRecordPostLayoutInformation);
                    } else {
                        ...
                        if (zIsDisappearing && fromOldChangeHolders == childViewHolderInt) {
                            ...
                            if (itemHolderInfoPopFromPreLayout == null) {
                                ...
                                recyclerView2 = this;
                                recyclerView2.animateChange(fromOldChangeHolders, childViewHolderInt, itemHolderInfoPopFromPreLayout, itemHolderInfoPopFromPostLayout, zIsDisappearing, zIsDisappearing2);
                            }
                        }
                        recyclerView2 = this;
                    }
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:48:0x00dc A[PHI: r1
      0x00dc: PHI (r1v45 int) = (r1v25 int), (r1v49 int) binds: [B:41:0x00c7, B:46:0x00d8] A[DONT_GENERATE, DONT_INLINE]] */
    @Override // android.view.View
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
