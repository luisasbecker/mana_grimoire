...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
            ...
            if (this.mPendingSavedState.mSpanOffsetsSize == this.mSpanCount) {
                for (int i = 0; i < this.mSpanCount; i++) {
                    ...
                    if (endAfterPadding != Integer.MIN_VALUE) {
                        ...
                        endAfterPadding += z ? orientationHelper.getEndAfterPadding() : orientationHelper.getStartAfterPadding();
                    }
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        while (layoutState.hasMore(state) && (r02.mLayoutState.mInfinite || !r02.mRemainingSpans.isEmpty())) {
            ...
            if (layoutState.mLayoutDirection == 1) {
                decoratedMeasurement = layoutParams.mFullSpan ? r02.getMaxEnd(endAfterPadding) : span2.getEndLine(endAfterPadding);
                ...
                minStart = layoutParams.mFullSpan ? r02.getMinStart(endAfterPadding) : span2.getStartLine(endAfterPadding);
            ...
            if (layoutParams.mFullSpan && layoutState.mItemDirection == -1) {
                if (r5 != 0) {
                    ...
                    if (!(layoutState.mLayoutDirection == 1 ? r02.areAllEndsEqual() : r02.areAllStartsEqual())) {
            ...
            if (r02.isLayoutRTL() && r02.mOrientation == 1) {
                ...
                decoratedMeasurement2 = z3 ? orientationHelper2.getEndAfterPadding() : orientationHelper2.getEndAfterPadding() - (((r02.mSpanCount - 1) - span2.mIndex) * r02.mSizePerSpan);
                startAfterPadding = decoratedMeasurement2 - r02.mSecondaryOrientation.getDecoratedMeasurement(next);
            } else {
                startAfterPadding = layoutParams.mFullSpan ? r02.mSecondaryOrientation.getStartAfterPadding() : (span2.mIndex * r02.mSizePerSpan) + r02.mSecondaryOrientation.getStartAfterPadding();
                decoratedMeasurement2 = r02.mSecondaryOrientation.getDecoratedMeasurement(next) + startAfterPadding;
            }
            int i2 = decoratedMeasurement2;
            int i3 = startAfterPadding;
            if (r02.mOrientation == 1) {
                r02.layoutDecoratedWithMargins(next, i3, decoratedMeasurement, i2, minStart);
                r0 = this;
            } else {
                r02.layoutDecoratedWithMargins(next, decoratedMeasurement, i3, minStart, i2);
                r0 = r02;
            }
            boolean z4 = layoutParams.mFullSpan;
            LayoutState layoutState2 = r0.mLayoutState;
            if (z4) {
                r0.updateAllRemainingSpans(layoutState2.mLayoutDirection, i);
            } else {
                r0.updateRemainingSpans(span2, layoutState2.mLayoutDirection, i);
            }
        ...
        int i4 = r02.mLayoutState.mLayoutDirection;
        OrientationHelper orientationHelper3 = r02.mPrimaryOrientation;
        int startAfterPadding2 = i4 == -1 ? r02.mPrimaryOrientation.getStartAfterPadding() - r02.getMinStart(orientationHelper3.getStartAfterPadding()) : r02.getMaxEnd(orientationHelper3.getEndAfterPadding()) - r02.mPrimaryOrientation.getEndAfterPadding();
        ...
        if (preferLastSpan(iConvertFocusDirectionToLayoutDirection)) {
            for (int i4 = this.mSpanCount - 1; i4 >= 0; i4--) {
                if (i4 != span.mIndex) {
                    ...
                    View viewFindViewByPosition2 = findViewByPosition(z2 ? spanArr[i4].findFirstPartiallyVisibleItemPosition() : spanArr[i4].findLastPartiallyVisibleItemPosition());
            ...
            for (int i5 = 0; i5 < this.mSpanCount; i5++) {
                ...
                View viewFindViewByPosition3 = findViewByPosition(z2 ? spanArr2[i5].findFirstPartiallyVisibleItemPosition() : spanArr2[i5].findLastPartiallyVisibleItemPosition());
                ...
                if (savedState == null || savedState.mAnchorPosition == -1 || this.mPendingSavedState.mSpanOffsetsSize < 1) {
                    ...
                    if (viewFindViewByPosition != null) {
                        ...
                        if (this.mPrimaryOrientation.getDecoratedMeasurement(viewFindViewByPosition) > this.mPrimaryOrientation.getTotalSpace()) {
                            ...
                            OrientationHelper orientationHelper2 = this.mPrimaryOrientation;
                            anchorInfo.mOffset = z2 ? orientationHelper2.getEndAfterPadding() : orientationHelper2.getStartAfterPadding();
                            return true;
                        }
