...
public final class Palette {
    ...
    public static final class Builder {
        ...
        private Bitmap scaleBitmapDown(Bitmap bitmap) {
            ...
            return dSqrt <= AudioStats.AUDIO_AMPLITUDE_NONE ? bitmap : Bitmap.createScaledBitmap(bitmap, (int) Math.ceil(((double) bitmap.getWidth()) * dSqrt), (int) Math.ceil(((double) bitmap.getHeight()) * dSqrt), false);
        }
