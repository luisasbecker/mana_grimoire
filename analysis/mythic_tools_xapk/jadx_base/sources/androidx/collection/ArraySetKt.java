...
public final class ArraySetKt {
    ...
    public static final <E> E removeAtInternal(ArraySet<E> arraySet, int i) {
        ...
        if (arraySet.getHashes().length <= 8 || arraySet.get_size$collection() >= arraySet.getHashes().length / 3) {
            if (i < i4) {
                int i5 = i + 1;
                ArraysKt.copyInto(arraySet.getHashes(), arraySet.getHashes(), i, i5, i3);
                ArraysKt.copyInto(arraySet.getArray(), arraySet.getArray(), i, i5, i3);
            }
            ...
            if (i2 < i4) {
                int i7 = i2 + 1;
                ArraysKt.copyInto(hashes, arraySet.getHashes(), i2, i7, i3);
                ArraysKt.copyInto(objArr, arraySet.getArray(), i2, i7, i3);
            }
        }
