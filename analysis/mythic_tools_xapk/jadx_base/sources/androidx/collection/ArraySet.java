...
public final class ArraySet<E> implements Collection<E>, Set<E>, KMutableCollection, KMutableSet {
    ...
    public final E removeAt(int index) {
        ...
        if (getHashes().length <= 8 || get_size$collection() >= getHashes().length / 3) {
            if (index < i3) {
                int i4 = index + 1;
                ArraysKt.copyInto(getHashes(), getHashes(), index, i4, i2);
                ArraysKt.copyInto(getArray(), getArray(), index, i4, i2);
            }
            getArray()[i3] = null;
        } else {
            ...
            if (i < i3) {
                int i6 = i + 1;
                ArraysKt.copyInto(hashes, getHashes(), i, i6, i2);
                ArraysKt.copyInto(objArr, getArray(), i, i6, i2);
            }
        }
        if (i2 != get_size$collection()) {
            throw new ConcurrentModificationException();
