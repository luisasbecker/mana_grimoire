...
public class SimpleArrayMap<K, V> {
    ...
    public V removeAt(int index) {
        ...
        if (iArr.length <= 8 || i2 >= iArr.length / 3) {
            if (index < i3) {
                int i4 = index + 1;
                ArraysKt.copyInto(iArr, iArr, index, i4, i2);
                Object[] objArr2 = this.array;
            ...
            if (index < i3) {
                int i7 = index + 1;
                ArraysKt.copyInto(iArr, this.hashes, index, i7, i2);
