                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            ...
                            float f = fArr[i4];
                            long j2 = jArr[i4];
                            int iFindKeyIndex = floatLongMap.findKeyIndex(f);
                            if (iFindKeyIndex < 0 || j2 != floatLongMap.values[iFindKeyIndex]) {
                                break loop0;
                            }
                        }
                        j >>= 8;
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i6 < i5) {
                        if ((j & 255) < 128) {
                            ...
                            jArr2 = jArr4;
                            sb.append(transform.invoke(fValueOf, Long.valueOf(j2)));
                            i3++;
                        } else {
                            jArr2 = jArr4;
                            i = i4;
