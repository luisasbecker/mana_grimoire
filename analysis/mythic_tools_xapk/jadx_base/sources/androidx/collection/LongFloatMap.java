                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            ...
                            long j2 = jArr[i4];
                            float f = fArr[i4];
                            int iFindKeyIndex = longFloatMap.findKeyIndex(j2);
                            if (iFindKeyIndex < 0 || f != longFloatMap.values[iFindKeyIndex]) {
                                break loop0;
                            }
                        }
                        j >>= 8;
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i6 < i5) {
                        if ((j & 255) < 128) {
                            ...
                            Long lValueOf = Long.valueOf(j2);
                            jArr2 = jArr4;
                            sb.append(transform.invoke(lValueOf, Float.valueOf(f)));
                            i3++;
                        } else {
                            jArr2 = jArr4;
                            i = i4;
