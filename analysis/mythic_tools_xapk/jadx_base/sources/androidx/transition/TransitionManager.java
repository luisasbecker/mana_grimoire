...
public class TransitionManager {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo9889clone = transition.mo9889clone();
        sceneChangeSetup(viewGroup, transitionMo9889clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo9889clone);
    }
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo9889clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo9889clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo9889clone);
    }
    ...
    public static TransitionSeekController controlDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        transitionSet.addTransition(transitionMo9889clone);
