...
public final class CharSequenceSerializer implements KSerializer<CharSequence> {
    ...
    public CharSequence deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m9779getCharSequenceimpl(SavedStateReader.m9762constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
    ...
    public void serialize(Encoder encoder, CharSequence value) {
        ...
        SavedStateWriter.m9858putCharSequenceimpl(SavedStateWriter.m9848constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
}
