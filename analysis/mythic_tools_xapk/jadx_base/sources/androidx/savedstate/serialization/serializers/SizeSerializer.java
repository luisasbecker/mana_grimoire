...
public final class SizeSerializer implements KSerializer<Size> {
    ...
    public Size deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m9825getSizeimpl(SavedStateReader.m9762constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
    ...
    public void serialize(Encoder encoder, Size value) {
        ...
        SavedStateWriter.m9878putSizeimpl(SavedStateWriter.m9848constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
}
