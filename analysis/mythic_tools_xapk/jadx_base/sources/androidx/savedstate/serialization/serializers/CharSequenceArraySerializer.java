...
public final class CharSequenceArraySerializer implements KSerializer<CharSequence[]> {
    ...
    public CharSequence[] deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m9780getCharSequenceArrayimpl(SavedStateReader.m9762constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
    ...
    public void serialize(Encoder encoder, CharSequence[] value) {
        ...
        SavedStateWriter.m9859putCharSequenceArrayimpl(SavedStateWriter.m9848constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
}
