...
public abstract class JavaSerializableSerializer<T extends Serializable> implements KSerializer<T> {
    ...
    public final T deserialize(Decoder decoder) {
        ...
        T t = (T) SavedStateReader.m9800getJavaSerializableimpl(SavedStateReader.m9762constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey(), Reflection.getOrCreateKotlinClass(Serializable.class));
    ...
    public final void serialize(Encoder encoder, T value) {
        ...
        SavedStateWriter.m9868putJavaSerializableimpl(SavedStateWriter.m9848constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
}
