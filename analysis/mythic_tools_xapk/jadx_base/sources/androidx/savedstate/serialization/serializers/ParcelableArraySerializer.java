...
public final class ParcelableArraySerializer implements KSerializer<Parcelable[]> {
    ...
    public Parcelable[] deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m9810getParcelableArrayimpl(SavedStateReader.m9762constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey(), Reflection.getOrCreateKotlinClass(Parcelable.class));
    }
    ...
    public void serialize(Encoder encoder, Parcelable[] value) {
        ...
        SavedStateWriter.m9873putParcelableArrayimpl(SavedStateWriter.m9848constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
}
