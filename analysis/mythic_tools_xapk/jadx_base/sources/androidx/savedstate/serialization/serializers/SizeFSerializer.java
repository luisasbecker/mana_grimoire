...
public final class SizeFSerializer implements KSerializer<SizeF> {
    ...
    public SizeF deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m9826getSizeFimpl(SavedStateReader.m9762constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
    ...
    public void serialize(Encoder encoder, SizeF value) {
        ...
        SavedStateWriter.m9879putSizeFimpl(SavedStateWriter.m9848constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
}
