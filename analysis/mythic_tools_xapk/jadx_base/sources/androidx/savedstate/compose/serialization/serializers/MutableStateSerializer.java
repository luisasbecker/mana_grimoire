...
public final class MutableStateSerializer<T> implements KSerializer<MutableState<T>> {
    ...
    public MutableStateSerializer(KSerializer<T> valueSerializer) {
        ...
        this.descriptor = kind instanceof PrimitiveKind ? SerialDescriptorsKt.PrimitiveSerialDescriptor("androidx.compose.runtime.MutableState", (PrimitiveKind) kind) : SerialDescriptorsKt.SerialDescriptor("androidx.compose.runtime.MutableState", this.valueSerializer.getDescriptor());
    }
