...
public final class RoundedPolygonKt {
    ...
    public static final RoundedPolygon RoundedPolygon(float[] vertices, CornerRounding rounding, List<CornerRounding> list, float f, float f2) {
        ...
        while (i4 < length) {
            ...
            int i7 = (i6 % length) * 2;
            int i8 = i4 * 2;
            arrayList2.add(new RoundedCorner(FloatFloatPair.m1231constructorimpl(vertices[i5], vertices[i5 + 1]), FloatFloatPair.m1231constructorimpl(vertices[i8], vertices[i8 + 1]), FloatFloatPair.m1231constructorimpl(vertices[i7], vertices[i7 + 1]), cornerRounding2, null));
            i4 = i6;
        }
        ...
        for (int i12 = 0; i12 < length; i12++) {
            ...
            for (int i13 = 0; i13 < 2; i13++) {
                Pair pair = (Pair) arrayList4.get((((i12 + length) - 1) + i13) % length);
                mutableFloatList.add((((RoundedCorner) arrayList2.get(i12)).getExpectedRoundCut() * ((Number) pair.component1()).floatValue()) + ((((RoundedCorner) arrayList2.get(i12)).getExpectedCut() - ((RoundedCorner) arrayList2.get(i12)).getExpectedRoundCut()) * ((Number) pair.component2()).floatValue()));
            }
        ...
        while (i3 < length) {
            ...
            int i15 = i14 % length;
            int i16 = i3 * 2;
            long jM1231constructorimpl = FloatFloatPair.m1231constructorimpl(vertices[i16], vertices[i16 + i2]);
            int i17 = (((i3 + length) - i2) % length) * i;
            long jM1231constructorimpl2 = FloatFloatPair.m1231constructorimpl(vertices[i17], vertices[i17 + i2]);
            int i18 = i15 * 2;
            arrayList5.add(new Feature.Corner((List) arrayList.get(i3), jM1231constructorimpl, ((RoundedCorner) arrayList2.get(i3)).getCenter(), PointKt.m9686clockwiseybeJwSQ(PointKt.m9698minusybeJwSQ(jM1231constructorimpl, jM1231constructorimpl2), PointKt.m9698minusybeJwSQ(FloatFloatPair.m1231constructorimpl(vertices[i18], vertices[i18 + i2]), jM1231constructorimpl)), null));
        ...
        long jCalculateCenter = (f == Float.MIN_VALUE || f2 == Float.MIN_VALUE) ? calculateCenter(vertices) : FloatFloatPair.m1231constructorimpl(f, f2);
        return new RoundedPolygon(arrayList5, Float.intBitsToFloat((int) (jCalculateCenter >> 32)), Float.intBitsToFloat((int) (jCalculateCenter & MuxerUtil.UNSIGNED_INT_MAX_VALUE)));
    }
    ...
    private static final long calculateCenter(float[] fArr) {
        ...
        return FloatFloatPair.m1231constructorimpl((f / fArr.length) / 2.0f, (f2 / fArr.length) / 2.0f);
    }
    ...
    private static final float[] verticesFromNumVerts(int i, float f, float f2, float f3) {
        ...
        while (i2 < i) {
            float f4 = f;
            long jM9699plusybeJwSQ = PointKt.m9699plusybeJwSQ(Utils.m9715radialToCartesianL6JJ3z0$default(f4, (Utils.getFloatPi() / i) * 2.0f * i2, 0L, 4, null), FloatFloatPair.m1231constructorimpl(f2, f3));
            int i4 = i3 + 1;
            fArr[i3] = PointKt.m9695getXDnnuFBc(jM9699plusybeJwSQ);
            i3 += 2;
            fArr[i4] = PointKt.m9696getYDnnuFBc(jM9699plusybeJwSQ);
            i2++;
            f = f4;
        }
        return fArr;
