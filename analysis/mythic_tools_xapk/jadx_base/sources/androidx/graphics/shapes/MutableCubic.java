...
public final class MutableCubic extends Cubic {
    ...
    private final void transformOnePoint(PointTransformer f, int ix) {
        int i = ix + 1;
        long jMo9704transformXgqJiTY = f.mo9704transformXgqJiTY(getPoints()[ix], getPoints()[i]);
        getPoints()[ix] = Float.intBitsToFloat((int) (jMo9704transformXgqJiTY >> 32));
        getPoints()[i] = Float.intBitsToFloat((int) (MuxerUtil.UNSIGNED_INT_MAX_VALUE & jMo9704transformXgqJiTY));
    }
