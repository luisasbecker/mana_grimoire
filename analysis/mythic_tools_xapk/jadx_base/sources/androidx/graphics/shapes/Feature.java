...
public abstract class Feature {
    ...
    public static final class Corner extends Feature {
        ...
        public String toString() {
            return "Corner: vertex=" + ((Object) FloatFloatPair.m1238toStringimpl(this.vertex)) + ", center=" + ((Object) FloatFloatPair.m1238toStringimpl(this.roundedCenter)) + ", convex=" + this.convex;
        }
        ...
        public Feature transformed$graphics_shapes_release(PointTransformer f) {
            ...
            return new Corner(CollectionsKt.build(listCreateListBuilder), PointKt.m9702transformedso9K2fw(this.vertex, f), PointKt.m9702transformedso9K2fw(this.roundedCenter, f), this.convex, null);
        }
    }
