...
public final class AngleMeasurer implements Measurer {
    ...
    static final float findCubicCutPoint$lambda$1(Cubic c, AngleMeasurer this$0, float f, float f2, float f3) {
        ...
        long jM9683pointOnCurveOOQOV4g$graphics_shapes_release = c.m9683pointOnCurveOOQOV4g$graphics_shapes_release(f3);
        return Math.abs(Utils.positiveModulo(Utils.angle(PointKt.m9695getXDnnuFBc(jM9683pointOnCurveOOQOV4g$graphics_shapes_release) - this$0.centerX, PointKt.m9696getYDnnuFBc(jM9683pointOnCurveOOQOV4g$graphics_shapes_release) - this$0.centerY) - f, Utils.getTwoPi()) - f2);
    }
