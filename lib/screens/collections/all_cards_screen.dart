...
import '../collection_detail/widgets/edit_collection_item_sheet.dart';
...
class _AllCardsScreenState extends State<AllCardsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: ManaInternalAppBar(title: t.allCardsTitle),
      body: Padding(
                ...
                builder: (context, snapshot) {
                  ...
                  if (items.isEmpty) {
                    return ManaEmptyState(
                      ...
                      title: t.allCardsEmptyTitle,
                      subtitle: t.allCardsEmptySubtitle,
                    );
                  }
