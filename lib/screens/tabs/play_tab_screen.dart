...
class PlayTabScreen extends StatefulWidget {
  const PlayTabScreen({super.key});

  @override
  State<PlayTabScreen> createState() => _PlayTabScreenState();
}

class _PlayTabScreenState extends State<PlayTabScreen> {
  int _players = 2;
  ...
  Widget build(BuildContext context) {
    ...
    final cache = PlaySessionCache.instance;
              ...
              child: Column(
                ...
                children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'Há um jogo em cache (${cache.players}P · ${cache.mode}).',
                              style: theme.textTheme.bodySmall?.copyWith(
                                color: scheme.onSurfaceVariant,
                    ...
                    child: Wrap(
                      ...
                      children: [
                        ChoiceChip(
                          ...
                          onSelected: (_) => setState(() => _mode = 'Commander'),
                        ),
                        ChoiceChip(
                          label: const Text('Standard'),
                          selected: _mode == 'Standard',
                          onSelected: (_) => setState(() => _mode = 'Standard'),
                        ),
                        ChoiceChip(
                  ...
                  FilledButton.icon(
                    onPressed: () {
                      setState(() {
                        cache.startNew(players: _players, mode: _mode);
                      });
...
class _SetupCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: scheme.surfaceContainerHigh.withOpacity(0.65),
        borderRadius: BorderRadius.circular(16),
